...
DO NOT USE for: paper writing workflows (use `write-methods-section`,
`journal-formatting`, etc. instead).
...
skill `skills/neqsim-in-writing/SKILL.md`. It covers the dual-boot setup
