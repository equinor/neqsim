...
## Deployment
The NeqSim source code is compiled and distributed as a Java library. [NeqSim latest release](/releases/latest) is available for download from the release pages.
