...
STUDY_CONFIG = "\n".join([
    ...
    "  language: en         # en (default) | nb/no | any ISO code",
    "  # Language of the report: section headings, cover labels, caption prefixes,",
    "  # and the document language used for spell-check. Write the study content in",
    "  # the same language. The scientific paper stays English.",
    "  include_paper: false",
