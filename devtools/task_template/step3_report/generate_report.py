...
REPORT_STRINGS = {
    "nb": {
        ...
        "Table": "Tabell",
        "Equation": "Ligning",
        # Sub-headings and table furniture inside generated sections
        ...
        "Assumptions the results depend on:": "Forutsetninger resultatene bygger på:",
        ...
        "Information sought but not available, and what was assumed in its place:":
            "Informasjon som ble søkt etter, men ikke var tilgjengelig, og hva som ble antatt i stedet:",
