...
| **Hydrogen Production**               | [docs/process/hydrogen_production.md](process/hydrogen_production)                                  | **PressureSwingAdsorptionBed, Electrolyzer (PEM/Alkaline/SOEC/AEM), ElectrolyzerIVCharacteristic, ElectrolyzerCostEstimate — blue/green H2 plant modeling** |
