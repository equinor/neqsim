...
| **Multiphase Transient Model Demo (Jupyter)** | [examples/notebooks/multiphase_transient_model_demo.ipynb](https://github.com/equinor/neqsim/blob/master/examples/notebooks/multiphase_transient_model_demo.ipynb) | **Runnable companion to the multiphase transient model roadmap: short and 20-80 km TwoFluidPipe calculations, terrain holdup, rate-change transients, explicit pressure-reference diagnostics, and steady/inlet-driven dynamic Beggs-Brill literature-correlation comparisons** |
