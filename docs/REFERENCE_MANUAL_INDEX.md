...
| **Production Allocation** | [docs/process/production-allocation.md](process/production-allocation)                                                  | **Back-allocate metered production to wells/sources via a linear recovery-factor proxy network — split factors, (I−A)v=b solve, mass closure, auto-detection, JSON export** |
