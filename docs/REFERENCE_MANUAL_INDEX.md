...
| **MCP Agentic Workflow Improvements** | [docs/integration/mcp_agentic_workflow_improvements.md](integration/mcp_agentic_workflow_improvements)          | **Response contracts, provenance, validation-first execution, schema-backed capability descriptors, setup templates, examples, and coverage tests for MCP agent workflows** |
