...
| **Vessel Depressurization**   | [docs/process/equipment/vessel_depressurization.md](process/equipment/vessel_depressurization) | **Filling, blowdown, fire cases, Stefan-Boltzmann fire model, Scandpower/API fire presets, transient wall HT, composite vessels, CNG/H2 tanks, flow assurance, real-gas beta, Biot correction, Rohsenow boiling, API reference** |
