...
| Distillation       | [docs/process/equipment/distillation.md](process/equipment/distillation)       | Distillation columns, **ColumnSpecification**, builder pattern, solver options including **AUTO**, side draws, pumparounds, condenser/reboiler modes, hydraulic pressure-drop coupling, shortcut initialization, tray efficiency, dynamic screening, rate-based packed columns, and MESH residual diagnostics |
| Distillation Wiki  | [docs/wiki/distillation_column.md](wiki/distillation_column)                   | Distillation column equations, solver details including **AUTO**, outer tear variables for side draws, pumparounds, and hydraulics, convergence diagnostics, and MESH residual monitoring                                                                                                                |
