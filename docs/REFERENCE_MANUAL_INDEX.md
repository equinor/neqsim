...
| EOS-CG CO2/SO2 Mixture    | [docs/thermo/eoscg_co2_so2.md](thermo/eoscg_co2_so2.md)             | Executable mixture flash, phase densities, pressure closure, material balance, and numerical validation boundary |
...
| Pitzer Hydrate Equilibrium       | [docs/thermo/pitzer_hydrate_equilibrium.md](thermo/pitzer_hydrate_equilibrium.md) | CO2/chloride brines, Pitzer water activities, bounded onset calculations and qualification limits |
...
| Compressor Thermal Model | [docs/compressor_thermal_model.md](compressor_thermal_model.md) | Metal-node temperature network, catalog templates, steady/transient screening, and deposition inputs |
...
| Plate Heat Exchanger Design | [Plate design guide](process/mechanical_design/plate_heat_exchanger_design.md) | Martin correlations, channel/port losses, effectiveness–NTU, fouling and frame/bolt headroom |
...
| Legacy SimpleAdsorber boundary     | [docs/process/equipment/adsorbers.md](process/equipment/adsorbers.md)                         | Unqualified MDEA-loading prototype; use maintained absorber or adsorption-bed models for new work                 |
...
| **VFP Export Contract** | [docs/process/optimization/vfp-export-contract.md](process/optimization/vfp-export-contract.md) | Supplied well BHP, complete axes, unit conversion and screening boundaries |
...
| **Early-Phase Tie-back Design**   | [docs/process/tieback_early_phase_design.md](process/tieback_early_phase_design.md)                                                                       | **Tie-back workflow: shut-in wellhead pressure, API RP 14E sizing, two-fluid hydraulics on a surveyed route, F101 wall thickness, and the wall/insulation coupling** |
...
| Coupled Gas Release Inventory | [docs/process/safety/coupled-release-inventory.md](process/safety/coupled-release-inventory.md) | Rigid adiabatic depletion, component/energy conservation, timestep convergence and live source frames from both process containers |
...
| **P2: SIS/SIF Integration**         | [docs/risk/sis-integration.md](risk/sis-integration.md)                                                | PFD and LOPA screening; independent assessment required              |
...
| **Calibration and Parameter Estimation Hub**             | [docs/calibration/index.md](calibration/index.md)                                                                                                                               | Data reconciliation, parameter fitting, and model calibration workflows                                                  |
...
| **Continuous Task Solving**        | [docs/development/CONTINUOUS_TASK_SOLVING.md](development/CONTINUOUS_TASK_SOLVING.md)               | **Living tasks: monitor cycles, solve loops, goal and cycle plan, stage scripts, backtesting, scheduling, headless agents, improvement ledger, baseline promotion** |
| **Code Patterns**                  | [docs/development/CODE_PATTERNS.md](development/CODE_PATTERNS.md)                                   | **Copy-paste starters for common coding tasks**                                       |
| **Agent Reference**                | [docs/development/AGENT_REFERENCE.md](development/AGENT_REFERENCE.md)                               | **Full detail behind the lean AGENTS.md / copilot-instructions.md: task workflow, results.json schema, Automation API, key paths, JavaDoc and docs rules** |
...
| CO2 transport reaction kinetics | [docs/chemicalreactions/co2_transport_reaction_kinetics.md](chemicalreactions/co2_transport_reaction_kinetics.md) | Qualified kinetic evidence and Damköhler transport-timescale screening |
