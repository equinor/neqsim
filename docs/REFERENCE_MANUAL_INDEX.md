...
| **Copilot Agent Plugin** | [docs/integration/copilot_plugin.md](integration/copilot_plugin.md) | **Package and install all repository agents, skills and MCP tools in VS Code, with Docker or an embedded Java server** |
