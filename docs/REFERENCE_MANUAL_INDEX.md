...
| Gas Scrubbers      | [docs/process/equipment/scrubbers.md](process/equipment/scrubbers)             | Vocabulary-first redirect for gas scrubbers / KO drums / suction scrubbers — points to the main separator reference, the physics-based entrainment guide, and the gas-scrubber mechanical-design / TR3500 sections. |
