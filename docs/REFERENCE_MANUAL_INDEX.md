...
| **Hydrogen Production**               | [docs/process/hydrogen_production.md](process/hydrogen_production)                                  | **SMR/ATR/POX route templates, ReformerFurnace, CatalyticTubeReformer, AutothermalReformer, PartialOxidationReactor, PSACascade, Electrolyzer — blue/green H2 plant modeling** |
