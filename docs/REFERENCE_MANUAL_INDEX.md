...
| **Out-of-Zone Injection**             | [docs/process/out_of_zone_injection.md](process/out_of_zone_injection)                             | **Multi-zone injection, fracture containment, annular leakage, cement degradation, conformance monitoring**                                              |
