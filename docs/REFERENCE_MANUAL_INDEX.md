...
| Separator Entrainment Modeling | [docs/process/equipment/separator-entrainment-modeling.md](process/equipment/separator-entrainment-modeling) | **Enhanced physics-based separator performance** — droplet size distributions, flow regime prediction (Mandhane, Taitel-Dukler), inlet device modeling (7 types, Bothamley momentum), grade efficiency curves, Schiller-Naumann settling, internals database (wire mesh, vane, cyclone), K-factor flooding, three-phase liquid-liquid separation |
