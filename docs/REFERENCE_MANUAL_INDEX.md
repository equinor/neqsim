...
| Standards-based DEXPI Engineering Generation | [docs/integration/dexpi-engineering-generation.md](integration/dexpi-engineering-generation) | Governed NeqSim-to-DEXPI workflow with line/equipment/instrument/valve/SIF/relief registers, installed relief and disposal screening, enhanced SIF verification, dynamic shutdown evidence, per-object coverage, DEXPI validation, package hashes, compressor maps and ProcessModel area packages |
