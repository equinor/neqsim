...
| **Task Solving Guide**             | [docs/development/TASK_SOLVING_GUIDE.md](development/TASK_SOLVING_GUIDE)                         | **Step-by-step workflow for solving engineering tasks, including study_config.yaml for detailed multi-notebook studies** |
