...
| Standards-based DEXPI Engineering Generation | [docs/integration/dexpi-engineering-generation.md](integration/dexpi-engineering-generation) | Governed NeqSim-to-DEXPI workflow with controlled line lists, relief coverage, SIL/PFD/voting, shutdown sequences, readiness metrics, equipment/piping design, PSV/blowdown/flare, compressor maps and ProcessModel area packages |
