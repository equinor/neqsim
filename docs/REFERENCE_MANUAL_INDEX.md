...
| Compressor Anti-Surge Control | [docs/process/equipment/compressor_antisurge_control.md](process/equipment/compressor_antisurge_control) | Dynamic anti-surge recycle, pressure-speed control, predictive supervision, and coordinated override philosophy |
