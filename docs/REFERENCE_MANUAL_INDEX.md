...
| **Decision Support**  | [docs/process/decision-support.md](process/decision-support)                                                               | **Engineering decision support for control room operators — structured queries, simulation-backed recommendations, audit trail** |
