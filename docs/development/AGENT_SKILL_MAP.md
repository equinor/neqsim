...
| `pvt.simulation.agent.md` | run a neqsim PVT simulation | `neqsim-api-patterns`, `neqsim-eos-regression`, `neqsim-fluid-quality-check`, `neqsim-input-validation`, `neqsim-notebook-patterns`, `neqsim-professional-reporting` |
...
| `thermo.fluid.agent.md` | create a neqsim thermodynamic fluid | `neqsim-api-patterns`, `neqsim-input-validation`, `neqsim-troubleshooting`, `neqsim-eos-regression`, `neqsim-fluid-quality-check` |
