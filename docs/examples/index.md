...
validation. The Eclipse E300, flow-regime, real-time integration, and two-fluid pipe
examples are also source-checked for Log4j2 compliance; the remaining files retain legacy console output. Inspect assumptions and execute
