...
| **Executed** | **Reservoir-to-market optimization with NeqSim equipment** | Notebook for Reservoir-to-market optimization with NeqSim equipment, including NeqSim Python examples and workflow context. | [Markdown](reservoir_to_market_optimization.md) \| [nbviewer](https://nbviewer.org/github/equinor/neqsim/blob/master/docs/examples/reservoir_to_market_optimization.ipynb) \| [Colab](https://colab.research.google.com/github/equinor/neqsim/blob/master/docs/examples/reservoir_to_market_optimization.ipynb) |
