...
| **Dynamic Compressor Good Maps** | Dynamic compressor speed, turndown, anti-surge sweep, predictive anti-surge, coordinated pressure-speed-recycle control, and steady-state-to-dynamic handoff using explicit GOOD compressor maps | [Notebook](../../examples/notebooks/process/dynamic_compressor_good_maps.ipynb) \| [nbviewer](https://nbviewer.org/github/equinor/neqsim/blob/master/examples/notebooks/process/dynamic_compressor_good_maps.ipynb) \| [Colab](https://colab.research.google.com/github/equinor/neqsim/blob/master/examples/notebooks/process/dynamic_compressor_good_maps.ipynb) |
...
| **Separator Efficiency (Gas Scrubber & Three-Phase)** | Separation-efficiency report with per-internal K-factor operating windows for a two-phase gas scrubber and a three-phase separator; turndown sweep | [nbviewer](https://nbviewer.org/github/equinor/neqsim/blob/master/docs/examples/SeparatorEfficiency_GasScrubber_ThreePhase.ipynb) \| [Colab](https://colab.research.google.com/github/equinor/neqsim/blob/master/docs/examples/SeparatorEfficiency_GasScrubber_ThreePhase.ipynb) |
