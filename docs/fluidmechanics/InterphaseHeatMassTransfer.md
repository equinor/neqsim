...
description: "Theory and numerical methods for non-equilibrium interphase mass and heat transfer in two-phase gas-liquid pipe flow."
---
...
#### Reactive enhancement selection
