...
- [MassTransferAPI.md](MassTransferAPI) - Flow pattern-specific mass transfer correlations
- [InterphaseHeatMassTransfer.md](InterphaseHeatMassTransfer) - Interfacial area by flow pattern
...
- [Pipeline Simulation](../process/equipment/pipeline_simulation) - Pipeline flow models
- [Two-Phase Pipe Flow](TwoPhasePipeFlowSystem_Development_Plan) - Advanced two-phase modeling
- [Heat Transfer](heat_transfer) - Flow pattern effects on heat transfer
