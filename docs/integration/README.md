...
| [engineering-diagram-delivery.md](engineering-diagram-delivery) | **Fail-closed assessed delivery of controlled semantic JSON, DEXPI, native SVG/PDF, hashes, and review-required diagnostics** |
