...
| Couple a trapped inventory release to depletion | [ReleaseInventory](coupled-release-inventory) and `SourceTermSession.addInventorySource` | Rigid, adiabatic equilibrium inventory; explicit gas/oil/liquid/aqueous phase selection, component/energy closure and timestep refinement; no entrainment or phase fallback |
