...
`StandardDesignKernelVerificationSuite.evaluateRegression()` executes eleven exact-edition
...
as current. API 2000, M-506, ISO 5167-2, DNV-RP-C203, DNV-RP-F105, and DNV-RP-F101 support their
catalogued current editions but remain
screening-only.
