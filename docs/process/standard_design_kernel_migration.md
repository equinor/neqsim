...
`StandardDesignKernelVerificationSuite.evaluateRegression()` executes the thirteen registered exact
...
DNV-RP-F114 caller-controlled vertical/axial/lateral demand-resistance identities.
...
as current. API 2000, M-506, ISO 5167-2, DNV-RP-C203, DNV-RP-F105, DNV-RP-F101, DNV-RP-F104, and
DNV-RP-F114 support their catalogued current editions but remain
screening-only.
