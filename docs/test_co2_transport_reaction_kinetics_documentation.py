...
class CO2TransportReactionKineticsDocumentationContractTest(unittest.TestCase):
    ...
    def test_published_hydration_bridge_matches_source_contract(self):
        for token in (
            ...
            "public static double relaxationTimeSeconds(",
            "public static TimescaleResult screenResidenceTime(",
            "public static double timeToRemainingDeviationFraction(",
            "1.0 / (hydrationRate + dehydrationRate)",
            "-Math.expm1(-damkohler)",
        ...
        for token in (
            ...
            "0.177022 s",
            "Da_pair = 26.0147",
            "neutral molecular pair",
            "not** a bicarbonate/carbonate",
            "no van Eldik–Palmer pressure multiplier",
            "issue #3144",
            "#3318",
        ):
