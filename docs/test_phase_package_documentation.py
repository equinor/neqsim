...
class PhasePackageDocumentationContractTest(unittest.TestCase):
    def test_structure_links_and_logging_are_source_safe(self) -> None:
    ...
    def test_phase_fraction_ownership_matches_current_interfaces(self) -> None:
    ...
    def test_initialization_and_property_boundary_is_source_anchored(self) -> None:
    ...
    def test_phase_types_and_lookup_match_current_source(self) -> None:
    ...
    def test_special_phase_boundaries_use_current_system_api(self) -> None:
    ...
    def test_stale_or_model_specific_api_patterns_do_not_return(self) -> None:
        """Reject the invalid and misleading patterns removed from the guide."""

        guide = read(GUIDE)
        stale_patterns = (
            "double betaV = phase.getBetaV()",
            'phase.getDiffusionCoefficient("m2/s")',
            "fluid.getNumberOfLiquidPhases()",
            "fluid.getSolidPhase()",
            "fluid.hasHydrate()",
            "fluid.getHydrateTemperature()",
            "fluid.setWaxCheck(",
            "fluid.hasWax()",
            "comp.getActivity()",
            "aqueous.getIonicStrength()",
            "fluid.isPhaseStable()",
            "phase.getdZdT()",
            "phase.getdZdP()",
            "phase.getComponent(0).getdfugdT()",
            "phase.getComponent(0).getdfugdP()",
            "phase.getExcessEnthalpy()",
            "phase.getExcessEntropy()",
            "phase.getExcessVolume()",
            "(PhaseGasEos)",
            "(PhaseGasCPA)",
            "(PhaseGasPCSAFT)",
            "~1150",
    ...
    def test_complete_example_calls_are_exercised_by_java_regression(self) -> None:
