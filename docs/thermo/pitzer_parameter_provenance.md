...
refitted. This independently qualifies the NaCl binary behavior; KCl and mixed Na/K/Cl remain
implementation-comparison evidence until equally clear experimental evidence is available.
