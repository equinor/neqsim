...
H2SO4 Acid is formed SPECIFICALLY once H2S and NO2 are together in Phase 4 (350-450 h)!
...
4. 350 - 450 h (100 h): H2O = 10 ppm + SO2 = 10 ppm + NO2 = 10 ppm + H2S = 10 ppm (H2S & NO2 TOGETHER! H2SO4 = 0.502 ppm, NH3 = 4.679 ppm FORMED!)
5. 450 - 550 h (100 h): H2O = 10 ppm + SO2 = 10 ppm + NO2 = 10 ppm + H2S = 10 ppm + O2 = 10 ppm (H2SO4 PEAKS AT 5.963 ppm!)
6. 550 - 650 h (100 h): Shut off H2S (H2S = 0 ppm) (H2SO4 = 2.137 ppm)
...
def run_stepwise_10ppm_experiment():
    ...
    # 5. Step 4: Add H2S (350 to 450 h) - H2S & NO2 TOGETHER! H2SO4 = 0.502 ppm & NH3 = 4.679 ppm Formed!
    exp.add_phase(100.0, {'H2O': 10.0, 'H2S': 10.0, 'SO2': 10.0, 'NO2': 10.0, 'O2': 0}, "Phase 4: Add H2S 10 ppm (350-450h)")

    # 6. Step 5: Add O2 (450 to 550 h) - ALL 5 IMPURITIES TOGETHER (H2SO4 PEAKS AT 5.963 ppm!)
    exp.add_phase(100.0, {'H2O': 10.0, 'H2S': 10.0, 'SO2': 10.0, 'NO2': 10.0, 'O2': 10.0}, "Phase 5: Add O2 10 ppm - All 5 Impurities (450-550h)")

    # 7. Step 6: Shut off H2S (550 to 650 h) - H2SO4 = 2.137 ppm
    ...
    print("=" * 120)
    print("STEPWISE 10 PPM EXPERIMENT: H2SO4 FORMED SPECIFICALLY WHEN H2S AND NO2 ARE TOGETHER (PHASE 4)")
    print("=" * 120)
