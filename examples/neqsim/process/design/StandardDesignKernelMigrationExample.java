...
public final class StandardDesignKernelMigrationExample {
  ...
  public static void main(String[] args) {
    StandardSelection selection = StandardSelection.strict(StandardType.API_526);
    ...
    System.out.println("Selected API 526 orifice: " + assessment.getSelectedOrifice());
    System.out.println("Adequate: " + assessment.isAdequate());
    ...
    System.out.println("Numeric regression passed; independent method qualification is still required.");
  }
}
