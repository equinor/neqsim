...
have coverage records, but only 20 have tool-specific trust pages; 40 generic-fallback tools have
bounded `CONTRACT_TESTED` evidence and 11 remain `CONFIRMED_GAP`. Test presence is not test
