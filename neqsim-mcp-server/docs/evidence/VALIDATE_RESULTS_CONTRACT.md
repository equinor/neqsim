...
Phase 0 inventory 1.38 retains this bounded behavior as **`CONTRACT_TESTED`** after merged PR #3406 established the
...
- `test_validate_results_protocol.py` repeats those boundaries through the real packaged STDIO server and proves that
  inventory 1.38 records 20 explicit + 38 contract-tested + 13 confirmed gaps.
