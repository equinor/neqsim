...
Phase 0 inventory 1.36 retains this bounded behavior as **`CONTRACT_TESTED`** after merged PR #3406 established the
...
- `test_validate_results_protocol.py` repeats those boundaries through the real packaged STDIO server and proves that
  inventory 1.36 records 20 explicit + 36 contract-tested + 15 confirmed gaps.
