...
Phase 0 inventory 1.35 retains this bounded behavior as **`CONTRACT_TESTED`** after merged PR #3406 established the
...
- `test_validate_results_protocol.py` repeats those boundaries through the real packaged STDIO server and proves that
  inventory 1.35 records 20 explicit + 35 contract-tested + 16 confirmed gaps.
