...
def test_contract_classification_is_promoted_atomically(client):
    ...
    require(limitations.get("contractTestedToolCount") == 25, "contract-tested count did not promote", result)
    require(limitations.get("confirmedGapToolCount") == 26, "confirmed-gap count did not promote", result)
