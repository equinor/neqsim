...
def test_contract_classification_is_promoted_atomically(client):
    ...
    require(limitations.get("contractTestedToolCount") == 48, "contract-tested count drifted", result)
    require(limitations.get("confirmedGapToolCount") == 3, "confirmed-gap count drifted", result)
