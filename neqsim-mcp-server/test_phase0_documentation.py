...
require(
    surface,
    "scientifically validated: 3 records remain\n"
...
contract_line = next(
    (
        ...
        if line.startswith("- Forty-eight bounded software contracts")
    ),
    None,
)
...
require(foundation, "- 3 tools remain `CONFIRMED_GAP`", FOUNDATION_PATH)
