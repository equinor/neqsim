...
def test_contract_classification_is_promoted_atomically(client):
    ...
    require(inventory.get("inventoryVersion") == "1.25", "unexpected evidence inventory version", result)
    limitations = inventory.get("knownLimitations", {})
    require(limitations.get("contractTestedToolCount") == 24, "contract-tested count did not promote", result)
    require(limitations.get("confirmedGapToolCount") == 27, "confirmed-gap count did not promote", result)
