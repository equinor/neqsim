...
calculation, validate against a physical limit, extract route selection, boundary definition, and evidence quality, and save the
...
that routine to the model in this chapter (route screening across grey, blue, green, pink, and selected carrier-adjacent H2 concepts) before treating any number
