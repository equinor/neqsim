...
calculation, validate against a physical limit, extract composition closure, dew point, water handling, and gas quality, and save the
...
that routine to the model in this chapter (feed gas, demineralized water, steam, shifted syngas, oxygen, and nitrogen) before treating any number
