...
calculation, validate against a physical limit, extract hydrogen yield, methane slip, furnace duty, and heat recovery, and save the
...
that routine to the model in this chapter (a conventional SMR, ATR, or POX front end) before treating any number
