...
1. Explain how to assemble feed preheat, desulfurization, reforming, cooling, and separation steps.
2. Translate the topic into a reproducible NeqSim Python workflow.
3. Identify the dominant assumptions and sanity checks for a conventional SMR, ATR, or POX front end.
...
Assemble feed preheat, desulfurization, reforming, cooling, and separation steps. The practical setting is a conventional SMR, ATR, or POX front end. In a desktop simulator this
...
4. Convert the output to engineering KPIs: hydrogen yield, methane slip, furnace duty, and heat recovery.
...
Specific NeqSim/Python surfaces and engineering references emphasized here: **SMRHydrogenPlantBuilder, ATRHydrogenPlantBuilder, POXHydrogenPlantBuilder, BlueHydrogenPlantBuilder, ReformerFurnace, CatalyticTubeReformer, WaterGasShiftReactor, ComponentCaptureUnit, AutothermalReformer, PartialOxidationReactor, QuenchSection, Stream, Heater, GibbsReactor, HeatExchanger, Separator, Recycle**.
...
# Route builders create feed streams, trace syngas species, reactor blocks, and optional PSA.
...
| Route | Conversion index | Duty index | H2/CO readiness index |
|---|---|---|---|
| SMR | 0.72 | 1.0 | 0.9 |
| ATR | 0.82 | 0.72 | 0.78 |
| POX | 0.7 | 0.62 | 0.58 |
| Blue SMR | 0.72 | 1.1 | 0.94 |

![Figure 9.2: Parameter study for SMR, ATR, POX, and blue-H2 route builders.](figures/parameter_reforming_route_builder_sweep.png)
...
chapter notebook should be longer and more explicit. For a conventional SMR, ATR, or POX front end, build the
...
| KPI cell | Extract hydrogen yield, methane slip, furnace duty, and heat recovery. | A table with units and engineering labels. |
...
For Reforming Plant Flowsheets, a strong final cell should contain a compact executive table. It
...
include hydrogen yield, methane slip, furnace duty, and heat recovery, plus a note about the thermodynamic model, the process
...
![Figure 9.1: Evidence-backed calculation and study basis for Reforming Plant Flowsheets.](figures/fig_ch09_reformer_flowsheet.png)
...
**Discussion.** The figure turns a conventional SMR, ATR, or POX front end into a data-backed study with traceable assumptions. The plotted values are generated from the chapter's calculation table, while the basis panel records the independent study or standard used to interpret hydrogen yield, methane slip, furnace duty, and heat recovery. The physical mechanism behind the figure is
...
remain in the model. For a conventional SMR, ATR, or POX front end, a simple equilibrium or equipment block is
...
case for a conventional SMR, ATR, or POX front end is converged, the next study can sweep feed composition,
...
For a conventional SMR, ATR, or POX front end, a useful design-review plot has three properties. First, the axes
...
- What decision would change if hydrogen yield, methane slip, furnace duty, and heat recovery moved by 10 percent?
...
- Set up a NeqSim Python notebook that addresses a conventional SMR, ATR, or POX front end with an explicit
  fluid, equipment block, run, and validation step.
- Identify the KPIs (hydrogen yield, methane slip, furnace duty, and heat recovery) and report them with units and a screening band.
...
This chapter positioned a conventional SMR, ATR, or POX front end inside a reproducible NeqSim workflow. The main
