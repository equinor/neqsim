...
calculation, validate against a physical limit, extract H2 purity, recovery, tail-gas composition, cycle assumptions, and CAPEX, and save the
...
that routine to the model in this chapter (hydrogen purification after shifted syngas) before treating any number
