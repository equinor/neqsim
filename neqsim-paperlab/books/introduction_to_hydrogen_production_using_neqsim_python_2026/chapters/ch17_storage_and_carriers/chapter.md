...
calculation, validate against a physical limit, extract stored kg H2, volumetric and gravimetric density, reconversion energy penalty, round-trip efficiency, and boil-off or release risk, and save the
...
that routine to the model in this chapter (stationary and transport hydrogen storage plus carrier value chains) before treating any number
