# Hydrogen End-Use: Power, Heat, Mobility, and Industry
...
1. Explain how to connect hydrogen production results to fuel-cell, gas-turbine, blending, refinery, fertilizer, steel, and synfuel end-use cases.
2. Translate the topic into a reproducible NeqSim Python workflow.
3. Identify the dominant assumptions and sanity checks for the demand side of the hydrogen value chain.
...
Connect hydrogen production results to fuel-cell, gas-turbine, blending, refinery,
fertilizer, steel, and synfuel end-use cases. The practical setting is the demand side of the hydrogen value chain. In a desktop simulator this
...
4. Convert the output to engineering KPIs: H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching.
...
Specific NeqSim/Python surfaces and engineering references emphasized here: **fuel-cell efficiency curves, gas-turbine fuel-gas screening, Standard_ISO6976 Wobbe checks, refinery hydrotreater H2 demand, ammonia and methanol synthesis, DRI steelmaking H2 demand**.
...
**Calculation basis.** Chapter-specific screening calculations for the demand side of the hydrogen value chain, normalized to the KPIs: H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching.
...
| H2 vol% in blend | Wobbe Index (MJ/Sm3) | LHV vol (MJ/Sm3) | Flame speed index | NOx attention |
|---|---|---|---|---|
| 0 | 50.7 | 36.0 | 1.0 | 1.0 |
| 5 | 50.3 | 35.0 | 1.08 | 1.02 |
| 10 | 49.8 | 34.0 | 1.18 | 1.05 |
| 20 | 48.6 | 32.0 | 1.42 | 1.15 |
| 30 | 47.1 | 30.0 | 1.72 | 1.3 |
| 50 | 43.5 | 25.6 | 2.5 | 1.75 |

![Figure 18.2: Wobbe Index and burner-tip behaviour vs hydrogen volume fraction in a natural-gas blend.](figures/parameter_h2_blending_wobbe.png)

The end-use chapter sweeps hydrogen volume fraction in a methane-dominated gas grid (0, 5, 10, 20, 30, 50 vol%) and tracks Wobbe Index, lower heating value (volumetric), laminar flame speed index, and a NOx-attention index for premix burners.
...
chapter notebook should be longer and more explicit. For the demand side of the hydrogen value chain, build the
...
| KPI cell | Extract H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching. | A table with units and engineering labels. |
...
For Hydrogen End-Use: Power, Heat, Mobility, and Industry, a strong final cell should contain a compact executive table. It
...
include H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching, plus a note about the thermodynamic model, the process
...
![Figure 18.1: Evidence-backed calculation and study basis for Hydrogen End-Use: Power, Heat, Mobility, and Industry.](figures/fig_ch18_end_use.png)
...
**Discussion.** The figure turns the demand side of the hydrogen value chain into a data-backed study with traceable assumptions. The plotted values are generated from the chapter's calculation table, while the basis panel records the independent study or standard used to interpret H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching. The physical mechanism behind the figure is
...
remain in the model. For the demand side of the hydrogen value chain, a simple equilibrium or equipment block is
...
case for the demand side of the hydrogen value chain is converged, the next study can sweep feed composition,
...
For the demand side of the hydrogen value chain, a useful design-review plot has three properties. First, the axes
...
- What decision would change if H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching moved by 10 percent?
...
- Set up a NeqSim Python notebook that addresses the demand side of the hydrogen value chain with an explicit
  fluid, equipment block, run, and validation step.
- Identify the KPIs (H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching) and report them with units and a screening band.
...
This chapter positioned the demand side of the hydrogen value chain inside a reproducible NeqSim workflow. The main
