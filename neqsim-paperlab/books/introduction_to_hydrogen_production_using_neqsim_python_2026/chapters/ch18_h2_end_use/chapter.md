...
calculation, validate against a physical limit, extract H2 demand by sector, end-use efficiency, blending limits, fuel-quality status, and value-chain matching, and save the
...
that routine to the model in this chapter (the demand side of the hydrogen value chain) before treating any number
