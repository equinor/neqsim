...
calculation, validate against a physical limit, extract CAPEX, OPEX, levelized cost, CEPCI escalation, sensitivity, and uncertainty, and save the
...
that routine to the model in this chapter (early concept screening for hydrogen projects) before treating any number
