# Capstone B: Green H2 Plant and Portfolio Comparison
...
1. Explain how to compare PEM, alkaline, SOEC, and AEM cases with compression, storage, and economics.
2. Translate the topic into a reproducible NeqSim Python workflow.
3. Identify the dominant assumptions and sanity checks for a green H2 portfolio study.
...
Compare PEM, alkaline, SOEC, and AEM cases with compression, storage, and economics. The practical setting is a green H2 portfolio study. In a desktop simulator this
...
4. Convert the output to engineering KPIs: specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation.
...
Specific NeqSim/Python surfaces and engineering references emphasized here: **ElectrolyzerTechnology, BatchStudy, optimization, cost estimates, reporting**.
...
def run_green_case(label, technology, water_kg_hr=1000.0):
...
| Technology | Specific energy index | Water intensity index | LCOH index |
|---|---|---|---|
| PEM | 1.0 | 1.0 | 1.0 |
| Alkaline | 0.98 | 1.02 | 0.88 |
| SOEC | 0.82 | 1.08 | 1.18 |
| AEM | 1.02 | 1.01 | 1.05 |

![Figure 25.2: Parameter study for green-H2 technology portfolio comparison.](figures/parameter_green_portfolio_comparison.png)

The green capstone study compares PEM, alkaline, SOEC, and AEM concepts with specific energy, water intensity, and LCOH screening index.
...
chapter notebook should be longer and more explicit. For a green H2 portfolio study, build the
...
| KPI cell | Extract specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation. | A table with units and engineering labels. |
...
For Capstone B: Green H2 Plant and Portfolio Comparison, a strong final cell should contain a compact executive table. It
...
include specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation, plus a note about the thermodynamic model, the process
...
![Figure 25.1: Evidence-backed calculation and study basis for Capstone B: Green H2 Plant and Portfolio Comparison.](figures/fig_ch25_green_portfolio.png)
...
**Discussion.** The figure turns a green H2 portfolio study into a data-backed study with traceable assumptions. The plotted values are generated from the chapter's calculation table, while the basis panel records the independent study or standard used to interpret specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation. The physical mechanism behind the figure is
...
remain in the model. For a green H2 portfolio study, a simple equilibrium or equipment block is
...
case for a green H2 portfolio study is converged, the next study can sweep feed composition,
...
For a green H2 portfolio study, a useful design-review plot has three properties. First, the axes
...
- What decision would change if specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation moved by 10 percent?
...
- Set up a NeqSim Python notebook that addresses a green H2 portfolio study with an explicit
  fluid, equipment block, run, and validation step.
- Identify the KPIs (specific energy, water intensity, capacity factor, LCOH, and portfolio recommendation) and report them with units and a screening band.
...
This chapter positioned a green H2 portfolio study inside a reproducible NeqSim workflow. The main
