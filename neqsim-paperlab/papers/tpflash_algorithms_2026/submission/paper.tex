...
\begin{highlights}
\item 100% convergence on 1664 flash cases across 6 natural gas families (4–11 components)
\item Hybrid SS–DEM–NR algorithm with Gibbs energy safeguard and near-critical stability retry
\item Sub-millisecond execution: median 0.088 ms, 95th percentile 0.371 ms
\item Computation time scales linearly with component count ($\sim$0.015 ms per component)
\item Open-source implementation in NeqSim with full reproducibility package
\end{highlights}

\end{frontmatter}

\section{Systematic Characterization of a Hybrid Successive-Substitution–Newton Flash Algorithm for Multicomponent Natural Gas Systems}
...
\textbf{Table 1.} Convergence and timing summary by fluid family.
...
\begin{itemize}
  \item Boston, J.F., Britt, H.I. (1978). A radically different formulation and solution of the single-stage flash problem. \textit{Comput. Chem. Eng.}, 2(2-3), 109–122.
  \item Crowe, C.M., Nishio, M. (1975). Convergence promotion in the simulation of chemical processes — the general dominant eigenvalue method. \textit{AIChE J.}, 21(3), 528–533.
  \item Michelsen, M.L. (1982a). The isothermal flash problem. Part I. Stability. \textit{Fluid Phase Equilib.}, 9(1), 1–19.
  \item Michelsen, M.L. (1982b). The isothermal flash problem. Part II. Phase-split calculation. \textit{Fluid Phase Equilib.}, 9(1), 21–40.
  \item Michelsen, M.L. (2001). State function based flash specifications. \textit{Fluid Phase Equilib.}, 193(1-2), 1–12.
  \item Michelsen, M.L., Mollerup, J.M. (2007). \textit{Thermodynamic Models: Fundamentals and Computational Aspects}, 2nd ed. Tie-Line Publications.
  \item Nielsen, R.F., Lia, E. (2023). A robust and efficient solution to the Rachford-Rice equations. \textit{Fluid Phase Equilib.}, 567, 113707.
  \item Rachford, H.H., Rice, J.D. (1952). Procedure for use of electronic digital computers in calculating flash vaporization hydrocarbon equilibrium. \textit{J. Pet. Technol.}, 4(10), 19–3.
  \item Risnes, R., Dalen, V., Jensen, J.I. (1981). Phase equilibrium calculations in the near-critical region. In: \textit{Proceedings of the European Symposium on Enhanced Oil Recovery}, Bournemouth, UK.
  \item Soave, G. (1972). Equilibrium constants from a modified Redlich-Kwong equation of state. \textit{Chem. Eng. Sci.}, 27(6), 1197–1203.
  \item Wilson, G.M. (1969). A modified Redlich-Kwong equation of state, application to general physical data calculations. \textit{Proc. AIChE National Meeting}, Cleveland, OH.
\end{itemize}
