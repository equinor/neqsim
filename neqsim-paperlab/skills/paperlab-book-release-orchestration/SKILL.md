---
name: paperlab-book-release-orchestration
description: |
...
- `paperlab-book-typesetting-release` for output formats,
- `paperlab-chapter-health-dashboard` for chapter readiness,
- `paperlab-notebook-regression-baselines` for computational gates.
