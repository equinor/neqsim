---
name: paperlab-curriculum-prerequisite-graph
description: |
...
- `paperlab-student-readability` for chapter-level learner friction,
- `paperlab-book-knowledge-graph` for graph output and visualization,
- `paperlab-learning-objective-matrix` for objective-level coverage.
