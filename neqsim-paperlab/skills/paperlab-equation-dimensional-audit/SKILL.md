---
name: paperlab-equation-dimensional-audit
description: |
...
- `paperlab-scientific-traceability-audit` for equation provenance,
- `neqsim-in-writing` for implementation links,
- `paperlab-standards-clause-traceability` for standards-based formulas.
