---
name: paperlab-exercise-difficulty-ramp
description: |
...
- `paperlab-learning-objective-matrix` for objective coverage,
- `paperlab-exam-alignment` for assessment fit,
- `paperlab-student-readability` for student-facing wording.
