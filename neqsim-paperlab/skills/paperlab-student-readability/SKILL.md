---
name: paperlab-student-readability
description: |
...
validation of NeqSim calculations. Pair with `paperlab-scientific-traceability-audit`
for scientific claims and `paperlab-book-typesetting-release` for final formats.
