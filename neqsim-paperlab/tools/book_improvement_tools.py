...
def _format_lecture_figure_plan_md(report: Dict) -> str:
    ...
    lines = [
        ...
        "",
        "Use this plan with the `technical-figure-understanding` skill. Review each",
...
CHAPTER_SKILL_RULES = [
    (range(1, 3), ["neqsim-field-development", "neqsim-capability-map",
                   "paperlab-student-readability", "paperlab-chapter-flow-editor"],
    ...
    (range(5, 11), ["neqsim-platform-modeling", "neqsim-flow-assurance",
                    ...
                    "neqsim-controllability-operability", "paperlab-student-readability",
    ...
    (range(15, 21), ["neqsim-model-calibration-and-data-reconciliation",
                     ...
                     "neqsim-field-economics", "paperlab-scientific-traceability-audit"],
    ...
    (range(22, 24), ["neqsim-ccs-hydrogen", "neqsim-technical-document-reading",
                     "neqsim-standards-lookup", "paperlab-scientific-traceability-audit"],
     "Deepen gas quality, CO2 impurity, injection, line-pack, and hydrogen sections."),
    (range(24, 27), ["neqsim-in-writing", "neqsim-professional-reporting",
                     "technical-figure-understanding", "paperlab-exam-alignment",
                     "paperlab-student-readability", "paperlab-scientific-traceability-audit",
    ...
    (range(27, 31), ["neqsim-field-development", "neqsim-field-economics",
                     "neqsim-professional-reporting", "paperlab-student-readability",
                     "paperlab-chapter-flow-editor",
                     "paperlab-scientific-traceability-audit"],
...
def build_skill_stack_plan(book_dir: Path | str) -> Dict:
    ...
    dimensions = [
        _dimension_record(
            "figure_intelligence",
            ["technical-figure-understanding", "figure-discussion", "generate-publication-figures"],
        ...
        _dimension_record(
            "traceability",
            ["paperlab-scientific-traceability-audit", "neqsim-professional-reporting",
             "neqsim-in-writing", "neqsim-notebook-patterns"],
        ...
        _dimension_record(
            "student_readability",
            ["paperlab-student-readability", "paperlab-exam-alignment"],
            ...
            "Review chapters missing objectives, summaries, or exercises with paperlab-student-readability."),
        _dimension_record(
            "chapter_flow",
            ["paperlab-chapter-flow-editor"],
            bool(conciseness)
        ...
        _dimension_record(
            "exam_alignment",
            ["paperlab-exam-alignment", "technical-figure-understanding"],
            bool(exam_alignment),
