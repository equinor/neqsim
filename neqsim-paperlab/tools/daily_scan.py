...
The issue workflow reads ``report_file`` from ``.pr_metadata.json`` to publish
the report generated by the selected mode, including the legacy fallback.
...
def main():
    ...
    parser.add_argument("--force", action="store_true",
                        help="Create issue even if nothing changed")
    ...
    if args.legacy:
        ...
        if not trending_ok:
            ...
            report_file = "trending_report.md" if args.full_scan else "daily_suggestion.md"
