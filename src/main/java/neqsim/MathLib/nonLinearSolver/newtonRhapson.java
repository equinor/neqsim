...
public class newtonRhapson extends Object implements  java.io.Serializable{
    ...
    public double solve(double xin){
       ...
       xNew = x - derivValue(x)/dubDerivValue(x) + Math.sqrt(derivValue(x)*derivValue(x)-2*funkValue(x)*dubDerivValue(x))/dubDerivValue(x);
       xNew2= x - derivValue(x)/dubDerivValue(x) - Math.sqrt(derivValue(x)*derivValue(x)-2*funkValue(x)*dubDerivValue(x))/dubDerivValue(x);
       }
        else{
    ...
    //    System.out.println("x++...........");
       ...
       // System.out.println("x--...........");
        ...
        if(iterations==maxIterations){System.out.println("Too many iterations...");}
