 ...
 /** Creates new nonlin */
	...
	public void setfvec()
	{
        ...
        public void findSpecEqInit(){
            ...
            for (int i=0;i<numberOfComponents;i++)
            {
                if(system.getPhases()[0].getComponents()[i].getTC()>system.getPhases()[0].getComponents()[speceq].getTC()) {
            ...
            avscp = (system.getPhases()[0].getComponents()[speceq].getTC()-system.getPhases()[0].getComponents()[speceqmin].getTC())/2000;
 ...
 //               System.out.println("dxidlnk("+i+") "+dxidlnk[i]);
    //            System.out.println("dyidlnk("+i+") "+dyidlnk[i]);
            ...
            for (int i=0;i<numberOfComponents;i++)
            {
                ...
                tempJ=system.getTemperature()*(system.getPhases()[1].getComponents()[i].getdfugdt()-system.getPhases()[0].getComponents()[i].getdfugdt());
                Jac.set(i,nofc,tempJ);
                tempJ=system.getPressure()*(system.getPhases()[1].getComponents()[i].getdfugdp()-system.getPhases()[0].getComponents()[i].getdfugdp());
...
// Here we find the next point from the polynomial.
            ...
            public void calcInc2(int np){             
                ...
                //       System.out.println("klnmax: " + u.get(numb,0) + "  np " + np + " xlnmax " + xlnkmax  + "avsxp " + avscp);
