...
public class ConstantMassExpansion extends BasePVTsimulation {
	...
	private double[] viscosity = null, viscosityOil=null, Zgas = null, density=null, Yfactor = null, isoThermalCompressibility = null, gasExpensionFactor=null, gasFormationVolumeFactor=null;
	...
	public void runCalc() {
		...
		for (int i = 0; i < pressures.length; i++) {
			...
			gasVolume[i]= getThermoSystem().getPhase(0).getNumberOfMolesInPhase()*getThermoSystem().getPhase(0).getMolarMass()/density[i] ;//getThermoSystem().getPhase(0).getVolume();
			gasStandardVolume[i] = getThermoSystem().getPhase(0).getVolume() * getThermoSystem().getPhase(0).getPressure() / 1.01325 / getThermoSystem().getPhase(0).getZ() * 288.15 / getThermoSystem().getTemperature();
	...
	public static void main(String[] args) {
		...
		CMEsim.setTemperaturesAndPressures(new double[] { 273.15+73.9, 273.15+73.9,273.15+73.9, 273.15+73.9, 273.15+73.9 },
