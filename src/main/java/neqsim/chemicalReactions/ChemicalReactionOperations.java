 ...
 * @version
 */
public class ChemicalReactionOperations extends Object implements neqsim.thermo.ThermodynamicConstantsInterface,Cloneable, java.io.Serializable {
        ...
        for(int j=0;j<componentNames.length;j++) {
           // System.out.println("component " + componentNames[j]);
            ...
            for(int i=0; i<allComponentNames.length;i++) {
             ...
             //       System.out.println("reactive comp " + system.getPhases()[1].getComponents()[j].getName());
                }
            }
        }
    }
    ...
    public String[] getAllElements(){
        ...
        for(int j=0;j<components.length;j++){
            for(int i=0; i<components[j].getElements().getElementNames().length;i++){
                //System.out.println("elements: " + components[j].getElements().getElementNames()[i]);
        ...
        for(int j=0;j<elementList.length;j++){
            System.out.println("elements2: " +elementList[j]);
        }
        */
        return elementList;
    }
    ...
    public void updateMoles(int phase){
        ...
        for(int i=0;i<components.length;i++){
            ...
            changeMoles += (newMoles[i]-system.getPhase(phase).getComponents()[components[i].getComponentNumber()].getNumberOfMolesInPhase());
             //           System.out.println("update moles first " + (components[i].getComponentName() + " moles " + components[i].getNumberOfMolesInPhase()));
            system.getPhase(phase).addMolesChemReac(components[i].getComponentNumber(),(newMoles[i]-system.getPhase(phase).getComponents()[components[i].getComponentNumber()].getNumberOfMolesInPhase()));
           // System.out.println("update moles after " + (components[i].getComponentName() + " moles " + components[i].getNumberOfMolesInPhase()));
        }}
