...
public class StratifiedFlowNode extends TwoPhaseFlowNode implements Cloneable {
  ...
  //      testSystem.addComponent("methane", 5.0, 0);
    ...
    //   testSystem.addComponent("n-pentane", 25.0, 1);
        ...
        //  
        // testSystem.addComponent("nitrogen", testSystem.getPhase(1).getMolarVolume() / testSystem.getPhase(0).getMolarVolume() * testSystem.getPhase(0).getComponent("CO2").getNumberOfmoles(), 0);
