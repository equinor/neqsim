 ...
 * @version
 */
public class TwoPhaseFixedStaggeredGridSolver extends TwoPhasePipeFlowSolver implements neqsim.thermo.ThermodynamicConstantsInterface{
    ...
    public void initProfiles(){
        ...
        for(int i = 1;i<numberOfNodes-1;i++){
            ...
            double liquidHeatRate = pipe.getNode(i).getFluidBoundary().getInterphaseHeatFlux(1)*pipe.getNode(i).getInterphaseContactArea()*(pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(1));
            double gasHeatRate = - pipe.getNode(i).getFluidBoundary().getInterphaseHeatFlux(0)*pipe.getNode(i).getInterphaseContactArea()*(pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(0));
            ...
            for(int componentNumber=0;componentNumber<pipe.getNode(0).getBulkSystem().getPhases()[0].getNumberOfComponents();componentNumber++){
                double liquidMolarRate =  pipe.getNode(i).getFluidBoundary().getInterphaseMolarFlux(componentNumber) * pipe.getNode(i).getInterphaseContactArea()*(pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(1));
                double gasMolarRate =  - pipe.getNode(i).getFluidBoundary().getInterphaseMolarFlux(componentNumber) * pipe.getNode(i).getInterphaseContactArea()*(pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(0));
                ...
                pipe.getNode(i+1).getBulkSystem().getPhases()[0].addMoles(componentNumber, molDiff[i-1][0][componentNumber]);
                pipe.getNode(i+1).getBulkSystem().getPhases()[1].addMoles(componentNumber, molDiff[i-1][1][componentNumber]);
        ...
        do{
            ...
            for(int i = 0;i<numberOfNodes-1;i++){
                ...
                dpdx = (pipe.getNode(i+1).getBulkSystem().getPressure()-pipe.getNode(i).getBulkSystem().getPressure())/((pipe.getNode(i+1).getGeometry().getNodeLength()+pipe.getNode(i).getGeometry().getNodeLength())*0.5);
                pipe.getNode(i+1).getBulkSystem().setTemperature((4.0*12.0*(278.0 - pipe.getNode(i).getBulkSystem().getPhases()[0].getTemperature())/ (pipe.getNode(i+1).getBulkSystem().getPhases()[0].getCp()/pipe.getNode(i+1).getBulkSystem().getPhases()[0].getNumberOfMolesInPhase()/pipe.getNode(i+1).getBulkSystem().getPhases()[0].getMolarMass()*pipe.getNode(i+1).getVelocity()*pipe.getNode(i+1).getGeometry().getDiameter()*pipe.getNode(i+1).getBulkSystem().getPhases()[0].getDensity())+pipe.getNode(i+1).getBulkSystem().getPhases()[0].getJouleThomsonCoefficient()*dpdx)*(pipe.getNode(i+1).getGeometry().getNodeLength()+pipe.getNode(i).getGeometry().getNodeLength())*0.5 + pipe.getNode(i).getBulkSystem().getTemperature());
                pipe.getNode(i+1).init();
         
                // setting pressures
                oldPres =  pipe.getNode(i+1).getBulkSystem().getPressure();
                pipe.getNode(i+1).getBulkSystem().setPressure(-pipe.getNode(i).getWallFrictionFactor()* pipe.getNode(i).getBulkSystem().getPhases()[0].getDensity()*pipe.velocity[i]*pipe.velocity[i]/pipe.getNode(i).getGeometry().getDiameter()/2.0*(pipe.getNode(i).getGeometry().getNodeLength())/1e5 - gravity*pipe.getNode(i).getBulkSystem().getPhases()[0].getDensity()*(pipe.getNode(i+1).getVerticalPositionOfNode() - pipe.getNode(i).getVerticalPositionOfNode() )/1e5 + pipe.getNode(i).getBulkSystem().getPressure());
                err = err+(oldPres-pipe.getNode(i+1).getBulkSystem().getPressure());
                pipe.getNode(i+1).init();
    ...
    public void setMassConservationMatrix(int phase){
        if(!dynamic){
            ...
            // System.out.println("new- old : " + (pipe.getNode(0).getVelocityIn().doubleValue() - oldVelocity[0]));
            oldMass[phase][0] = 1.0/timeStep*pipe.getNode(0).getGeometry().getArea() * pipe.getNode(0).getGeometry().getNodeLength();
        ...
        for(int i=1;i<numberOfNodes-1;i++){
            ...
            if(dynamic) {
                oldMass[phase][i] = 1.0/timeStep*pipe.getNode(i).getArea(phase) * pipe.getNode(i).getGeometry().getNodeLength();
            } else {
                oldMass[phase][i]=0.0;
            }
    ...
    public void setPhaseFractionMatrix(int phase){
        ...
        for(int i=1;i<numberOfNodes-1;i++){
            ...
            double Fe = pipe.getNode(i).getVelocityOut(phase).doubleValue() * Ae* pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity();
            double Fw = pipe.getNode(i).getVelocityIn(phase).doubleValue() * Aw * pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity();
            
            if(dynamic) {
                oldMass[phase][i] = 1.0/timeStep*pipe.getNode(i).getGeometry().getArea() * pipe.getNode(i).getGeometry().getNodeLength();
            } else {
                oldMass[phase][i]=0.0;
            }
        ...
        double Fe = pipe.getNode(i).getVelocity(phase) * Ae* pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity();
        double Fw = pipe.getNode(i).getVelocityIn(phase).doubleValue() * Aw * pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity();
    ...
    public void setImpulsMatrixTDMA(int phase){
        ...
        for(int i=2;i<numberOfNodes-1;i++){
            ...
            double meanDensity = pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity();
            double oldMeanDensity = oldDensity[phase][i];
            double meanVelocity = pipe.getNode(i-1).getVelocity(phase);
            double vertposchange = pipe.getNode(i).getVerticalPositionOfNode()  - pipe.getNode(i-1).getVerticalPositionOfNode();
            ...
            SU = - Amean*(pipe.getNode(i).getBulkSystem().getPressure() - pipe.getNode(i-1).getBulkSystem().getPressure())*1e5 + Amean*gravity*meanDensity*vertposchange + pipe.getNode(i-1).getWallContactLength(phase) * nodeLength* meanDensity * meanFrik*Math.abs(meanVelocity)*meanVelocity/8.0 - pipe.getNode(i-1).getInterphaseContactLength(0)*nodeLength* meanDensity * interfaceFricition*Math.abs(pipe.getNode(i).getVelocity(0) - pipe.getNode(i).getVelocity(1))*(pipe.getNode(i).getVelocity(0) - pipe.getNode(i).getVelocity(1))/8.0*sign;
            // System.out.println("su " + SU);
            SP = - pipe.getNode(i-1).getWallContactLength(phase)* nodeLength* meanDensity * meanFrik*meanVelocity/4.0;
            Fw = Aw * pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i-1).getVelocity(phase);
            Fe = Ae * pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i).getVelocity(phase);
        ...
        SU = - Amean*(pipe.getNode(i).getBulkSystem().getPressure() - pipe.getNode(i-1).getBulkSystem().getPressure())*1e5 - Amean*gravity*meanDensity*vertposchange + pipe.getNode(i-1).getWallContactLength(phase) * nodeLength* meanDensity * meanFrik*Math.abs(meanVelocity)*meanVelocity/8.0 - pipe.getNode(i-1).getInterphaseContactLength(0)*nodeLength* meanDensity * interfaceFricition*Math.abs(pipe.getNode(i).getVelocity(0) - pipe.getNode(i).getVelocity(1))*(pipe.getNode(i).getVelocity(0) - pipe.getNode(i).getVelocity(1))/8.0*sign;
        SP = - pipe.getNode(i-1).getWallContactLength(phase) * nodeLength* meanDensity * meanFrik*meanVelocity/4.0;
        Fw = Aw * pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i).getVelocityIn(phase).doubleValue();
        Fe = Ae * pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i).getVelocity(phase);
    ...
    public void setEnergyMatrixTDMA(int phase){
        ...
        b[0] = 1.0;
        c[0] = 0;
        double SU = pipe.getNode(0).getBulkSystem().getPhases()[phase].getEnthalpy()/pipe.getNode(0).getBulkSystem().getPhases()[phase].getNumberOfMolesInPhase()/pipe.getNode(0).getBulkSystem().getPhases()[phase].getMolarMass();
        r[0] = SU;
        
        for(int i=1;i<numberOfNodes-1;i++){
            double fe = pipe.getNode(i+1).getGeometry().getNodeLength()/(pipe.getNode(i).getGeometry().getNodeLength() + pipe.getNode(i+1).getGeometry().getNodeLength());
            double fw = pipe.getNode(i-1).getGeometry().getNodeLength()/(pipe.getNode(i).getGeometry().getNodeLength() + pipe.getNode(i-1).getGeometry().getNodeLength());
            double Ae = pipe.getNode(i).getArea(phase);
            double Aw = pipe.getNode(i-1).getArea(phase) ;
            double vertposchange = (1-fe) * (pipe.getNode(i+1).getVerticalPositionOfNode()-pipe.getNode(i).getVerticalPositionOfNode()) + (1-fw) * (pipe.getNode(i).getVerticalPositionOfNode()-pipe.getNode(i-1).getVerticalPositionOfNode());
            
            SU = - pipe.getNode(i).getArea(phase)* gravity * pipe.getNode(i).getBulkSystem().getPhases()[phase].getDensity() * pipe.getNode(i).getVelocity(phase) * vertposchange  + pipe.getNode(i).getArea(phase)*4.0*0.02*(278.0-pipe.getNode(i).getBulkSystem().getPhases()[phase].getTemperature())/(pipe.getNode(i).getGeometry().getDiameter())*pipe.getNode(i).getGeometry().getNodeLength()  + sign * pipe.getNode(i).getFluidBoundary().getInterphaseHeatFlux(phase)*pipe.getNode(i).getGeometry().getNodeLength()*pipe.getNode(i).getInterphaseContactLength(phase)* (pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(phase));
            double SP = 0;
            
            double Fw = Aw * pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()* pipe.getNode(i).getVelocityIn(phase).doubleValue();
            double Fe = Ae * pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i).getVelocityOut(phase).doubleValue();
            
            if(dynamic) {
                oldEnergy[phase][i] = 1.0/timeStep*oldDensity[phase][i] * pipe.getNode(i).getGeometry().getNodeLength() * pipe.getNode(i).getArea(phase);
            } else {
        ...
        double fw = pipe.getNode(i-1).getGeometry().getNodeLength()/(pipe.getNode(i).getGeometry().getNodeLength() + pipe.getNode(i-1).getGeometry().getNodeLength());
        double Ae = pipe.getNode(i).getArea(phase) ;//1.0/((1.0-fe)/pipe.getNode(i).getGeometry().getArea() + fe/pipe.getNode(i+1).getGeometry().getArea());
        double Aw = pipe.getNode(i-1).getArea(phase) ;//1.0/((1.0-fw)/pipe.getNode(i).getGeometry().getArea() + fw/pipe.getNode(i-1).getGeometry().getArea());
        double vertposchange = (1-fw) * (pipe.getNode(i).getVerticalPositionOfNode()-pipe.getNode(i-1).getVerticalPositionOfNode());
        ...
        double Fw = Aw*pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()* pipe.getNode(i).getVelocityIn(phase).doubleValue();
        double Fe = Ae*pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity() * pipe.getNode(i).getVelocity(phase);
    ...
    public void setComponentConservationMatrix2(int phase, int componentNumber){
        ...
        // System.out.println("phase x0: " +pipe.getNode(0).getBulkSystem().getPhases()[0].getComponents()[componentNumber].getx());
        // System.out.println("phase x1: " +pipe.getNode(0).getBulkSystem().getPhases()[1].getComponents()[componentNumber].getx());
        r[0] = SU;
        
        for(int i=1;i<numberOfNodes-1;i++){
            double fe = pipe.getNode(i+1).getGeometry().getNodeLength()/(pipe.getNode(i).getGeometry().getNodeLength()+pipe.getNode(i+1).getGeometry().getNodeLength());
            double fw = pipe.getNode(i-1).getGeometry().getNodeLength()/(pipe.getNode(i).getGeometry().getNodeLength()+pipe.getNode(i-1).getGeometry().getNodeLength());
            double Ae = 1.0/((1.0-fe)/pipe.getNode(i).getArea(phase) + fe/pipe.getNode(i+1).getArea(phase));
            double Aw = 1.0/((1.0-fw)/pipe.getNode(i).getArea(phase) + fw/pipe.getNode(i-1).getArea(phase));
            
            double Fe = pipe.getNode(i).getVelocityOut(phase).doubleValue()*pipe.getNode(i).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()*pipe.getNode(i).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getMolarMass()/pipe.getNode(i).getBulkSystem().getPhases()[phase].getMolarMass()*Ae;
            double Fw = pipe.getNode(i).getVelocityIn(phase).doubleValue()*pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()*pipe.getNode(i).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getMolarMass()/pipe.getNode(i).getBulkSystem().getPhases()[phase].getMolarMass()*Aw;
            
            //System.out.println("vel: " + pipe.getNode(i).getVelocityOut(phase).doubleValue() + " fe " + Fe);
            a[i] = Math.max(Fw,0);
            c[i] = Math.max(-Fe,0);//- Fe/2.0;
        ...
        c[numberOfNodes-1] = 0;
        SU = pipe.getNode(numberOfNodes-2).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()*pipe.getNode(numberOfNodes-2).getVelocityIn(phase).doubleValue()*pipe.getNode(numberOfNodes-2).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getx()
        /
        (pipe.getNode(numberOfNodes-1).getBulkSystem().getPhases()[phase].getPhysicalProperties().getDensity()*pipe.getNode(numberOfNodes-1).getVelocityIn(phase).doubleValue());
    ...
    public void setComponentConservationMatrix(int phase, int componentNumber){
        ...
        b[0] = 1.0;
        c[0] = 0;
        SU = pipe.getNode(0).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getx()*pipe.getNode(0).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getMolarMass()/pipe.getNode(0).getBulkSystem().getPhases()[phase].getMolarMass();
        r[0] = SU;
        ...
        for(int i=1;i<numberOfNodes-1;i++){
            ...
            double Fe = pipe.getNode(i).getVelocityOut(phase).doubleValue()*pipe.getNode(i).getBulkSystem().getPhases()[phase].getDensity()*Ae;
            double Fw = pipe.getNode(i).getVelocityIn(phase).doubleValue()*pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getDensity()*Aw;
            //System.out.println("vel: " + pipe.getNode(i).getVelocityOut(phase).doubleValue() + " fe " + Fe);
            if(dynamic) {
                oldComp[phase][i] = 1.0/timeStep * pipe.getNode(i).getArea(phase) * pipe.getNode(i).getGeometry().getNodeLength()*pipe.getNode(i).getBulkSystem().getPhases()[phase].getDensity();
            } else {
                oldComp[phase][i]=0.0;
            }
            
            SU =  + sign * pipe.getNode(i).getFluidBoundary().getInterphaseMolarFlux(componentNumber)*pipe.getNode(i).getBulkSystem().getPhases()[phase].getComponents()[componentNumber].getMolarMass()*pipe.getNode(i).getGeometry().getNodeLength()*pipe.getNode(i).getInterphaseContactLength(phase)* (pipe.getNode(i).getGeometry().getNodeLength()/pipe.getNode(i).getVelocity(phase));
            double SP = 0;//-pipe.getNode(i).getGeometry().getArea()*4.0*12.0/(pipe.getNode(i).getGeometry().getDiameter())*pipe.getNode(i).getGeometry().getNodeLength();
        ...
        double Fe = pipe.getNode(i).getVelocity(phase)*pipe.getNode(i).getBulkSystem().getPhases()[phase].getDensity()*Ae;
        double Fw = pipe.getNode(i).getVelocityIn(phase).doubleValue()*pipe.getNode(i-1).getBulkSystem().getPhases()[phase].getDensity()*Aw;
    ...
    public void initFinalResults(int phase){
        for(int i=0;i<numberOfNodes;i++){
            ...
            for(int j=0;j<pipe.getNode(i).getBulkSystem().getPhases()[0].getNumberOfComponents();j++){
                oldComposition[phase][j][i] = xNew[phase][j][i]; //pipe.getNode(i).getBulkSystem().getPhases()[0].getComponents()[j].getx() * pipe.getNode(i).getBulkSystem().getPhases()[0].getComponents()[j].getMolarMass()/pipe.getNode(i).getBulkSystem().getPhases()[0].getMolarMass();
            }
        }
    }
    ...
    public void solveTDMA(){
        ...
        initProfiles();
        dn = new double[numberOfNodes][pipe.getNode(0).getBulkSystem().getPhases()[0].getNumberOfComponents()];
        xNew = new double[2][pipe.getNode(0).getBulkSystem().getPhases()[0].getNumberOfComponents()][numberOfNodes];
        initMatrix();
        ...
        do{
            ...
            if(this.solverType>=5){
                for(int phase=0;phase<2;phase++){
                    do {
                        ...
                        //System.out.println("diff impuls: "+ diffMatrix.norm2()/solMatrix[phase].norm2());
            ...
            if(this.solverType>=5){
                for(int phase=1;phase<2;phase++){
                    do {
                        ...
                        //System.out.println("diff phase frac: "+ diffMatrix.norm2()/solPhaseConsMatrix[phase].norm2());
                ...
                do {
                    ...
                    //solPhaseConsMatrix[phase].print(10,10);
                    diffMatrix = solPhaseConsMatrix[phase].minus(solOld);
                    //System.out.println("diff mass: "+ diffMatrix.norm2()/solPhaseConsMatrix[phase].norm2());
                    diff = Math.abs(diffMatrix.norm1()/solPhaseConsMatrix[phase].norm1());
                    if(diff>maxDiff) {
                        maxDiff = diff;
                    }
            ...
            if(this.solverType>=5){
                for(int phase=0;phase<2;phase++){
                    ...
                    do{
                        ...
                        // System.out.println("diff energy: " + diffMatrix.norm2()/sol3Matrix[phase].norm2());
            ...
            if(this.solverType>=5){
                ...
                do{
                    ...
                    for(int phase=0;phase<2;phase++){
                        iter=0;
                        for(int p=0;p<pipe.getNode(0).getBulkSystem().getPhases()[0].getNumberOfComponents()-1;p++){
                            do{
                                iter++;
                                ...
                                System.out.println("diff molfrac: "+ diffMatrix.norm2()/solMolFracMatrix[phase][p].norm2());
