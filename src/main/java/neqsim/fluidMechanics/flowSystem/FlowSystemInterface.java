...
/**
 * <p>FlowSystemInterface interface.</p>
 *
 * @author Even Solbraa
 * @version $Id: $Id
 */
public interface FlowSystemInterface {
     ...
     * <p>getDisplay.</p>
     *
     * @return a {@link neqsim.fluidMechanics.util.fluidMechanicsVisualization.flowSystemVisualization.FlowSystemVisualizationInterface} object
     */
     ...
     *
     * @param i a int
     * @return a {@link neqsim.fluidMechanics.util.fluidMechanicsDataHandeling.FileWriterInterface} object
     */
    ...
    /**
     * <p>setLegOuterHeatTransferCoefficients.</p>
     *
    ...
    /**
     * <p>setLegWallHeatTransferCoefficients.</p>
     *
     * @param coefs an array of {@link double} objects
     */
     ...
     *
     * @param equipmentGeometry an array of {@link neqsim.fluidMechanics.geometryDefinitions.GeometryDefinitionInterface} objects
     */
    public void setEquipmentGeometry(GeometryDefinitionInterface[] equipmentGeometry);

    /**
     * <p>getTotalNumberOfNodes.</p>
     *
     * @return a int
     */
    ...
    /**
     * <p>getTotalMolarMassTransferRate.</p>
     *
    ...
    /**
     * <p>setEquilibriumMassTransfer.</p>
     *
    ...
    /**
     * <p>setEquilibriumHeatTransfer.</p>
     *
     * @param test a boolean
     */
