...
public class StirredCellSystem extends neqsim.fluidMechanics.flowSystem.twoPhaseFlowSystem.TwoPhaseFlowSystem {
    ...
    public void createSystem(){
        ...
        flowNode[0] = new neqsim.fluidMechanics.flowNode.twoPhaseNode.twoPhaseStirredCellNode.StirredCellNode(thermoSystem, equipmentGeometry[0]);
    ...
    public void solveSteadyState(int solverType){
         flowSolver = new neqsim.fluidMechanics.flowSolver.twoPhaseFlowSolver.stirredCellSolver.StirredCellSolver(this, getSystemLength(), getTotalNumberOfNodes(), false); 
    }
    
    public void solveTransient(int solverType){
        getTimeSeries().init(this);
        display = new neqsim.fluidMechanics.util.fluidMechanicsVisualization.flowSystemVisualization.twoPhaseFlowVisualization.twoPhasePipeFlowVisualization.TwoPhasePipeFlowVisualization(this.getTotalNumberOfNodes(),getTimeSeries().getTime().length);
