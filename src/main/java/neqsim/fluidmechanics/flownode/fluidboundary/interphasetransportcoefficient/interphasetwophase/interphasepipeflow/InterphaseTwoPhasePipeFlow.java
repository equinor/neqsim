 ...
 * numbers (mass transfer) and Nusselt numbers (heat transfer) based on flow pattern-specific correlations.
 * </p>
 *
 * @author esol
 * @version $Id: $Id
...
public class InterphaseTwoPhasePipeFlow extends InterphaseTwoPhase {
  ...
  public double calcWallSherwoodNumber(int phaseNum, double reynoldsNumber, double schmidtNumber,
    ...
    if (reynoldsNumber < 2300) {
      ...
      double denominator = 1.0 + 12.7 * Math.sqrt(f / 8.0) * (Math.pow(schmidtNumber, 2.0 / 3.0) - 1.0);
