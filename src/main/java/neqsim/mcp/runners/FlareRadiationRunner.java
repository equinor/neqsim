 ...
 *
 * <p>
 * Computes the radiant heat flux at user-specified ground distances and the safe distance to a given flux threshold
 * (default API 521 thresholds: 1.58 / 4.73 / 6.31 / 9.46 kW/m²).
 * </p>
 *
 * @author Even Solbraa
 * @version 1.0
