 ...
 *
 * <p>
 * The runner consumes normalized technical-document and instrument-data evidence. If supplied, it also embeds outputs
 * from the existing safety-system performance runner, operational-study runner, and dynamic simulation runner, so a
 * single result can show clause findings alongside calculated barrier, tagreader, and transient process evidence.
 * </p>
 *
