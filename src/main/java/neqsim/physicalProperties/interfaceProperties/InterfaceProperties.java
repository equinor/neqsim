...
public class InterfaceProperties implements InterphasePropertiesInterface, java.io.Serializable, Cloneable {
    ...
    public void init() {
        ...
        if (gasLiquidSurfaceTensionCalc == null || gasAqueousSurfaceTensionCalc == null || liquidLiquidSurfaceTensionCalc == null) {
    ...
    /*
     public double getSurfaceTension(int numb) {
     if (numb >= numberOfInterfaces) {
     return 0.0;
     } else {
     return surfaceTension[numb];
     }
     }
     */
    public double getSurfaceTension(int numb1, int numb2) {

        if (system.getPhase(numb1).getPhaseTypeName().equals("gas") && system.getPhase(numb2).getPhaseTypeName().equals("oil")) {
            return gasLiquidSurfaceTensionCalc.calcSurfaceTension(numb1, numb2);
        } else if (system.getPhase(numb1).getPhaseTypeName().equals("gas") && system.getPhase(numb2).getPhaseTypeName().equals("aqueous")) {
    ...
    public void setInterfacialTensionModel(String phase1, String phase2, String model) {
        ...
        if (phase1.equals(
                "gas") && phase2.equals("oil")) {
            gasLiquidSurfaceTensionCalc = surfTensModel;
        } else if (phase1.equals(
                "gas") && phase2.equals("aqueous")) {
            gasAqueousSurfaceTensionCalc = surfTensModel;
        } else if (phase1.equals(
                "oil") && phase2.equals("aqueous")) {
    ...
    public void setInterfacialTensionModel(int interfacialTensionModel) {
        ...
        if (interfacialTensionModel == 0) {
            ...
            //  liquidLiquidSurfaceTensionCalc = new GTSurfaceTension(system); //Sintef method
