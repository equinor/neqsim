...
/**
 * <p>PFCTViscosityMethodHeavyOil class.</p>
 *
 * @author esol
...
public class PFCTViscosityMethodHeavyOil extends Viscosity {
    ...
    /**
     * <p>Constructor for PFCTViscosityMethodHeavyOil.</p>
     */
	...
	public double calcViscosity() {
        ...
        if (T0 < 75.0) {
            ...
            double LOviscosity = refVisosity * Math.pow(TCmix / Tc0, -1.0 / 6.0) * Math.pow(PCmix / Pc0, 2.0 / 3.0)
