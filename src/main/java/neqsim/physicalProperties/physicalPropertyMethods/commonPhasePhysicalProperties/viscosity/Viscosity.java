    ...
    public void calcPureComponentViscosity() {
        ...
        for (int i = 0; i < phase.getPhase().getNumberOfComponents(); i++) {
            ...
            if (phase.getPhase().getTemperature() > phase.getPhase().getComponents()[i].getTC()) {
                ...
                pureComponentViscosity[i] = phase.getPhase().getComponents()[i].getLiquidViscosityParameter(0)
                ...
                pureComponentViscosity[i] = Math.exp(phase.getPhase().getComponents()[i].getLiquidViscosityParameter(0)
                        + phase.getPhase().getComponents()[i].getLiquidViscosityParameter(1)
