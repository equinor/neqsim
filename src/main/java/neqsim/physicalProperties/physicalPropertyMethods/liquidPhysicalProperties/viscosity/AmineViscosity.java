...
public class AmineViscosity extends Viscosity{
    ...
    public double calcViscosity(){
        super.calcViscosity();
        double wtFracA = liquidPhase.getPhase().getComponent("MDEA").getx()*liquidPhase.getPhase().getComponent("MDEA").getMolarMass()/liquidPhase.getPhase().getMolarMass();
        wtFracA += liquidPhase.getPhase().getComponent("MDEA+").getx()*liquidPhase.getPhase().getComponent("MDEA+").getMolarMass()/liquidPhase.getPhase().getMolarMass();
