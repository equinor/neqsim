...
public class TestInfluenceParamGTFunction extends java.lang.Object {
    ...
    public static void main(String[] args) {
        ...
        //double guess[] = { -0.7708158524, 0.4990571549, 0.8645478315, -0.3509810630, -0.1611763157}; // SRK param
         double guess[] = { -0.0286407191587279700, -1.85760887578596, 0.520588, -0.1386439759, 1.1216308727071944}; // CPA param
...
/*
        dataSet = database.getResultSet("NeqSimDataBase", "SELECT * FROM BinaryComponentSurfaceTension WHERE Include=1");//  AND ComponentName<>'nC12'  AND ComponentName<>'nC13'");
