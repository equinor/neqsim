...
public abstract class Viscosity extends CommonPhysicalPropertyMethod implements ViscosityInterface {
  ...
  public void calcPureComponentViscosity() {
	...
	pureComponentViscosity[i] = phase.getPhase().getComponent(i).getLiquidViscosityParameter(0) * Math
	    .pow(phase.getPhase().getTemperature(), phase.getPhase().getComponent(i).getLiquidViscosityParameter(1));
	...
	pureComponentViscosity[i] = Math.exp(phase.getPhase().getComponent(i).getLiquidViscosityParameter(0)
	    + phase.getPhase().getComponent(i).getLiquidViscosityParameter(1) / phase.getPhase().getTemperature()
	    + phase.getPhase().getComponent(i).getLiquidViscosityParameter(2) * phase.getPhase().getTemperature()
	...
	pureComponentViscosity[i] = Math.pow(10,
	    phase.getPhase().getComponent(i).getLiquidViscosityParameter(0) * (1.0 / phase.getPhase().getTemperature()
