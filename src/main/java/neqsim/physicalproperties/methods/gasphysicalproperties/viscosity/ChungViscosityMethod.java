...
public class ChungViscosityMethod extends Viscosity {
  ...
  protected double[][] chungHPcoefs = { { 6.324, 50.412, -51.680, 1189.0 }, { 1.210e-3, -1.154e-3, -6.257e-3, 0.03728 },
      { 5.283, 254.209, -168.48, 3898.0 }, { 6.623, 38.096, -8.464, 31.42 }, { 19.745, 7.630, -14.354, 31.53 },
      { -1.9, -12.537, 4.985, -18.15 }, { 24.275, 3.450, -11.291, 69.35 }, { 0.7972, 1.117, 0.01235, -4.117 },
  ...
  public void initChungPureComponentViscosity() {
    ...
    for (int i = 0; i < gasPhase.getPhase().getNumberOfComponents(); i++) {
      ...
      tempVar = 1.2593 * gasPhase.getPhase().getTemperature() / gasPhase.getPhase().getComponent(i).getTC();
      // eq. 9.4.3 TPoLG
