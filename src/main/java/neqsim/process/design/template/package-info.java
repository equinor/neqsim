 ...
 *
 * <p>
 * This package contains pre-built templates for standard process configurations that can be instantiated with a
 * {@link neqsim.process.design.ProcessBasis} to create complete process systems.
 * </p>
 *
 * <h2>Available Templates</h2>
 * <ul>
 * <li>{@link neqsim.process.design.template.ThreeStageSeparationTemplate} - Standard HP/MP/LP separation train</li>
 * </ul>
 *
 * <h2>Usage Example</h2>
 *
 ...
 * ProcessBasis basis = ProcessBasis.builder().feedFluid(myOilGasFluid).feedFlowRate(5000.0, "Sm3/hr")
 *     .stagePressures(80.0, 20.0, 2.0).build();
 *
