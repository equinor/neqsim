 ...
 * is used by diagnostic hypothesis-generation logic to produce candidate root causes ranked by prior
 * probability from OREDA failure data.
 * </p>
 *
...
public enum Symptom {
  ...
  HIGH_VIBRATION("High vibration",
      Arrays.asList("MECHANICAL", "PROCESS")),
  ...
  FOULING("Fouling or plugging",
      Arrays.asList("PROCESS", "EXTERNAL")),
  ...
  LIQUID_CARRYOVER("Liquid carryover",
      Arrays.asList("PROCESS", "CONTROL"));
