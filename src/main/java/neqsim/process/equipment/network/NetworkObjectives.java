...
public final class NetworkObjectives {
  ...
  public static NetworkObjective maximizeThroughput(double weight) {
    return custom("throughputKgHr", weight,
        new Evaluator() {
   ...
   * @return objective
   */
  public static NetworkObjective minimizeCompressorPower(
      double weight) {
    return custom("negativeCompressorPowerKW", weight,
        new Evaluator() {
          private static final long serialVersionUID = 1000L;
   ...
   * @return objective
   */
  public static NetworkObjective custom(final String name,
      final double weight, final Evaluator evaluator) {
