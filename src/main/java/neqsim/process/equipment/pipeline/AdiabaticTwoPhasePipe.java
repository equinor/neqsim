...
public class AdiabaticTwoPhasePipe extends Pipeline {
  ...
  public double calcPressureOut() {
	...
	/ Math.pow(insideDiameter * 1000, 5.0) / system.getDensity("kg/m3") / 100.0 * 1000.0 * length;
   ...
   *
   * <p>
   * Calculates the flow rate required to achieve the specified outlet pressure using bisection iteration. This method
   * iteratively adjusts the flow rate until the calculated outlet pressure matches the target outlet pressure.
   * </p>
   *
