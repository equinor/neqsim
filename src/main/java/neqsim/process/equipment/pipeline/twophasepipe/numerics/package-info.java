 ...
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link neqsim.process.equipment.pipeline.twophasepipe.numerics.AUSMPlusFluxCalculator} - Advection Upstream
 * Splitting Method</li>
 * <li>{@link neqsim.process.equipment.pipeline.twophasepipe.numerics.MUSCLReconstructor} - Second-order spatial
 * reconstruction</li>
 * <li>{@link neqsim.process.equipment.pipeline.twophasepipe.numerics.TimeIntegrator} - Time stepping algorithms</li>
 * </ul>
 *
 * <h2>Numerical Scheme</h2>
 * <p>
 * The default scheme uses AUSM+ flux splitting, which is well-suited for multiphase flows with large density ratios.
 * Time integration uses explicit RK4 with CFL-based adaptive stepping.
 * </p>
 *
 * <h2>References</h2>
 * <ul>
