 ...
 *
 * <p>
 * Models isentropic expansion with a specified efficiency. The outlet stream conditions are computed by performing an
 * isentropic flash at the outlet pressure, then applying the isentropic efficiency to determine the actual outlet
 ...
 * @version 1.0
 */
public class SteamTurbine extends TwoPortEquipment implements CapacityConstrainedEquipment, AutoSizeable {
