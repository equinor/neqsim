...
/**
 * Alternative pump chart implementation extending the compressor chart with map lookup and extrapolation, adding
 * pump-specific features: NPSH curves, density correction, viscosity correction (HI method), BEP identification,
 * specific speed, and operating status monitoring.
 *
 * <p>
 * Delegates base head and efficiency to the compressor chart's polytropic methods, then applies pump-specific
 * corrections on top.
 * </p>
 *
 * @author ESOL
 * @version $Id: $Id
 */
public class PumpChartAlternativeMapLookupExtrapolate extends CompressorChartAlternativeMapLookupExtrapolate
