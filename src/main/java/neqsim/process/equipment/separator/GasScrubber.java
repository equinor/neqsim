 ...
 * standard separators, the key performance metric is the K-value (Souders-Brown factor) rather than liquid retention
 * time.
 * </p>
 *
 ...
 *
 * <p>
 * The orientation is automatically set to "vertical" and the design liquid level fraction defaults to 0.1 (10%),
 * reflecting that scrubbers hold very little liquid. For dry gas (no liquid phase), a default liquid density of 1000
 * kg/m³ is used.
 * </p>
 *
 * <p>
