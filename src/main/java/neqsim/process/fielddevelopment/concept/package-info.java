 ...
 *
 * <p>
 * This package provides the input data structures for defining field development concepts at a high level, enabling
 * rapid iteration during early project phases. All classes use the builder pattern for fluent, readable construction.
 * </p>
 *
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link neqsim.process.fielddevelopment.concept.FieldConcept} - Main concept container combining reservoir, wells,
 * and infrastructure into a complete development scenario</li>
 * <li>{@link neqsim.process.fielddevelopment.concept.ReservoirInput} - Reservoir fluid properties including
 * composition, temperature, pressure, and contaminants (CO2, H2S)</li>
 * <li>{@link neqsim.process.fielddevelopment.concept.WellsInput} - Well count, deliverability, and operating
 * conditions</li>
 * <li>{@link neqsim.process.fielddevelopment.concept.InfrastructureInput} - Processing location (platform/FPSO/subsea),
 * export route, and power source</li>
 * </ul>
 *
 * <h2>Enumerations</h2>
 * <ul>
