 ...
 *
 * <p>
 * This package provides a fluent API for assembling facility configurations from pre-validated process blocks. It
 * enables rapid, concept-level facility design without requiring detailed equipment parameters upfront.
 * </p>
 *
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link neqsim.process.fielddevelopment.facility.FacilityBuilder} - Fluent builder for constructing facility
 * configurations from process blocks</li>
 * <li>{@link neqsim.process.fielddevelopment.facility.BlockType} - Enumeration of available process block types
 * (separation, compression, dehydration, CO2 removal, etc.)</li>
 * <li>{@link neqsim.process.fielddevelopment.facility.BlockConfig} - Configuration for individual process blocks with
 * type-specific parameters</li>
 * <li>{@link neqsim.process.fielddevelopment.facility.FacilityConfig} - Immutable facility configuration containing all
 * blocks</li>
 * </ul>
 *
 ...
 *     .addBlock(BlockConfig.of(BlockType.CO2_REMOVAL_AMINE).withParameter("capacity_mmscfd", 200.0))
