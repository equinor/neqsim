 ...
 *
 * <p>
 * For a dry/wet gas reservoir without water influx the p/z material balance is linear in cumulative production:
 * </p>
 *
 * <p>
 * p/z = (p_i/z_i) (1 - G_p / G)
 ...
 *
 * <p>
 * where {@code p_i} and {@code z_i} are the initial pressure and gas deviation factor, {@code G} is the initial gas in
 * place (GIIP, surface Sm3) and {@code G_p} is the cumulative gas produced. A constant average {@code z} is used here
 * for a fast surrogate suitable for screening and integrated network coupling; the pressure therefore declines
 * essentially linearly with recovery.
 * </p>
 *
 * @author NeqSim
 * @version 1.0
