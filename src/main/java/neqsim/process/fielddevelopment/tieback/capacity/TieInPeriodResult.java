...
public final class TieInPeriodResult implements Serializable {
  ...
  public TieInPeriodResult(String periodName, int year, ProductionLoad baseRequest, ProductionLoad acceptedBase,
      ...
      ProductionLoad acceptedSatellite, ProductionLoad heldBackSatellite, ProductionLoad deferredToNextPeriod,
      double satelliteAllocationScale, String nameplateBottleneck, boolean processModelUsed,
      boolean processCapacityAvailable, String processBottleneck, double processBottleneckUtilization,
      Map<String, Double> processUtilizationSummary, double deferredValueMusd, double deferredValueNpvMusd,
      String summary) {
