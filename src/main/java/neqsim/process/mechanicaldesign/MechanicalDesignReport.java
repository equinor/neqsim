...
public class MechanicalDesignReport implements java.io.Serializable {
  ...
  public String generateWeightReport() {
    ...
    sb.append(String.format("Total Heating Duty:        %,.0f kW\n", systemDesign.getTotalHeatingDuty()));
    sb.append(String.format("Total Cooling Duty:        %,.0f kW\n", systemDesign.getTotalCoolingDuty()));
    sb.append("\n");
  ...
  public String toJson() {
    ...
    systemSummary.addProperty("totalWeight_kg", systemDesign.getTotalWeight() + pipingDesign.getTotalPipingWeight());
