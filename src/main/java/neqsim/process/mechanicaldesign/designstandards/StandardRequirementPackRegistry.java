...
public final class StandardRequirementPackRegistry {
  ...
  static {
    Map<StandardType, StandardRequirementPack> packs = new EnumMap<StandardType, StandardRequirementPack>(
        StandardType.class);
    register(packs, pack(StandardType.NORSOK_P_002,
        ...
        capability("process-review", Kind.REVIEW_WORKFLOW,
            "neqsim.process.safety.compliance.StandardsDesignReview",
            "Orchestrates supported model checks and reports unsupported requirements for review.")));
    register(packs, pack(StandardType.NORSOK_S_001,
    ...
    register(packs, pack(StandardType.ISO_10418,
        capability("offshore-process-safety-review", Kind.REVIEW_WORKFLOW,
            "neqsim.process.safety.processsafetysystem.ProcessSafetySystemReviewEngine",
    ...
    register(packs, pack(StandardType.IEC_61511,
        capability("hazop-lopa-srs", Kind.REVIEW_WORKFLOW,
            "neqsim.process.engineering.safety.lifecycle.HazopLopaSrsWorkflow",
    ...
    register(packs, pack(StandardType.IEC_60534,
        capability("control-valve-sizing", Kind.CALCULATION_SCREENING,
    ...
    register(packs, pack(StandardType.NORSOK_M_001,
        ...
        capability("co2-corrosion", Kind.CALCULATION_SCREENING,
    ...
    register(packs, pack(StandardType.API_650,
        capability("tank-mechanical-design", Kind.CALCULATION_SCREENING,
    ...
    register(packs, pack(StandardType.API_660,
    ...
    register(packs, pack(StandardType.DNV_ST_F101,
