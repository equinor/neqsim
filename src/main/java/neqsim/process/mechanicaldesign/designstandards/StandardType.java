...
public enum StandardType {
  ...
  DNV_OS_F101("DNV-OS-F101", "Submarine Pipeline Systems (Legacy)", "2013", new String[] {"Pipeline", "AdiabaticPipe"},
      "pipeline design codes"),
  ...
  ISO_5167_2("ISO-5167-2", "Differential-pressure flow measurement - Orifice plates", "2022", new String[] {"Orifice"},
