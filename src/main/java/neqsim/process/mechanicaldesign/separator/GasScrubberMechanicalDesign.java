...
public class GasScrubberMechanicalDesign extends SeparatorMechanicalDesign {
  ...
  public void calcDesign() {
    ...
    // Design gas volumetric flow used for Souders-Brown diameter sizing, stored in m3/hr
    // so the derived "design volume flow" capacity constraint is consistent with
  ...
  public SeparatorMechanicalDesignResponse getResponse() {
    ...
    if (Double.isFinite(liquidEntrainmentLitresPerMSm3)) {
      resp.addSpecificParameter("liquidEntrainment_litre_per_MSm3", liquidEntrainmentLitresPerMSm3);
    }
