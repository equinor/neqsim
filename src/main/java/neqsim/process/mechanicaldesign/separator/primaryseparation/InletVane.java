 ...
 *
 * <p>
 * An inlet vane distributor uses curved vanes to redirect the incoming two-phase flow, separate bulk liquid by
 * centrifugal force, and distribute gas evenly across the separator cross-section.
 * </p>
 *
 * <p>
 * Inlet vanes typically allow higher inlet momentum (up to 6000 Pa rho*v^2) compared to simple deflector plates (3000
 * Pa), and achieve a bulk separation efficiency of 80-90%.
 * </p>
 *
 * @author NeqSim
 * @version 1.0
