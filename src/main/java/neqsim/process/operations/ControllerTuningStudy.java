 ...
 *
 * <p>
 * The study is deliberately independent of any specific controller implementation. Existing NeqSim controllers can
 * generate the histories, and this class computes portable performance metrics for P&amp;ID-driven operating studies.
 * </p>
 *
 * @author ESOL
 * @version 1.0
...
public final class ControllerTuningStudy {
   ...
   */
  public static ControllerTuningResult evaluateStepResponse(String controllerName, double setPoint,
      double[] timeSeconds, double[] processValue, double[] controllerOutput, double outputMin, double outputMax,
      double settlingTolerance) {
    validateInputs(timeSeconds, processValue, controllerOutput, outputMin, outputMax, settlingTolerance);
    ...
    double settlingTimeSeconds = settlingTime(setPoint, timeSeconds, processValue, settlingTolerance);
   ...
   */
  private static void validateInputs(double[] timeSeconds, double[] processValue, double[] controllerOutput,
   ...
   */
  private static String recommendation(boolean stableAtEnd, double overshootPercent, double settlingTimeSeconds,
      double outputSaturationFraction) {
