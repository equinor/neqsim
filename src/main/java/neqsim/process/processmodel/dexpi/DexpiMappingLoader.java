 ...
 *
 * <p>
 * Each properties file maps a DEXPI ComponentClass string (e.g. "CentrifugalPump") to a {@link EquipmentEnum} name
 * (e.g. "Pump"). If a properties file cannot be loaded, the loader falls back to a built-in default mapping.
 * </p>
 *
 * @author NeqSim
 * @version 1.0
...
public final class DexpiMappingLoader {
  ...
  private static final String EQUIPMENT_RESOURCE = "neqsim/process/processmodel/dexpi_equipment_mapping.properties";
  private static final String PIPING_RESOURCE = "neqsim/process/processmodel/dexpi_piping_component_mapping.properties";
