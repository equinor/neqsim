...
public class EquipmentVisualStyle implements Serializable {
  ...
  private static void initializeDefaultStyles() {
    ...
    STYLE_CACHE.put("separator",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.2", "1.5", "filled"));
    STYLE_CACHE.put("threephaseseparator",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.4", "1.8", "filled"));
    STYLE_CACHE.put("twophaseseparator",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.2", "1.5", "filled"));
    STYLE_CACHE.put("scrubber",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.0", "1.8", "filled"));
    STYLE_CACHE.put("gasscrubber",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.0", "1.8", "filled"));
    STYLE_CACHE.put("simplegasscrubber",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.0", "1.6", "filled"));
    STYLE_CACHE.put("knockout",
        new EquipmentVisualStyle("cylinder", "#90EE90", "#228B22", "black", "1.0", "1.5", "filled"));
    STYLE_CACHE.put("hydrocyclone",
        new EquipmentVisualStyle("invtrapezium", "#90EE90", "#228B22", "black", "0.8", "1.5", "filled"));
    STYLE_CACHE.put("flash",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.0", "1.2", "filled"));

    // ========== DISTILLATION & ABSORPTION COLUMNS (Tall cylinder, Green) ==========
    STYLE_CACHE.put("distillationcolumn",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.5", "3.0", "filled"));
    STYLE_CACHE.put("absorber",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.3", "2.5", "filled"));
    STYLE_CACHE.put("simpletegabsorber",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.3", "2.5", "filled"));
    STYLE_CACHE.put("waterstripper",
        new EquipmentVisualStyle("cylinder", "#98FB98", "#228B22", "black", "1.3", "2.5", "filled"));
    STYLE_CACHE.put("adsorber",
        new EquipmentVisualStyle("cylinder", "#D3D3D3", "#696969", "black", "1.2", "2.0", "filled"));

    // ========== COMPRESSORS (Trapezium - short side inlet left, long side outlet right) ==========
    STYLE_CACHE.put("compressor",
        new EquipmentVisualStyle("trapezium", "#87CEEB", "#4682B4", "black", "1.2", "0.8", "filled"));
    STYLE_CACHE.put("singlestagecompressor",
        new EquipmentVisualStyle("trapezium", "#87CEEB", "#4682B4", "black", "1.2", "0.8", "filled"));
    STYLE_CACHE.put("multistagecompressor",
        new EquipmentVisualStyle("trapezium", "#ADD8E6", "#4682B4", "black", "1.5", "1.0", "filled"));
    STYLE_CACHE.put("compressormodule",
        new EquipmentVisualStyle("trapezium", "#B0E0E6", "#4682B4", "black", "1.8", "1.2", "filled"));

    // ========== EXPANDERS & TURBINES (Inverted trapezoid - long side inlet, short side outlet)
    // ==========
    STYLE_CACHE.put("expander",
        new EquipmentVisualStyle("invtrapezium", "#87CEFA", "#4169E1", "black", "1.5", "0.8", "filled"));
    STYLE_CACHE.put("turboexpander",
        new EquipmentVisualStyle("invtrapezium", "#87CEFA", "#4169E1", "black", "1.5", "0.8", "filled"));
    STYLE_CACHE.put("turboexpandercompressor",
        new EquipmentVisualStyle("invtrapezium", "#87CEFA", "#4169E1", "black", "1.8", "1.0", "filled"));

    // ========== PUMPS (Circle, Dark Blue) ==========
    STYLE_CACHE.put("pump", new EquipmentVisualStyle("circle", "#4169E1", "#00008B", "white", "0.8", "0.8", "filled"));
    ...
    STYLE_CACHE.put("heatexchanger",
        new EquipmentVisualStyle("rect", "#FFD700", "#FF8C00", "black", "1.5", "0.6", "filled,rounded"));
    ...
    STYLE_CACHE.put("reboiler",
        new EquipmentVisualStyle("circle", "#FF6347", "#8B0000", "white", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("multistreamheatexchanger",
        new EquipmentVisualStyle("rect", "#FFD700", "#FF8C00", "black", "2.0", "1.0", "filled,rounded"));
    ...
    STYLE_CACHE.put("valve",
        new EquipmentVisualStyle("polygon", "#FFB6C1", "#FF69B4", "black", "0.3", "0.25", "filled"));
    STYLE_CACHE.put("throttlingvalve",
        new EquipmentVisualStyle("polygon", "#FFB6C1", "#FF69B4", "black", "0.3", "0.25", "filled"));
    STYLE_CACHE.put("controlvalve",
        new EquipmentVisualStyle("polygon", "#FFB6C1", "#FF69B4", "black", "0.35", "0.3", "filled"));
    STYLE_CACHE.put("safetyvalve",
        new EquipmentVisualStyle("polygon", "#FF6347", "#8B0000", "white", "0.3", "0.25", "filled"));
    STYLE_CACHE.put("esdvalve",
        new EquipmentVisualStyle("polygon", "#FF0000", "#8B0000", "white", "0.35", "0.3", "filled"));
    STYLE_CACHE.put("blowdownvalve",
        new EquipmentVisualStyle("polygon", "#FF4500", "#8B0000", "white", "0.3", "0.25", "filled"));
    STYLE_CACHE.put("checkvalve",
        new EquipmentVisualStyle("polygon", "#DDA0DD", "#8B008B", "black", "0.25", "0.2", "filled"));
    ...
    STYLE_CACHE.put("rupturedisc",
        new EquipmentVisualStyle("polygon", "#FF6347", "#8B0000", "white", "0.25", "0.2", "filled"));
    ...
    STYLE_CACHE.put("neqstream",
        new EquipmentVisualStyle("ellipse", "#FFFFFF", "#000000", "black", "1.2", "0.5", "filled"));
    STYLE_CACHE.put("virtualstream",
        new EquipmentVisualStyle("ellipse", "#F5F5F5", "#808080", "gray", "1.0", "0.4", "filled,dashed"));
    ...
    STYLE_CACHE.put("mixer",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("staticmixer",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("phasemixer",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("splitter",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("componentsplitter",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    STYLE_CACHE.put("manifold",
        new EquipmentVisualStyle("triangle", "#E8E8E8", "#000000", "black", "0.5", "0.5", "filled"));
    ...
    STYLE_CACHE.put("pipe", new EquipmentVisualStyle("rect", "#C0C0C0", "#808080", "black", "2.0", "0.3", "filled"));
    ...
    STYLE_CACHE.put("tank",
        new EquipmentVisualStyle("cylinder", "#D3D3D3", "#696969", "black", "1.5", "1.8", "filled"));
    STYLE_CACHE.put("storagetank",
        new EquipmentVisualStyle("cylinder", "#D3D3D3", "#696969", "black", "1.8", "2.0", "filled"));
    STYLE_CACHE.put("depressurizer",
        new EquipmentVisualStyle("cylinder", "#D3D3D3", "#696969", "black", "1.5", "1.8", "filled"));

    // ========== WELLS & RESERVOIR (House shape, Brown) ==========
    STYLE_CACHE.put("well", new EquipmentVisualStyle("house", "#8B4513", "#654321", "white", "1.0", "1.2", "filled"));
    ...
    STYLE_CACHE.put("recycle",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "1.0", "0.5", "filled,dashed"));
    STYLE_CACHE.put("adjuster",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "1.0", "0.5", "filled,dashed"));
    STYLE_CACHE.put("calculator",
        new EquipmentVisualStyle("rect", "#FFFACD", "#DAA520", "black", "1.0", "0.5", "filled,dashed"));
    STYLE_CACHE.put("controller",
        new EquipmentVisualStyle("rect", "#FFFACD", "#DAA520", "black", "1.0", "0.5", "filled,dashed"));
    STYLE_CACHE.put("setpoint",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "0.8", "0.4", "filled,dashed"));
    STYLE_CACHE.put("setter",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "0.8", "0.4", "filled,dashed"));
    STYLE_CACHE.put("flowsetter",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "0.8", "0.4", "filled,dashed"));
    STYLE_CACHE.put("streamsaturator",
        new EquipmentVisualStyle("rect", "#E6E6FA", "#9370DB", "black", "1.0", "0.5", "filled,dashed"));
    STYLE_CACHE.put("gormatch",
        new EquipmentVisualStyle("rect", "#F5F5F5", "#808080", "black", "0.8", "0.4", "filled,dashed"));

    // ========== EJECTOR (Special shape) ==========
    STYLE_CACHE.put("ejector",
        new EquipmentVisualStyle("trapezium", "#ADD8E6", "#4682B4", "black", "1.2", "0.6", "filled"));
    ...
    // ========== FILTER (Special) ==========
    STYLE_CACHE.put("filter", new EquipmentVisualStyle("rect", "#F0E68C", "#BDB76B", "black", "1.0", "0.8", "filled"));
    ...
    STYLE_CACHE.put("flare", new EquipmentVisualStyle("note", "#FF4500", "#8B0000", "white", "1.0", "1.5", "filled"));
    ...
    STYLE_CACHE.put("windturbine",
        new EquipmentVisualStyle("triangle", "#87CEEB", "#4682B4", "black", "1.2", "1.5", "filled"));
    ...
    // ========== DEFAULT ==========
    STYLE_CACHE.put("default", new EquipmentVisualStyle("rect", "#FFFFFF", "#000000", "black", DEFAULT_WIDTH,
        DEFAULT_HEIGHT, "filled,rounded"));
   ...
   *
   * <p>
   * This method provides unified access to styles whether equipment comes from direct NeqSim creation or DEXPI import.
   * DEXPI-imported equipment uses {@code DexpiProcessUnit.getMappedEquipment()} to get the EquipmentEnum.
   * </p>
   *
   ...
   *
   * <p>
   * This method automatically handles DEXPI-imported equipment by using the mapped EquipmentEnum, ensuring consistent
   * styling regardless of equipment origin.
   * </p>
   *
