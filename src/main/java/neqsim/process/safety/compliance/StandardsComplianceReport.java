...
/**
 * Standards Compliance Report — produces an auditable checklist of mandatory requirements from the major process-safety
 * standards and tracks the project's compliance status.
 *
 * <p>
...
public class StandardsComplianceReport implements Serializable {
   ...
   */
  public StandardsComplianceReport addRequirement(String standard, String clause, String description) {
   ...
   * @return this report for chaining
   */
  public StandardsComplianceReport setStatus(String standard, String clause, Status status, String evidence) {
  ...
  public StandardsComplianceReport loadAPI14C() {
    ...
    for (String[] r : Arrays.asList(new String[] {"3.4", "Safety Analysis Table (SAT) for each component"},
  ...
  public StandardsComplianceReport loadNORSOKS001() {
    ...
    for (String[] r : Arrays.asList(new String[] {"5.1", "Safety strategy aligned with NORSOK Z-013 risk policy"},
        new String[] {"5.4", "Performance standards for safety functions"},
        new String[] {"6", "Layout and area classification per IEC 60079-10"},
        new String[] {"7.1", "ESD philosophy and ESD levels"}, new String[] {"7.2", "PSD philosophy and PSD levels"},
  ...
  public StandardsComplianceReport loadNORSOKS001Clause10() {
    String std = "NORSOK S-001";
    for (String[] r : Arrays.asList(new String[] {"10.1", "Process safety system role and interfaces documented"},
        ...
        new String[] {"10.4.7",
            "Instrumented secondary pressure protection pressure, frequency, leakage, and proof-test basis documented"},
  ...
  public StandardsComplianceReport loadIEC61511() {
    ...
    for (String[] r : Arrays.asList(new String[] {"5", "Safety lifecycle plan documented"},
  ...
  public StandardsComplianceReport loadSTS0131() {
    ...
    for (String[] r : Arrays.asList(
        ...
        new String[] {"Blowdown",
            "Depressurization acceptance covers escape time, rupture pressure, inventory, and fire rate"},
