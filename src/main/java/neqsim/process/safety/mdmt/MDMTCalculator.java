 ...
 *
 * <p>
 * Implements a simplified Procedure based on API 579-1 / ASME FFS-1 Part 3 (brittle fracture assessment) and ASME B31.3
 * / Section VIII Div. 1 UCS-66 / UHA-51 impact-test exemption curves. Used to verify that a vessel exposed to cold
 * blowdown (Joule–Thomson cooling) will not become susceptible to brittle fracture.
 *
 * <p>
 * Inputs: material toughness curve (A/B/C/D per UCS-66 Fig.), governing thickness, design stress ratio, and minimum
 * operating temperature. Returns: MDMT in °C and PASS/FAIL verdict.
 *
 * <p>
 * <b>References:</b>
 * <ul>
...
public class MDMTCalculator implements Serializable {
  ...
  /**
   * UCS-66 impact test exemption curves. Selection per Fig. UCS-66 based on material grade and thickness.
   */
  ...
  /**
   * Set the stress ratio (applied / allowable). Lower stress ratios permit colder MDMT per UCS-66.1.
   *
   ...
   *
   * <p>
   * Approximates Fig. UCS-66 with simple analytic curves of MDMT vs thickness for the four UCS-66 groups, then applies
   * the stress-ratio reduction per UCS-66.1 Fig. UCS-66.1 (up to 55 °C colder for low stress).
   *
   * @return MDMT in °C
   */
