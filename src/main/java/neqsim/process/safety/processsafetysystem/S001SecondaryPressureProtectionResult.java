...
public class S001SecondaryPressureProtectionResult implements Serializable {
  ...
  public S001SecondaryPressureProtectionResult(double maximumEventPressureBara, double designPressureBara,
      ...
      boolean pressureBasisComplete, boolean testPressureValid, boolean pressureWithinTestPressure,
      boolean frequencyConfigured, boolean frequencyCriterionMet, boolean leakageAssessed, boolean leakageRoutedSafe,
