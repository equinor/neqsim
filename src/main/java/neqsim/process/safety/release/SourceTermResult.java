...
public class SourceTermResult implements Serializable {
  ...
  void setDataPoint(int index, double t, double mdot, double T, double P, double vaporFrac, double velocity,
      double momentum, double smd) {
  ...
  public void exportToFLACS(String filename) {
    ...
    sb.append("  DIRECTION = ").append(orientation.isHorizontal() ? "HORIZONTAL" : "VERTICAL").append("\n");
  ...
  public void exportToOpenFOAM(String directory) {
    ...
    massFile.append("/*--------------------------------*- C++ -*----------------------------------*\\\n");
    massFile.append("| =========                 |                                                 |\n");
    massFile.append("| \\\\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox           |\n");
    massFile.append("|  \\\\    /   O peration     | Generated by NeqSim                             |\n");
    massFile.append("|   \\\\  /    A nd           |                                                 |\n");
    massFile.append("|    \\\\/     M anipulation  |                                                 |\n");
    massFile.append("\\*---------------------------------------------------------------------------*/\n");
    massFile.append("(\n");
