 ...
 *
 * <p>
 * This package provides a standardized interface for integrating external machine learning models with the NeqSim risk
 * framework. It enables data-driven risk assessment and prediction.
 * </p>
 *
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link neqsim.process.safety.risk.ml.RiskMLInterface} - Main interface for ML model management and
 * prediction</li>
 * </ul>
 *
 * <h2>ML Use Cases</h2>
 ...
 * <li><strong>Anomaly Detection:</strong> Identify unusual patterns indicating potential problems</li>
 ...
 * RiskMLInterface.MLPrediction prediction = mlInterface.predictWithExtraction("pump-failure-v1", "process",
 *     processData);
 *
 ...
 * <p>
 * The ML interface is designed for easy integration with Python-based ML models via REST API or direct JPype/Py4J
 * bridging.
 * </p>
 *
