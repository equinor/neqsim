 ...
 *
 * <p>
 * This package provides integration between operational risk assessment and Safety Instrumented Systems (SIS) per IEC
 * 61508/61511 standards. Key capabilities include:
 * </p>
 *
 * <ul>
 * <li><strong>Safety Instrumented Function (SIF) Modeling:</strong> Model SIFs with SIL targets, architectures (1oo1,
 * 1oo2, 2oo3, etc.), and PFD calculations</li>
 * <li><strong>Layer of Protection Analysis (LOPA):</strong> Semi-quantitative risk assessment with IPL credit
 * allocation</li>
 * <li><strong>SIL Verification:</strong> Verify SIL targets are met based on PFD, architecture, and systematic
 * capability</li>
 ...
 * <h2>Key Classes</h2>
 * <ul>
 * <li>{@link neqsim.process.safety.risk.sis.SafetyInstrumentedFunction} - Models individual SIFs with SIL,
 * architecture, and PFD</li>
 * <li>{@link neqsim.process.safety.risk.sis.SISIntegratedRiskModel} - Extends RiskModel with SIS integration</li>
 * <li>{@link neqsim.process.safety.risk.sis.LOPAResult} - LOPA analysis results with protection layers</li>
 * <li>{@link neqsim.process.safety.risk.sis.SILVerificationResult} - SIL verification results</li>
 * <li>{@link neqsim.process.safety.risk.sis.SISRiskResult} - Combined risk results with SIS mitigation</li>
 * </ul>
 *
