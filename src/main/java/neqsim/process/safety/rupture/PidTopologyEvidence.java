 ...
 *
 * <p>
 * The class records the deterministic graph extracted by P&amp;ID/STID/OCR agents: equipment, nozzles, valves, and line
...
public final class PidTopologyEvidence implements Serializable {
  ...
  public SafetyStudyReadiness readiness() {
    ...
    if (nodes.isEmpty()) {
	  ...
	  "Extract equipment, nozzles, valves, and boundary nodes from STID/P&ID evidence.");
    }
    if (edges.isEmpty()) {
