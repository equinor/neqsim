 ...
 *
 * <p>
 * The study implements the calculation structure used by legacy fire-rupture spreadsheets for pipes exposed to fire
 * while a blowdown pressure profile is supplied externally. It couples pipe heat-up, pressure stress,
 ...
 *
 * <p>
 * This model is intended for screening and agent workflows where pipe data may be gathered from source documents and
 * piping specifications, then reviewed by an engineer before the calculation is run. Formal safety studies should
 * verify the material basis, pressure profile, segment inventory, and release modelling.
 * </p>
 *
 * @author ESOL
 * @version 1.0
