 ...
 *
 * <p>
 * Per TR1244 best practice, process design should cross-check results between SRK and PR78 equations of state to
 * identify cases where EoS choice significantly affects separation predictions, compressor duties, phase envelopes or
 * hydrate curves. This class runs both EoS on the same composition and conditions and flags deviations above
...
public class DualEosComparison implements Serializable {
   ...
   *
   * <p>
   * The composition is extracted from the supplied system. Both SRK and PR78 fluids will be built internally with the
   * same composition. The base fluid's EoS type does not matter.
   * </p>
   *
