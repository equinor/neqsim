 ...
 *
 * <p>
 * The calculator supports the legacy API 521 pool fire correlation as well as a generalized Stefan-Boltzmann
 * formulation that can account for configuration factors. The values are expressed in SI units to make them easy to
 * integrate with the rest of the NeqSim process equipment model.
 */
public final class FireHeatLoadCalculator {
   ...
   */
  public static double generalizedStefanBoltzmannHeatFlux(double emissivity, double viewFactor,
      double flameTemperatureK, double surfaceTemperatureK) {
