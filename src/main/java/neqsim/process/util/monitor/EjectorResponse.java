...
public class EjectorResponse extends BaseResponse {
  ...
  public EjectorResponse(Ejector ejector) {
    ...
    if (ejector.getMotiveStream() != null) {
      data.put("motive mass flow",
          new Value(
              Double.toString(ejector.getMotiveStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
              neqsim.util.unit.Units.getSymbol("mass flow")));
      data.put("motive pressure",
          new Value(
              Double.toString(ejector.getMotiveStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
              neqsim.util.unit.Units.getSymbol("pressure")));
    }
    if (ejector.getSuctionStream() != null) {
      data.put("suction mass flow",
          new Value(
              Double.toString(ejector.getSuctionStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
              neqsim.util.unit.Units.getSymbol("mass flow")));
      data.put("suction pressure",
          new Value(
              Double.toString(ejector.getSuctionStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
              neqsim.util.unit.Units.getSymbol("pressure")));
    }
    if (ejector.getMixedStream() != null) {
      data.put("discharge mass flow",
          new Value(
              Double.toString(ejector.getMixedStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
              neqsim.util.unit.Units.getSymbol("mass flow")));
      data.put("discharge pressure",
          new Value(Double.toString(ejector.getMixedStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
              neqsim.util.unit.Units.getSymbol("pressure")));
      data.put("discharge temperature",
          new Value(
              Double.toString(ejector.getMixedStream().getTemperature(neqsim.util.unit.Units.getSymbol("temperature"))),
              neqsim.util.unit.Units.getSymbol("temperature")));
    }
    data.put("isentropic efficiency", new Value(Double.toString(ejector.getEfficiencyIsentropic()), ""));
    data.put("suction nozzle efficiency", new Value(Double.toString(ejector.getSuctionNozzleEfficiency()), ""));
    data.put("mixing efficiency", new Value(Double.toString(ejector.getMixingEfficiency()), ""));
    data.put("diffuser efficiency", new Value(Double.toString(ejector.getDiffuserEfficiency()), ""));
    ...
    data.put("critical back pressure",
        new Value(Double.toString(ejector.getCriticalBackPressure()), neqsim.util.unit.Units.getSymbol("pressure")));
