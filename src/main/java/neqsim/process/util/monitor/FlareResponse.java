...
public class FlareResponse extends BaseResponse {
  ...
  public FlareResponse(Flare flare) {
    ...
    if (flare.getInletStream() != null) {
      data.put("mass flow",
	  new Value(Double.toString(flare.getInletStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
	      neqsim.util.unit.Units.getSymbol("mass flow")));
      data.put("inlet temperature",
	  new Value(
	      Double.toString(flare.getInletStream().getTemperature(neqsim.util.unit.Units.getSymbol("temperature"))),
	      neqsim.util.unit.Units.getSymbol("temperature")));
      data.put("inlet pressure",
	  new Value(Double.toString(flare.getInletStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
