...
public class ManifoldResponse extends BaseResponse {
  ...
  public ManifoldResponse(Manifold manifold) {
    ...
    data.put("mixed mass flow", new Value(
        Double.toString(
            manifold.getMixedStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
    ...
    data.put("mixed pressure", new Value(
        Double.toString(
            manifold.getMixedStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
