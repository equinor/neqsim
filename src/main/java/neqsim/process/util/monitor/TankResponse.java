...
public class TankResponse extends BaseResponse {
  ...
  public TankResponse(Tank tank) {
	...
	new Value(Double.toString(tank.getGasOutStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
	    neqsim.util.unit.Units.getSymbol("pressure")));
    data.put("gas outlet mass flow",
	new Value(Double.toString(tank.getGasOutStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
	...
	new Value(Double.toString(tank.getLiquidOutStream().getPressure(neqsim.util.unit.Units.getSymbol("pressure"))),
	    neqsim.util.unit.Units.getSymbol("pressure")));
    data.put("liquid outlet mass flow",
	new Value(Double.toString(tank.getLiquidOutStream().getFlowRate(neqsim.util.unit.Units.getSymbol("mass flow"))),
