...
public class CompressorChart implements CompressorChartInterface, Serializable {
    ...
    public static void main(String[] args) {
         ...
         * surgehead = new double[] { 6000.0, 7000.0, 8000.0, 10000.0 };
        ...
        System.out.println("speed " + comp1.getCompressorChart()
                .getSpeed(stream_1.getThermoSystem().getFlowRate("m3/hr") + 10.0, comp1.getPolytropicHead()));
