        ...
        for (int k = 1; k < streams.size(); k++) {
            ...
            for (int i = 0; i < ((SystemInterface) ((StreamInterface) streams.get(k)).getThermoSystem()).getPhases()[0]
                ...
                for (int p = 0; p < numberOfPhases; p++) {
                    moles[p] = ((StreamInterface) streams.get(k)).getThermoSystem().getPhase(p).getComponents()[i]
                ...
                if (k == 1) {
                    ...
                    mixedStream.getThermoSystem().getPhase(1)
                            .setTemperature(((StreamInterface) streams.get(k)).getThermoSystem().getTemperature());
                }
