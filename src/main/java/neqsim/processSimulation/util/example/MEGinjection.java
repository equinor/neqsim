...
public class MEGinjection {
        public static void main(String[] args) {
                ...
                adjuster.setTargetVariable(mixerStream, "mass fraction", 0.6, "-", "aqueous",
                                "MEG");
                ...
                Stream feedStream =
                                new Stream((Stream) MEGwelloperations.getUnit("feed gas and MEG"));
                feedStream.setName("feed to onhore");

                ThrottlingValve onshoreChockeValve =
                                new ThrottlingValve("onshore choke valve", feedStream);
                onshoreChockeValve.setOutletPressure(70.3);

                ThreePhaseSeparator slugCatcher = new ThreePhaseSeparator("slug catcher",
                                onshoreChockeValve.getOutStream());
                ...
                ThrottlingValve DPvalve1 =
                                new ThrottlingValve("DP valve 1", MEGmixer1.getOutStream());
