...
//        // Land plant
            ...
            VolumeFlowTransmitter volumeTransmitter2 = new VolumeFlowTransmitter(slugCatcher.getOilOutStream());
            volumeTransmitter2.setMeasuredPhaseNumber(0);
            volumeTransmitter2.setName("Condesate Volume Flow From Slug Catcher");

            VolumeFlowTransmitter volumeTransmitter1 = new VolumeFlowTransmitter(slugCatcher.getWaterOutStream());
            volumeTransmitter1.setMeasuredPhaseNumber(0);
            volumeTransmitter1.setName("MEG Volume FLow From Slug Catcher");

            VolumeFlowTransmitter volumeTransmitter3 = new VolumeFlowTransmitter(slugCatcher.getGasOutStream());
...
//
            ThreePhaseSeparator condensateSeparator = new ThreePhaseSeparator(condesateheater1.getOutStream());
//
...
////
//            ThrottlingValve valve3 = new ThrottlingValve("MEG flash valve 1", MEGheater2.getOutStream());
//            valve3.setOutletPressure(1.4);
////
////
////
//            ThreePhaseSeparator separator3 = new ThreePhaseSeparator("MEG LP separator", valve3.getOutStream());
////
//            VolumeFlowTransmitter volumeTransmitter5= new VolumeFlowTransmitter(separator3.getGasOutStream());
...
////
//            ThrottlingValve valve4 = new ThrottlingValve("MEG flash valve 2", MEGheater3.getOutStream());
//            valve4.setOutletPressure(1.05);
////
////        //ScalePotentialCheckStream stream_6 = new ScalePotentialCheckStream(valve4.getOutStream());
////
//            Stream stream_7 = new Stream(valve4.getOutStream());
//
//            ThreePhaseSeparator separator4 = new ThreePhaseSeparator("MEG Storage tank 13-TA-101", stream_7);
//
//
//            Stream stream_8 = new Stream(co2Module.getOutputStream("streamFromAbsorber"));
//
