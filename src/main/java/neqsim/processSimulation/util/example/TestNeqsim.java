...
public class TestNeqsim {
        ...
        public static void main(String[] args) {
                ...
                // operations.run();
                System.out.println("work " + compressor1.getTotalWork() + " density " + Density1
                                + " Cp " + Cpone + " SPEED OF SOUND "
                                + stream1.getThermoSystem().getPhase(0).getSoundSpeed());

                compressor1.solveEfficiency(390.15);
                compressor1.getOutStream().displayResult();
                System.out.println("Hvap " + stream1.getThermoSystem().getHeatOfVaporization()
                                + " POLI " + compressor1.getPolytropicEfficiency() + " dentity "
                ...
                double volFlowGas =
                                massFlowGas / stream1.getThermoSystem().getPhase(0).getDensity();
                double volFlowLiq =
                                massFlowLiq / stream1.getThermoSystem().getPhase(2).getDensity();
                double volFlowOil =
                                massFlowOil / stream1.getThermoSystem().getPhase(1).getDensity();
                 ...
                 * Cp [i] = compressor1.getOutStream().getThermoSystem().getPhase(0).getBeta() *
                 * Cp_Vapour [i] +
                 ...
                 * Density_liquid [i] =
                 * compressor1.getOutStream().getThermoSystem().getPhase(1).getDensity(); Density
                 * [i] = compressor1.getOutStream().getThermoSystem().getWtFraction(0) *
                 * Density_Vapour [i] +
         ...
         * }
         * 
         * System.out.println( "Density" ); for (int i=0;i<10;i++ ) { System.out.println( Density
         * [i] );
         */
}
// }
