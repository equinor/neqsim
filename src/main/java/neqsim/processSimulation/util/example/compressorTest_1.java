...
public class compressorTest_1 {
    ...
    public static void main(String args[]) {
        ...
        neqsim.thermo.system.SystemInterface testSystem = new neqsim.thermo.system.SystemSrkCPAstatoil((273.15 + 20.0), 10.00);
       ...
       // testSystem.addComponent("water", 0.2);
        ...
        System.out.println("speed of sound " + comp_1.getOutStream().getThermoSystem().getPhase(0).getSoundSpeed());
        System.out.println("out temperature" + comp_1.getOutStream().getThermoSystem().getTemperature());
        ...
        System.out.println("molarmass " + comp_1.getOutStream().getThermoSystem().getPhase(0).getMolarMass());
        System.out.println("molarmass " + comp_1.getOutStream().getThermoSystem().getPhase(0).getMolarMass());
        ...
        System.out.println("compressor head " +comp_1.getPower()/comp_1.getThermoSystem().getTotalNumberOfMoles() + " J/mol");
    }
}
