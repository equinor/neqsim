...
//        testSystem.addComponent("ethane", 2.0);
       ...
       // testSystem.display();
        ...
        neqsim.processSimulation.processEquipment.heatExchanger.Heater heater = new neqsim.processSimulation.processEquipment.heatExchanger.Heater(stream_2);
...
/*        try {
        ...
        ops.waterPrecipitationTemperature();
        ...
        double wtMEG = stream_2.getThermoSystem().getPhase(1).getComponent("MEG").getx()*stream_2.getThermoSystem().getPhase(1).getComponent("MEG").getMolarMass();
        double wtwater = stream_2.getThermoSystem().getPhase(1).getComponent("water").getx()*stream_2.getThermoSystem().getPhase(1).getComponent("water").getMolarMass();
