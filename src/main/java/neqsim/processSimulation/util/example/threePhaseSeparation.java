...
public class threePhaseSeparation {
    ...
    public static void main(String args[]) {
        ...
        system1.addTBPfraction(
                "C7", 0.05719361, 98.4 / 1000.0, 0.751);
        system1.addTBPfraction(
                "C8", 0.03807916, 111.74 / 1000.0, 0.779);
        system1.addTBPfraction(
                "C9", 0.0203721, 125.19 / 1000.0, 0.793);
        system1.addTBPfraction(
                "C10", 0.01497714, 137.83 / 1000.0, 0.798);
        system1.addTBPfraction(
                "C11", 0.00929271, 149.0 / 1000.0, 0.803);
        system1.addTBPfraction(
                "C12", 0.00619347, 163.0 / 1000.0, 0.809);
        system1.addTBPfraction(
                "C13", 0.004102369, 176.0 / 1000.0, 0.815);
        system1.addTBPfraction(
                "C14", 0.002625117, 191.0 / 1000.0, 0.824);
        system1.addTBPfraction(
                "C15", 0.00168187, 207.0 / 1000.0, 0.829);
        system1.addTBPfraction(
                "C16", 0.001092967, 221.0 / 1000.0, 0.843);
        system1.addTBPfraction(
                "C17", 0.0006937096, 237.0 / 1000.0, 0.848);
        system1.addTBPfraction(
                "C18", 0.0004341923, 249.0 / 1000.0, 0.852);
        system1.addTBPfraction(
                "C19", 0.000329387, 261.0 / 1000.0, 0.855);
        system1.addTBPfraction(
                "CN1", 0.0008534124, 304.7 / 1000.0, 0.865);
        system1.addTBPfraction(
                "CN2", 5.340066E-005, 432.55 / 1000.0, 0.88);
        system1.addComponent(
                "TEG", 1.0e-10);
        system1.addComponent(
                "MEG", .3);
        ...
        //ThreePhaseSeparator separator2 = new ThreePhaseSeparator("Separator LP", LP_valve.getOutStream());
