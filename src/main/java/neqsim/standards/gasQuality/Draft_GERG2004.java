    ...
    public boolean isOnSpec(){
       ...
       // thermoSystem.setNumberOfPhases(1);
        ...
        for(int i=0;i<thermoSystem.getNumberOfPhases();i++){
            ...
            table[thermoSystem.getPhases()[0].getNumberOfComponents()+3][i+1] = nf.format(thermoSystem.getPhase(i).getZ());
            ...
            table[thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getNumberOfComponents()+4][i+1] = nf.format(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getPhysicalProperties().getDensity(), buf, test).toString();
            ...
            table[thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getNumberOfComponents()+5][i+1] = nf.format(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getBeta(), buf, test).toString();
            ...
            table[thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getNumberOfComponents()+6][i+1] = nf.format(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getMolarMass()*1000, buf, test).toString();
            ...
            table[thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getNumberOfComponents()+7][i+1] = nf.format((thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getCp()/(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getNumberOfMolesInPhase() *thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getMolarMass()*1000)), buf, test).toString();
           ...
           buf = new StringBuffer();
            ...
            table[thermoSystem.getPhases()[0].getNumberOfComponents()+10][i+1] = Double.toString(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getPressure());
            ...
            table[thermoSystem.getPhases()[0].getNumberOfComponents()+11][i+1] = Double.toString(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getTemperature());
            table[thermoSystem.getPhases()[0].getNumberOfComponents()+11][4] = "[K]";Double.toString(thermoSystem.getPhase(thermoSystem.getPhaseIndex(i)).getTemperature());
