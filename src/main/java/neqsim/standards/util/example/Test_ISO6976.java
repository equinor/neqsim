...
public class Test_ISO6976 {
    ...
    public static void main(String args[]) {
         ...
         * testSystem.addComponent("n-octane", 0.0); testSystem.addComponent("n-nonane",
         * 0.0); testSystem.addComponent("nC10", 0.0);
         * 
         * testSystem.addComponent("CO2", 0.68); testSystem.addComponent("H2S", 0.0);
         * testSystem.addComponent("water", 0.0); testSystem.addComponent("oxygen",
         * 0.0); testSystem.addComponent("carbonmonoxide", 0.0);
