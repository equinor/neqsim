...
public class Test_ISO6976 {
    ...
    public static void main(String args[]) {
        ...
        /*
        testSystem.addComponent("methane", 0.922393);
        testSystem.addComponent("ethane", 0.025358);
        testSystem.addComponent("propane", 0.01519);
        ...
        testSystem.addComponent("nitrogen", 0.01023);
        ...
        /*
         ...
         testSystem.addComponent("methane", 0.9247);
        testSystem.addComponent("ethane", 0.035);
        testSystem.addComponent("propane", 0.0098);
        testSystem.addComponent("n-butane", 0.0022);
      ...
      //  testSystem.addComponent("water", 0.016837);
        ...
        testSystem.addComponent("n-heptane", 0.0);
        testSystem.addComponent("n-octane", 0.0);
        testSystem.addComponent("n-nonane", 0.0);
        testSystem.addComponent("nC10", 0.0);
        
        testSystem.addComponent("CO2", 0.68);
        testSystem.addComponent("H2S", 0.0);
        testSystem.addComponent("water", 0.0);
        testSystem.addComponent("oxygen", 0.0);
        ...
        System.out.println("Superior Calorific Value " + standard.getValue("SuperiorCalorificValue"));
        System.out.println("Inferior Calorific Value " + standard.getValue("InferiorCalorificValue"));
        ...
        standardUK.calculate();
        System.out.println("ICF " + standardUK.getValue("IncompleteCombustionFactor", ""));

        System.out.println("HID " + testSystem.getPhase(0).getComponent("methane").getHID(273.15 - 150.0));
        System.out.println("Hres " + testSystem.getPhase(0).getComponent("methane").getHresTP(273.15 - 150.0));
         */
    }
}
