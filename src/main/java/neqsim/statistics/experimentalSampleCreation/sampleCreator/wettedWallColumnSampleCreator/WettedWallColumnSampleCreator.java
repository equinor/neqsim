...
public class WettedWallColumnSampleCreator extends SampleCreator {
    ...
    inletTotalGasFlowRate, inletLiquidFlowRate, co2SupplyRate,columnWallTemperature, dPdt, dNdt, dPdn, dNdtOld, dnVdt;
    double[]    smoothedPressure, smoothedInletLiquidTemperature, smoothedOutletLiquidTemperature, smoothedInletGasTemperature,
    smoothedInletTotalGasFlowRate, smoothedInletLiquidFlowRate, smoothedCo2SupplyRate, smoothedColumnWallTemperature;
    ...
    public void setSampleValues(){
        ...
        do{
            ...
            inletLiquidTemperature[i] = ((WettedWallColumnDataObject) reader.getSampleObjectList().get(i)).getInletLiquidTemperature();
            outletLiquidTemperature[i] = ((WettedWallColumnDataObject) reader.getSampleObjectList().get(i)).getOutletLiquidTemperature();
            columnWallTemperature[i] = ((WettedWallColumnDataObject) reader.getSampleObjectList().get(i)).getColumnWallTemperature();
            inletTotalGasFlowRate[i] = ((WettedWallColumnDataObject) reader.getSampleObjectList().get(i)).getInletTotalGasFlow();
