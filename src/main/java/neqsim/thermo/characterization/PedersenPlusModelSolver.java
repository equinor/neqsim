...
public class PedersenPlusModelSolver extends Object implements java.io.Serializable {
    ...
    public void setJacAB() {
        ...
        for (int j = 0; j < 2; j++) {
            ...
            for (int i = characterizeClass.getFirstPlusFractionNumber(); i < characterizeClass.getLastPlusFractionNumber(); i++) {
                mTot1 += (characterizeClass.PVTsimMolarMass[i - 6] / 1000.0) * Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * i);
                mTot2 += i * (characterizeClass.PVTsimMolarMass[i - 6] / 1000.0) * Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * i);
    ...
    public void setfvecCD() {
        ...
        double densTBO = characterizeClass.PVTsimDensities[characterizeClass.getFirstPlusFractionNumber() - 6];//0.71;//characterizeClass.getDensLastTBP();
        fvecCD.set(0, 0, (characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(characterizeClass.getFirstPlusFractionNumber() - 1)) - densTBO);
        double temp = 0.0, temp2 = 0;
        for (int i = characterizeClass.getFirstPlusFractionNumber(); i < characterizeClass.getLastPlusFractionNumber(); i++) {
            temp += Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * (i)) * characterizeClass.PVTsimMolarMass[i - 6];
            temp2 += Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * (i)) * characterizeClass.PVTsimMolarMass[i - 6] / (characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(i));
        }
    ...
    public void setJacCD() {
        ...
        for (int i = characterizeClass.getFirstPlusFractionNumber(); i < characterizeClass.getLastPlusFractionNumber(); i++) {
            temp += Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * (i)) * characterizeClass.PVTsimMolarMass[i - 6];
            temp2 += Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * (i)) * characterizeClass.PVTsimMolarMass[i - 6] / (characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(i));
            temp3 -= Math.exp(characterizeClass.getCoef(0) + characterizeClass.getCoef(1) * (i)) * characterizeClass.PVTsimMolarMass[i - 6] / Math.pow(characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(i), 2.0);
            deriv += 1.0 / ((characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(i)) * characterizeClass.PVTsimMolarMass[i - 6] / Math.pow(characterizeClass.getCoef(2) + characterizeClass.getCoef(3) * Math.log(i), 2.0));
        }
