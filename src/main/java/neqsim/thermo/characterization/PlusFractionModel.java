    ...
    public class PedersenPlusModel implements PlusFractionModelInterface, Cloneable, java.io.Serializable {
                ...
                if (system.getPhase(0).getComponent(i).isIsTBPfraction()) {
                    ...
                    if (M < Mmin) {
                        ...
                        if (system.getPhase(0).getComponent(i).getComponentName().substring(3, 4).equals("_")) {
                            firstTBPNumber = new Integer(system.getPhase(0).getComponent(i).getComponentName().substring(1, 3));
                        } else {
                            firstTBPNumber = new Integer(system.getPhase(0).getComponent(i).getComponentName().substring(1, 2));
                        }
                    }
                }
            }
        ...
        public void characterizePlusFraction(TBPModelInterface TBPModel) {
            ...
            if (system.getPhase(0).getComponent(plusComponentNumber).getComponentName().substring(3, 4).equals("_")) {
                firstPlusNumber = new Integer(system.getPhase(0).getComponent(plusComponentNumber).getComponentName().substring(1, 3));
            } else {
                firstPlusNumber = new Integer(system.getPhase(0).getComponent(plusComponentNumber).getComponentName().substring(1, 2));
            }
