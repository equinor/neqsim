 ...
 * @version 1.0
 */
public final class RefineryHydrotreatingHydrogenRecycleBalance implements Serializable {
  private static final long serialVersionUID = 1000L;

  private final RefineryHydrotreatingHydrogenSupplyBalance supplyBalance;
  ...
  /**
   * Calculate a steady-state component recycle and purge balance.
   *
   * @param supplyBalance qualified once-through hydrogen-supply receipt
  ...
  /** @return upstream once-through hydrogen-supply receipt */
  public RefineryHydrotreatingHydrogenSupplyBalance getSupplyBalance() {
