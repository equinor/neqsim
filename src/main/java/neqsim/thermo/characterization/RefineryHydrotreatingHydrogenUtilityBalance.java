...
public final class RefineryHydrotreatingHydrogenUtilityBalance implements Serializable {
  ...
  public static RefineryHydrotreatingHydrogenUtilityBalance calculate(
      RefineryHydrotreatingThroughputBalance throughputBalance, double hydrogenLowerHeatingValueMegaJoulePerKg,
    ...
    return new RefineryHydrotreatingHydrogenUtilityBalance(throughputBalance, hydrogenLowerHeatingValueMegaJoulePerKg,
        hydrogenCostPerKg, freshHydrogenMassFlow, consumedHydrogenMassFlow, exportHydrogenMassFlow, freshPower,
        consumedPower, exportPower, energyResidual, freshCostPerHour, freshCostPerTonneFeed, utilizationFraction);
  }
