 ...
 * @version 1.0
 */
public final class RefineryHydrotreatingOperatingReceipt implements Serializable {
  private static final long serialVersionUID = 1000L;
  private static final double KILOGRAMS_PER_TONNE = 1000.0;

  private final RefineryHydrotreatingHydrogenEmissionsBalance emissionsBalance;
   ...
   *
   * @param emissionsBalance qualified hydrotreating hydrogen-supply emissions receipt
   * @return immutable integrated operating receipt
   */
  public static RefineryHydrotreatingOperatingReceipt calculate(
      RefineryHydrotreatingHydrogenEmissionsBalance emissionsBalance) {
  ...
  public RefineryHydrotreatingHydrogenEmissionsBalance getEmissionsBalance() {
