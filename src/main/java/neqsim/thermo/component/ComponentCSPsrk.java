...
public class ComponentCSPsrk extends ComponentSrk{
    ...
    public void init(double temperature,double pressure,double totalNumberOfMoles, double beta,int type){
            ...
            double termfi3 = ((ComponentEosInterface)refPhaseBWRS.getRefBWRSPhase().getComponent(0)).getaDiffT()/((ComponentEosInterface)refPhaseBWRS.getRefBWRSPhase().getComponent(0)).getaT()*refPhaseBWRS.getRefBWRSPhase().getTemperature()/refPhaseBWRS.getNumberOfMolesInPhase();
            double termfi4 = 1.0-((ComponentEosInterface)refPhaseBWRS.getRefBWRSPhase().getComponent(0)).getaDiffT()/((ComponentEosInterface)refPhaseBWRS.getRefBWRSPhase().getComponent(0)).getaT()*refPhaseBWRS.getRefBWRSPhase().getTemperature();
    ...
    public double dFdN(PhaseInterface phase, int numberOfComponentphases, double temperature, double pressure){
        ...
        double term1 = f_scale_mix_i*refPhaseBWRS.getRefBWRSPhase().getF()/refPhaseBWRS.getRefBWRSPhase().getNumberOfMolesInPhase()*refPhaseBWRS.getRefBWRSPhase().getTemperature()/temperature ;
        double term2 = refPhaseBWRS.getF_scale_mix()*(refPhaseBWRS.getRefBWRSPhase().dFdT()/refPhaseBWRS.getRefBWRSPhase().getNumberOfMolesInPhase()*(1.0/refPhaseBWRS.getNumberOfMolesInPhase()-f_scale_mix_i/refPhaseBWRS.getF_scale_mix())*refPhaseBWRS.getRefBWRSPhase().getTemperature() + refPhaseBWRS.getRefBWRSPhase().dFdV()/refPhaseBWRS.getRefBWRSPhase().getNumberOfMolesInPhase()*(-1.0*h_scale_mix_i/refPhaseBWRS.getH_scale_mix()*refPhaseBWRS.getRefBWRSPhase().getMolarVolume()))*refPhaseBWRS.getRefBWRSPhase().getTemperature()/temperature/refPhaseBWRS.getRefBWRSPhase().getNumberOfMolesInPhase();
        double term3 = refPhaseBWRS.getF_scale_mix()*refPhaseBWRS.getRefBWRSPhase().getF()*1.0/temperature*1.0/refPhaseBWRS.getRefBWRSPhase().getNumberOfMolesInPhase()*(1.0/refPhaseBWRS.getNumberOfMolesInPhase()-f_scale_mix_i/refPhaseBWRS.getF_scale_mix())*refPhaseBWRS.getRefBWRSPhase().getTemperature();
        //System.out.println("dFdN  " + super.dFdN(phase, numberOfComponentphases,temperature,pressure));
