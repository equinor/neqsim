...
public class ComponentGENRTLmodifiedWS extends ComponentGeNRTL{
    ...
    public double getGamma(PhaseInterface phase,  int numberOfComponents, double temperature, double pressure, int phasetype, double[][] WSalpha, double[][] WSgij, double[][] intparam, String[][] mixRule){
        double[][] WSgijT = new double[numberOfComponents][numberOfComponents];
        return getGamma( phase,   numberOfComponents,  temperature,  pressure,  phasetype, WSalpha,  WSgij,  WSgijT, intparam, mixRule);
    }
    
    public double getGamma(PhaseInterface phase,  int numberOfComponents, double temperature, double pressure, int phasetype, double[][] WSalpha, double[][] WSgij, double[][] WSgijT, double[][] intparam, String[][] mixRule){
