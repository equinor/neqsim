...
public class ComponentGEUnifacPSRK extends ComponentGEUnifac {
        ...
        public double calcaij(PhaseInterface phase, int i, int j) {
                return ((PhaseGEUnifac) phase).getAij(i, j)
                                ...
                                + ((PhaseGEUnifac) phase).getCij(i, j)
        ...
        public void calclnGammakdT(int k, PhaseInterface phase) {
                ...
                for (int i = 0; i < getNumberOfUNIFACgroups(); i++) {
                        sum1Comp += getUnifacGroup(i).getQComp() * Math.exp(-1.0
                                        / phase.getTemperature()
                                        * calcaijdT(phase, getUnifacGroup(i).getGroupIndex(),
                                                        getUnifacGroup(k).getGroupIndex()));
                        sum1Mix += getUnifacGroup(i).getQMix() * Math.exp(-1.0
                                        / phase.getTemperature()
                                        * calcaijdT(phase, getUnifacGroup(i).getGroupIndex(),
                        ...
                        for (int j = 0; j < getNumberOfUNIFACgroups(); j++) {
                                sum2Comp += getUnifacGroup(j).getQComp() * Math.exp(-1.0
                                                / phase.getTemperature()
                                                * calcaijdT(phase,
                                                                getUnifacGroup(j).getGroupIndex(),
                                                                getUnifacGroup(i).getGroupIndex()));
                                sum2Mix += getUnifacGroup(j).getQMix() * Math.exp(-1.0
                                                / phase.getTemperature()
                                                * calcaijdT(phase,
                        ...
                        sum3Comp += getUnifacGroup(i).getQComp() * Math.exp(-1.0
                                        / phase.getTemperature()
                                        * calcaijdT(phase, getUnifacGroup(k).getGroupIndex(),
                                                        getUnifacGroup(i).getGroupIndex()))
                                        / sum2Comp;
                        sum3Mix += getUnifacGroup(i).getQMix() * Math.exp(-1.0
                                        / phase.getTemperature()
        ...
        public double getGamma(PhaseInterface phase, int numberOfComponents, double temperature,
                ...
                for (int j = 0; j < numberOfComponents; j++) {
                        ...
                        suml += compArray[j].getx()
                                        * (10.0 / 2.0 * (compArray[j].getR() - compArray[j].getQ())
                ...
                lngammaCombinational =
                                (10.0 / 2.0 * getQ() * Math.log(F / V) + li - V / getx() * suml)
                                                + Math.log(V / getx());
                ...
                for (int i = 0; i < getNumberOfUNIFACgroups(); i++) {
                        lngammaResidual += getUnifacGroup(i).getN()
                                        * (getUnifacGroup(i).getLnGammaMix()
                                                        - getUnifacGroup(i).getLnGammaComp());
                }
                ...
                if (initType > 1) {
                        ...
                        for (int i = 0; i < getNumberOfUNIFACgroups(); i++) {
                                ...
                                lngammaResidualdT += getUnifacGroup(i).getN() * (getUnifacGroup(i)
                                                .getLnGammaMixdT()
