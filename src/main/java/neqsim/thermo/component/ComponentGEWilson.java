...
public class ComponentGEWilson extends ComponentGE {
        ...
        public double fugcoef(PhaseInterface phase, int numberOfComponents, double temperature,
                ...
                fugasityCoeffisient = (this.getGamma(phase, numberOfComponents, temperature,
                                pressure, phasetype) * this.getAntoineVaporPressure(temperature)
                                / pressure);
        ...
        public double getWilsonActivityCoeffisient(PhaseInterface phase1) {
                ...
                for (int i = 0; i < phase1.getNumberOfComponents(); i++) {
                        sum1 += phase1.getComponent(i).getx()
                                        * ((ComponentGEWilson) phase1.getComponent(i))
                        ...
                        for (int j = 0; j < phase1.getNumberOfComponents(); j++) {
                                tempSum += phase1.getComponent(j).getx()
                                                * ((ComponentGEWilson) phase1.getComponent(j))
        ...
        public double getCharEnergyParamter(PhaseInterface phase1, int comp1, int comp2) {
                ...
                // carbon molecule .....
                if (phase1.getComponent(comp1).getMolarMass() > phase1.getComponent(comp2)
                                .getMolarMass()) {
                ...
                double energyParameter = Math.exp(-(param2 - param1)
