...
public class ComponentHydratePVTsim extends ComponentHydrate {
    ...
    public double fugcoef(PhaseInterface phase
        ...
        return fugcoef(phase,
                phase
                        .getNumberOfComponents(), phase
    ...
    public double fugcoef(PhaseInterface phase,
        ...
        if (hydrateStructure
            ...
            refPhase
                    .init(refPhase
                            .getNumberOfMolesInPhase(), 1, 3, 0, 1.0);

            double refWaterFugacityCoef
                    = Math
                            .log(refPhase
                                    .getComponent("water").fugcoef(refPhase
                            ));
            ...
            for (int structure
                ...
                if (componentName
                    ...
                    double alphaWater
                            = reffug[getComponentNumber()];

                    double wateralphaRef
                            = Math
                                    .log(refWaterFugacity
                                            / alphaWater
                                    );
                    logger
                            .info("wateralphaRef " + wateralphaRef
                                    + " refFUgalpha " + alphaWater
                    ...
                    for (int cavType
                        ...
                        for (int j
                            ...
                            double tee
                                    = ((ComponentHydrate) phase
                                            .getComponent(j
                                            )).calcYKI(hydrateStructure,
                                                    cavType,
                                                    phase
                                            );
                            tempy
                        ...
                        val
                                += getCavprwat()[hydrateStructure][cavType] * Math
                                        .log(1.0 - tempy
                                        );
                    ...
                    logger
                            .info("emty " + calcDeltaChemPot(phase,
                                    numberOfComps,
                                    temp,
                                    pres,
                                    hydrateStructure
        ...
        logFugasityCoeffisient
                = Math
                        .log(fugasityCoeffisient
                        );
        hydrateStructure
                = stableStructure;
    ...
    public double calcYKI(int stucture,
            int cavityType,
...
// else return 0.0;
    ...
    public double calcCKI(int stucture,
            int cavityType,
            PhaseInterface phase
    ) {
        ...
        return Ak[stucture][cavityType] / (phase
                .getTemperature()) * Math
                        .exp(Bk[stucture][cavityType] / (phase
                                .getTemperature()));

    }

    public double calcDeltaChemPot(PhaseInterface phase,
            int numberOfComps,
            double temp,
            double pres,
            int hydrateStruct
        ...
        if (hydrateStruct
            ...
            Cp
                    = -39.16;
            molarvolume
                    = getMolarVolumeHydrate(hydrateStruct,
                            temp
                    );
            deltaMolarVolume
                    = 4.6e-6;
