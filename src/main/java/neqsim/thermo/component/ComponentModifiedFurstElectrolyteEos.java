 ...
 * @version
 */
public class ComponentModifiedFurstElectrolyteEos extends ComponentSrk implements neqsim.thermo.ThermodynamicConstantsInterface {
    ...
    public ComponentModifiedFurstElectrolyteEos(String component_name, double moles, double molesInPhase, int compnumber){
    ...
    public void Finit(PhaseInterface phase, double temp, double pres, double totMoles, double beta, int numberOfComponents,  int type){
        ...
        WiT = ((PhaseModifiedFurstElectrolyteEos) phase).calcWiT(componentNumber, phase, temp, pres, numberOfComponents);
        ...
        alphai = - (electronCharge*electronCharge*avagadroNumber)/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),2.0)*R*temp)*diElectricdn;
        alphaiT = - electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),2.0)*R*temp)*diElectricdndT
        + electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),2.0)*R*temp*temp)*diElectricdn
        + 2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),3.0)*R*temp)*diElectricdn*((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstantdT();
        alphaiV = - electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),2.0)*R*temp)*diElectricdndV
        + 2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),3.0)*R*temp)*diElectricdn*((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstantdV();
    ...
    public double dAlphaLRdndn(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        double temp = 2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),3.0)*R*temperature)*diElectricdn*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getDiElectricConstantdn()
        -  electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getDiElectricConstant(),2.0)*R*temperature) * calcdiElectricdndn(j, phase, numberOfComponents, temperature, pressure);
        return temp;
    }
    ...
    public double dFLRdNdT(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).dFdAlphaLRdX()*  XLRi *((PhaseModifiedFurstElectrolyteEos) phase).getAlphaLRT()
    ...
    public double dFLRdNdV(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return 1e-5*(((PhaseModifiedFurstElectrolyteEos) phase).dFdAlphaLRdX()* XLRi *((PhaseModifiedFurstElectrolyteEos) phase).getAlphaLRV()
    ...
    public double dFLRdNdN(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).dFdAlphaLRdX()*XLRi*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getAlphai()
        +  ((PhaseModifiedFurstElectrolyteEos) phase).dFdAlphaLR()*dAlphaLRdndn(j, phase, numberOfComponents, temperature, pressure)
        +  ((PhaseModifiedFurstElectrolyteEos) phase).dFdAlphaLRdX()*alphai*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getXLRi();
    }
    
    public double calcXLRdN(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return Math.pow(getIonicCharge(),2.0) * ((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter()/(1.0 + ((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter()*getLennardJonesMolecularDiameter()*1e-10);
    }
    ...
    public double calcSolventdiElectricdn(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        ...
        //return 0.0;
        return getDiElectricConstant(temperature)/ans2 - ((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstant()/ans2;
    }
    ...
    public double calcSolventdiElectricdndn(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        if(getIonicCharge()!=0 || ((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j].getIonicCharge()!=0) {
            return 0.0;
        }
        double ans2 = 0.0;
        for(int i=0;i<numberOfComponents;i++){
        ...
        //return 0.0;
        return -getDiElectricConstant(temperature)/(ans2*ans2) - ((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j].getDiElectricConstant(temperature)/(ans2*ans2) + 2.0*((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstant()/(ans2*ans2);
    }
    ...
    public double calcSolventdiElectricdndT(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        ...
        //return 0.0;
        return getDiElectricConstantdT(temperature)/ans2 - ((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstantdT()/ans2;
    }
    
    public double calcdiElectricdn(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        double X= (1.0-((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic())/(1.0 + ((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0);
        double Y= ((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstant()-1.0;
        double dXdf= getEpsIonici() *  - 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,2.0);
    ...
    public double calcdiElectricdndV(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        double dXdf= ((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonicdV() *  - 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,2.0);
        double dYdf=getSolventDiElectricConstantdn();
        double d1 = ((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstant();
        double d2 = epsIoniciV * - 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,2.0);
        double d3 = ((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonicdV()*epsIonici * 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,3.0);
    ...
    public double calcdiElectricdndn(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        double dYdf= ((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getSolventDiElectricConstantdn();
        double dXdfdfj= getEpsIonici() *  - 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,2.0);
        
        double dXdf= ((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getEpsIonici()*getEpsIonici() * 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,3.0);
        double d1 = ((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstant();
        
        double d2 = ((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getEpsIonici() * - 3.0/2.0/Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0+1.0,2.0);
        ...
        double d4 =(1.0-((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic())/(1.0 + ((PhaseModifiedFurstElectrolyteEos) phase).getEpsIonic()/2.0);
    ...
    public double calcGammaLRdn(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        ...
        //                double temp = Math.pow(getIonicCharge()/(1.0+((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter()*getLennardJonesMolecularDiameter()*1e-10),2.0);
        //                return  1.0/(8.0*((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter() + 4.0 * Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).calcShieldingParameter2(),2.0) * 2.0 * getLennardJonesMolecularDiameter()*1e-10) *
        //                ((temp * ((PhaseModifiedFurstElectrolyteEos) phase).getAlphaLR2()/(((PhaseModifiedFurstElectrolyteEos) phase).getMolarVolume()*1e-5*((PhaseModifiedFurstElectrolyteEos) phase).getNumberOfMolesInPhase()) * avagadroNumber)
        //                + 4.0 * Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter(),2.0) / ((PhaseModifiedFurstElectrolyteEos) phase).getAlphaLR2() * alphai );
        //                     Math.pow(getIonicCharge()/(1.0+((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter()*getLennardJonesMolecularDiameter()*1e-10),2.0) +  alphai*temp) /(8.0*((PhaseModifiedFurstElectrolyteEos) phase).getShieldingParameter());
        //                + 2.0*getLennardJonesMolecularDiameter()*1e-10 * 4.0 * Math.pow(((PhaseModifiedFurstElectrolyteEos) phase).calcShieldingParameter2(),2.0))*
    }
    ...
    public double dFSR2dN(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).FSR2eps()*epsi + ((PhaseModifiedFurstElectrolyteEos) phase).FSR2W()*Wi;
    }
    ...
    public double dFSR2dNdT(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        ...
        +  ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epsW()*epsi*((PhaseModifiedFurstElectrolyteEos) phase).getWT();
    }
    
    public double dFSR2dNdV(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return 1.0e-5*(
        + ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epseps()*epsi*((PhaseModifiedFurstElectrolyteEos) phase).getEpsdV()
        + ((PhaseModifiedFurstElectrolyteEos) phase).FSR2eps()*epsiV
        + ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epsW()*Wi*((PhaseModifiedFurstElectrolyteEos) phase).getEpsdV()
    ...
    public double dFSR2dNdN(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epseps()*epsi*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getEpsi()
        +   ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epsW() * Wi* ((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getEpsi()
        +   ((PhaseModifiedFurstElectrolyteEos) phase).FSR2W() * ((PhaseModifiedFurstElectrolyteEos) phase).calcWij(componentNumber,j, phase, temperature, pressure, numberOfComponents)
        +   ((PhaseModifiedFurstElectrolyteEos) phase).FSR2epsW()*epsi*((PhaseModifiedFurstElectrolyteEos) phase).calcWi(j, phase, temperature, pressure, numberOfComponents);
    }
    ...
    public double dFBorndN(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).FBornX()*getXBorni() + ((PhaseModifiedFurstElectrolyteEos) phase).FBornD()*solventdiElectricdn;
    }
    ...
    public double dFBorndNdT(PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        ...
        ((PhaseModifiedFurstElectrolyteEos) phase).FBornDX()*XBorni*((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstantdT())
        ...
        + ((PhaseModifiedFurstElectrolyteEos) phase).FBornDD() *getSolventDiElectricConstantdn()*((PhaseModifiedFurstElectrolyteEos) phase).getSolventDiElectricConstantdT();
    }
    
    public double dFBorndNdN(int j, PhaseInterface phase, int numberOfComponents, double temperature, double pressure){
        return ((PhaseModifiedFurstElectrolyteEos) phase).FBornDD()*solventdiElectricdn*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getSolventDiElectricConstantdn()
        ...
        +  ((PhaseModifiedFurstElectrolyteEos) phase).FBornDX()*solventdiElectricdn*((ComponentModifiedFurstElectrolyteEos)((PhaseModifiedFurstElectrolyteEos) phase).getComponents()[j]).getXBorni()
        +  ((PhaseModifiedFurstElectrolyteEos) phase).FBornD()*calcSolventdiElectricdndn(j , phase, numberOfComponents, temperature, pressure);
    }
