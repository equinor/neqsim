...
public final class ComponentNameResolver {
  ...
  private static Map<String, String> buildCanonicalNames() {
    ...
    put(m, "(e)-2-methyl-3-hexene", "(e)-2-methyl-3-hexene");
    put(m, "(e)-3,4-dimethyl-2-pentene", "(e)-3,4-dimethyl-2-pentene");
    put(m, "(e)-3-methyl-3-hexene", "(e)-3-methyl-3-hexene");
    put(m, "-oocpzcoo-", "-OOCPZCOO-");
    put(m, "1,1,2-trimethylcyclopentane", "1,1,2-trimethylcyclopentane");
    put(m, "1,1,3-tm-cy-c6", "1.1.3-TM-cy-C6");
    put(m, "1,1,4-trimethylcyclohexane", "1,1,4-trimethylcyclohexane");
    put(m, "1,1-dimethylcyclohexane", "1,1-dimethylcyclohexane");
    put(m, "1,2,3,5-tetramethylcyclohexane", "1,2,3,5-tetramethylcyclohexane");
    put(m, "1,2,3-tm-benzene", "1.2.3-TM-Benzene");
    put(m, "1,2,3-tmcyc6", "1.2.3-TMcyC6");
    put(m, "1,2,3-trimethylcyclopentane", "1,2,3-trimethylcyclopentane");
    put(m, "1,2,4,5-tetramethylbenzene", "1,2,4,5-tetramethylbenzene");
    put(m, "1,2,4-tmcyc6", "1.2.4-TMcyC6");
    put(m, "1,2,4-trimethylbenzene", "1,2,4-trimethylbenzene");
    put(m, "1,2,4-trimethylcyclopentane", "1,2,4-trimethylcyclopentane");
    put(m, "1,2-diethylbenzene", "1,2-diethylbenzene");
    put(m, "1,2-dm-cyc5", "1.2-DM-cyC5");
    put(m, "1,3,5-triethylbenzene", "1,3,5-triethylbenzene");
    put(m, "1,3-ddm-cyc5", "1.3-dDM-cyC5");
    put(m, "1,3-diethylcyclopentane", "1,3-diethylcyclopentane");
    put(m, "1,4-diethylbenzene", "1,4-diethylbenzene");
    put(m, "1,5-dimethylcyclopentene", "1,5-dimethylcyclopentene");
    put(m, "1-butene", "1-butene");
    put(m, "1-butyl-2-methylbenzene", "1-butyl-2-methylbenzene");
    put(m, "1-ethyl-2,3-dimethylbenzene", "1-ethyl-2,3-dimethylbenzene");
    put(m, "1-ethyl-2,4-dimethylbenzene", "1-ethyl-2,4-dimethylbenzene");
    put(m, "1-ethyl-2-methylcyclopentane", "1-ethyl-2-methylcyclopentane");
    put(m, "1-ethyl-3-methylcyclopentane", "1-ethyl-3-methylcyclopentane");
    put(m, "1-heptene", "1-heptene");
    put(m, "1-hexene", "1-hexene");
    put(m, "1-methyl-1-ethylcyclohexane", "1-methyl-1-ethylcyclohexane");
    put(m, "1-methyl-2-propylcyclohexane", "1-Methyl-2-propylcyclohexane");
    put(m, "1-methyl-2-propylcyclopentane", "1-methyl-2-propylcyclopentane");
    put(m, "1-methylcyclohexene", "1-methylcyclohexene");
    put(m, "1-methylcyclopentene", "1-methylcyclopentene");
    put(m, "1-methylnaphthalene", "1-methylnaphthalene");
    put(m, "1-pentene", "1-pentene");
    ...
    put(m, "2,2,3-trimethylhexane", "2,2,3-trimethylhexane");
    put(m, "2,2,3-trimethylpentane", "2,2,3-trimethylpentane");
    put(m, "2,2,4-trimethylheptane", "2,2,4-trimethylheptane");
    put(m, "2,2,4-trimethylhexane", "2,2,4-trimethylhexane");
    put(m, "2,2,5-trimethylhexane", "2,2,5-trimethylhexane");
    put(m, "2,2,6-trimethyloctane", "2,2,6-trimethyloctane");
    put(m, "2,2-dimethyloctane", "2,2-dimethyloctane");
    put(m, "2,2-dm-c7", "2.2-DM-C7");
    put(m, "2,3,3-trimethyl-1-butene", "2,3,3-trimethyl-1-butene");
    put(m, "2,3,3-trimethyloctane", "2,3,3-trimethyloctane");
    put(m, "2,3,3-trimethylpentane", "2,3,3-trimethylpentane");
    put(m, "2,3,4-trimethyl-1,4-pentadiene", "2,3,4-trimethyl-1,4-pentadiene");
    put(m, "2,3,5-trimethylhexane", "2,3,5-trimethylhexane");
    put(m, "2,3-dimethyl-1-hexene", "2,3-dimethyl-1-hexene");
    put(m, "2,3-dimethyl-2-heptene", "2,3-dimethyl-2-heptene");
    put(m, "2,3-dimethyl-2-octene", "2,3-dimethyl-2-octene");
    put(m, "2,3-dimethyl-2-pentene", "2,3-dimethyl-2-pentene");
    put(m, "2,3-dimethylheptane", "2,3-dimethylheptane");
    put(m, "2,3-dimethyloctane", "2,3-dimethyloctane");
    put(m, "2,3-dm-c6", "2.3-DM-C6");
    put(m, "2,4-dimethyl-1-heptene", "2,4-dimethyl-1-heptene");
    put(m, "2,4-dimethylheptane", "2,4-dimethylheptane");
    put(m, "2,4-dimethyloctane", "2,4-dimethyloctane");
    put(m, "2,5,6-trimethyloctane", "2,5,6-trimethyloctane");
    put(m, "2,5-dimethylheptane", "2,5-dimethylheptane");
    put(m, "2,5-dimethyloctane", "2,5-dimethyloctane");
    put(m, "2,6-dimethyl-3-heptene", "2,6-dimethyl-3-heptene");
    put(m, "2,6-dimethyloctane", "2,6-dimethyloctane");
    put(m, "2,6-dm-c7", "2.6-DM-C7");
    put(m, "2,7-dimethyloctane", "2,7-dimethyloctane");
    put(m, "2-e-p-xylene", "2-E-p-xylene");
    put(m, "2-ethyl-1,3-dimethylbenzene", "2-ethyl-1,3-dimethylbenzene");
    put(m, "2-hexene", "2-hexene");
    put(m, "2-m-c5", "2-m-C5");
    put(m, "2-m-c6", "2-M-C6");
    put(m, "2-m-c7", "2-M-C7");
    put(m, "2-m-c8", "2-M-C8");
    put(m, "2-methyl-1-butene", "2-methyl-1-butene");
    put(m, "2-methyl-1-heptene", "2-methyl-1-heptene");
    put(m, "2-methyl-1-hexene", "2-methyl-1-hexene");
    put(m, "2-methyl-1-pentene", "2-methyl-1-pentene");
    put(m, "2-methyl-2-butene", "2-methyl-2-butene");
    put(m, "2-methyl-2-hexene", "2-methyl-2-hexene");
    put(m, "2-methyl-2-octene", "2-methyl-2-octene");
    put(m, "2-methyl-2-pentene", "2-methyl-2-pentene");
    put(m, "2-methylnaphthalene", "2-methylnaphthalene");
    put(m, "2-propyltoluene", "2-propyltoluene");
    ...
    put(m, "3,3-dimethyl-1-butene", "3,3-dimethyl-1-butene");
    put(m, "3,3-dimethyl-1-pentene", "3,3-dimethyl-1-pentene");
    put(m, "3,4-dimethylheptane", "3,4-dimethylheptane");
    put(m, "3,4-dimethylhexane", "3,4-dimethylhexane");
    put(m, "3,5-dimethyl-3-heptene", "3,5-dimethyl-3-heptene");
    put(m, "3,5-dimethylcyclopentene", "3,5-dimethylcyclopentene");
    put(m, "3,5-dimethylheptane", "3,5-dimethylheptane");
    put(m, "3-e-c6", "3-E-C6");
    put(m, "3-ethyl-2-methylpentane", "3-ethyl-2-methylpentane");
    put(m, "3-ethyl-2-pentene", "3-ethyl-2-pentene");
    put(m, "3-ethyl-3-hexene", "3-ethyl-3-hexene");
    put(m, "3-ethylcyclopentene", "3-ethylcyclopentene");
    put(m, "3-ethylheptane", "3-ethylheptane");
    put(m, "3-ethylnonane", "3-ethylnonane");
    put(m, "3-ethyloctane", "3-ethyloctane");
    put(m, "3-ethylpentane", "3-ethylpentane");
    put(m, "3-ethyltoluene", "3-ethyltoluene");
    put(m, "3-m-4,4-de-heptane", "3-M-4.4-DE-heptane");
    put(m, "3-m-c5", "3-m-C5");
    put(m, "3-m-c6", "3-M-C6");
    put(m, "3-m-c7", "3-M-C7");
    put(m, "3-m-c8", "3-M-C8");
    put(m, "3-methyl-1-butene", "3-methyl-1-butene");
    put(m, "3-methyl-1-hexene", "3-methyl-1-hexene");
    put(m, "3-methyl-1-pentene", "3-methyl-1-pentene");
    put(m, "3-methyl-2-hexene", "3-methyl-2-hexene");
    put(m, "3-methylnonane", "3-methylnonane");
    put(m, "3-propyltoluene", "3-propyltoluene");
    put(m, "33-dm-c5", "33-DM-C5");
    put(m, "33-dm-c6", "33-DM-C6");
    put(m, "4-ethyl-2-methylhexane", "4-ethyl-2-methylhexane");
    put(m, "4-ethyl-o-xylene", "4-ethyl-o-xylene");
    put(m, "4-ethylheptane", "4-ethylheptane");
    put(m, "4-ethyltoluene", "4-ethyltoluene");
    put(m, "4-m-c8", "4-M-C8");
    put(m, "4-methyl-1-hexene", "4-methyl-1-hexene");
    put(m, "4-methylheptane", "4-methylheptane");
    put(m, "4-methylnonane", "4-methylnonane");
    put(m, "5-ethyl-m-xylene", "5-ethyl-m-xylene");
    put(m, "5-ethyltetralin", "5-ethyltetralin");
    put(m, "5-methyl-3-heptene", "5-methyl-3-heptene");
    put(m, "5-methyl-3-heptyne", "5-methyl-3-heptyne");
    put(m, "5-methylnonane", "5-methylnonane");
    put(m, "5-undecene", "5-undecene");
    put(m, "ac-", "Ac-");
    ...
    put(m, "biphenyl", "biphenyl");
    put(m, "br-", "Br-");
    put(m, "butylbenzene", "butylbenzene");
    put(m, "c-c4", "c-C4");
    put(m, "c-c5", "c-C5");
    put(m, "c-c7", "c-C7");
    put(m, "c-c8", "c-C8");
    ...
    put(m, "cis-2-heptene", "cis-2-heptene");
    put(m, "cis-2-octene", "cis-2-Octene");
    put(m, "cis-2-pentene", "cis-2-pentene");
    put(m, "cis-3-hexene", "cis-3-hexene");
    put(m, "cis-3-octene", "cis-3-octene");
    put(m, "cis-4-octene", "cis-4-octene");
    ...
    put(m, "cumene", "cumene");
    put(m, "cy-c9", "cy-C9");
    put(m, "cyclohexene", "cyclohexene");
    put(m, "cyclopentene", "cyclopentene");
    put(m, "dea", "DEA");
    put(m, "dea+", "DEA+");
    put(m, "deacoo-", "DEACOO-");
    ...
    put(m, "isobutylbenzene", "isobutylbenzene");
    put(m, "isobutylcyclohexane", "isobutylcyclohexane");
    put(m, "isoprene", "isoprene");
    put(m, "isopropylcyclohexane", "isopropylcyclohexane");
    put(m, "k+", "K+");
    put(m, "li+", "Li+");
    put(m, "m-cy-c5", "M-cy-C5");
    put(m, "m-cy-c6", "M-cy-C6");
    put(m, "m-cymene", "m-cymene");
    put(m, "m-diethylbenzene", "m-diethylbenzene");
    ...
    put(m, "pentamethylbenzene", "pentamethylbenzene");
    put(m, "pg", "PG");
    ...
    put(m, "trans-1,3-dimethylcyclohexane", "trans-1,3-dimethylcyclohexane");
    put(m, "trans-1,3-pentadiene", "trans-1,3-Pentadiene");
    put(m, "trans-1-ethyl-2-methylcyclopentane", "trans-1-ethyl-2-methylcyclopentane");
    ...
    put(m, "trans-2-nonene", "trans-2-nonene");
    put(m, "trans-3-heptene", "trans-3-heptene");
    put(m, "trans-3-methyl-2-pentene", "trans-3-Methyl-2-pentene");
    put(m, "trans-3-nonene", "trans-3-nonene");
    put(m, "trans-4-methyl-2-pentene", "trans-4-Methyl-2-pentene");
