...
public class AtractiveTermPrDelft1998 extends AtractiveTermPr1978{
    ...
    public double alpha(double temperature){
        if(isMethane) {
            return 0.969617+0.20089*temperature/component.getTC()-0.3256987*Math.pow(temperature/component.getTC(),2.0)+0.06653*Math.pow(temperature/component.getTC(),3.0);
        } else {
    ...
    public double diffalphaT(double temperature) {
        if(isMethane) {
            return 0.20089/component.getTC()-2.0*0.3256987*temperature/Math.pow(component.getTC(),2.0)+3.0*0.06653*Math.pow(temperature,2.0)/Math.pow(component.getTC(),3.0);
        } else {
    ...
    public double diffdiffalphaT(double temperature) {
        if(isMethane) {
            return -2.0*0.3256987/Math.pow(component.getTC(),2.0)+6.0*0.06653*temperature/Math.pow(component.getTC(),3.0);
        } else {
