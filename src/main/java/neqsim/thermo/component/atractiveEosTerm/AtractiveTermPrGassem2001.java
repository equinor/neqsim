...
public class AtractiveTermPrGassem2001 extends AtractiveTermPr{
    ...
    public double alpha(double temperature){
        ...
        return Math.exp((A+B*temperature/component.getTC())*(1.0-Math.pow(temperature/component.getTC(),C+D*component.getAcentricFactor()+E*component.getAcentricFactor()*component.getAcentricFactor())));
    }
    ...
    public double diffalphaT(double temperature) {
        return 1.0/component.getTC()*alpha(temperature)*((B*(1.0-Math.pow(temperature/component.getTC(),C+D*component.getAcentricFactor()+E*component.getAcentricFactor()*component.getAcentricFactor())))-(A+B*temperature/component.getTC())*(C+D*component.getAcentricFactor()+E*component.getAcentricFactor()*component.getAcentricFactor())*Math.pow(temperature/component.getTC(),C+D*component.getAcentricFactor()+E*component.getAcentricFactor()*component.getAcentricFactor()-1.0));
    }
