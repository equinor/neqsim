 ...
 * @version
 */
public class PhaseModifiedFurstElectrolyteEos extends PhaseSrkEos implements neqsim.thermo.ThermodynamicConstantsInterface{

    private static final long serialVersionUID = 1000;
    double gammaold=0, alphaLRdTdV=0;
    double W=0, WT=0, WTT=0, eps=0, epsdV=0, epsdVdV=0, epsIonic=0,bornX=0, epsIonicdV=0,epsIonicdVdV=0, alphaLR2=0,alphaLRdT=0.0, alphaLRdTdT=0.0, alphaLRdV=0.0, XLR=0, solventDiElectricConstant=0, solventDiElectricConstantdT=0.0,solventDiElectricConstantdTdT=0, shieldingParameter=0;
    ...
    public void volInit(){
        ...
        alphaLR2 = electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*R*temperature);
        alphaLRdT = - electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*R*temperature*temperature)
        - electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdT;
        alphaLRdV = -electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdV;
        alphaLRdTdT =  2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*R*Math.pow(temperature,3.0))
        +   electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature*temperature)*diElectricConstantdT
                -   electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdTdT
                +   electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature*temperature)*diElectricConstantdT
                +   2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(diElectricConstant,3.0)*R*temperature)*Math.pow(diElectricConstantdT,2.0);
        alphaLRdTdV = electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature*temperature)*diElectricConstantdV
                + 2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdT*diElectricConstantdV
                - electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdTdV;
        alphaLRdVdV = -electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*diElectricConstant*diElectricConstant*R*temperature)*diElectricConstantdVdV
                + 2.0*electronCharge*electronCharge*avagadroNumber/(vacumPermittivity*Math.pow(diElectricConstant,3.0)*R*temperature)*diElectricConstantdV*diElectricConstantdV;
    ...
    public void addcomponent(String componentName, double moles,double molesInPhase,  int compNumber){
        ...
        componentArray[compNumber] = new neqsim.thermo.component.ComponentModifiedFurstElectrolyteEos(componentName, moles, molesInPhase, compNumber);
    }
    ...
    public double calcEps(){
        double eps=0.0;
        for(int i=0;i<numberOfComponents;i++){
            eps += avagadroNumber*pi/6.0*componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getLennardJonesMolecularDiameter()*1e-10,3.0)*1.0/(numberOfMolesInPhase*getMolarVolume()*1e-5);
        }
        return eps;
    }
    ...
    public double calcEpsIonic(){
        ...
        for(int i=0;i<numberOfComponents;i++){
            if(componentArray[i].getIonicCharge()!=0){
                epsIonicLoc += avagadroNumber*pi/6.0*componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getLennardJonesMolecularDiameter()*1e-10,3.0)/(numberOfMolesInPhase*getMolarVolume()*1e-5);
            }
        }
        return epsIonicLoc;
    }
    ...
    public double calcXLR(){
        ...
        for(int i=0;i<numberOfComponents;i++){
            if(componentArray[i].getIonicCharge()!=0){
                ans += componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getIonicCharge(), 2.0)*getShieldingParameter()/(1.0+getShieldingParameter()*componentArray[i].getLennardJonesMolecularDiameter()*1e-10);
            }
        }
        return ans;
    }
    ...
    public double calcShieldingParameter(){
        ...
        do{
            ...
            for(int i=0;i<numberOfComponents;i++){
                if(componentArray[i].getIonicCharge()!=0){
                    ions++;
                    f  += -getAlphaLR2()*componentArray[i].getNumberOfMolesInPhase()/(getMolarVolume()*numberOfMolesInPhase*1e-5)*Math.pow(componentArray[i].getIonicCharge()/(1.0+gamma*componentArray[i].getLennardJonesMolecularDiameter()*1e-10),2.0);
                    df += 2.0*getAlphaLR2()*componentArray[i].getNumberOfMolesInPhase()/(getMolarVolume()*numberOfMolesInPhase*1e-5)*Math.pow(componentArray[i].getIonicCharge(),2.0)*(componentArray[i].getLennardJonesMolecularDiameter()*1e-10)/(Math.pow(1.0+gamma*componentArray[i].getLennardJonesMolecularDiameter()*1e-10,3.0));
                }
            }
    ...
    //                if(componentArray[i].getIonicCharge()!=0){
    //                    ions++;
    //                    f  += -  getAlphaLR2()*componentArray[i].getNumberOfMolesInPhase()/(molarVolume*numberOfMolesInPhase*1e-5)*Math.pow(componentArray[i].getIonicCharge(),2.0)/Math.pow((1.0+gamma*componentArray[i].getLennardJonesMolecularDiameter()*1e-10),3.0);
    //                    df += getAlphaLR2()*componentArray[i].getNumberOfMolesInPhase()/(molarVolume*numberOfMolesInPhase*1e-5)*Math.pow(componentArray[i].getIonicCharge(),2.0)*(componentArray[i].getLennardJonesMolecularDiameter()*1e-10)/Math.pow(1.0+gamma*componentArray[i].getLennardJonesMolecularDiameter()*1e-10,4.0);
    //                }
    //            }
    //            gamma = ions>0 ? gammaold - 0.8*f/df : 0;
    //        }
    ...
    public double molarVolume(double pressure, double temperature, double A, double B, int phase) throws neqsim.util.exception.IsNaNException, neqsim.util.exception.TooManyIterationsException{
        ...
        //double BonV = phase== 0 ? 2.0/(2.0+temperature/getPseudoCriticalTemperature()):0.1*pressure*getB()/(numberOfMolesInPhase*temperature*R);
    ...
    public double calcBornX(){
        ...
        for(int i=0;i<numberOfComponents;i++){
            if(componentArray[i].getLennardJonesMolecularDiameter()>0) {
                ans += componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getIonicCharge(), 2.0)/(componentArray[i].getLennardJonesMolecularDiameter()*1e-10);
            }
        }
        return ans;
    }
    ...
    public double FLR(){
        ...
        return ans + (numberOfMolesInPhase*getMolarVolume()*1e-5*Math.pow(getShieldingParameter(),3.0))/(3.0*pi*avagadroNumber);
    }
    ...
    public double dFLRdV(){
        return (FLRV()+dFdAlphaLR()*alphaLRdV)*1e-5;// + FLRGammaLR()*gammLRdV + 0*FLRXLR()*XLRdGammaLR()*gammLRdV)*1e-5;
    }
    ...
    public double FLRGammaLR(){
        return 3.0*numberOfMolesInPhase*getMolarVolume()*1e-5*Math.pow(getShieldingParameter(),2.0)/(3.0*pi*avagadroNumber);
    }
    ...
    public double XLRdGammaLR(){
        ...
        double ans2=0.0;
        for(int i=0;i<numberOfComponents;i++){
            ans -= componentArray[i].getLennardJonesMolecularDiameter()*1e-10*componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getIonicCharge(), 2.0)*getShieldingParameter()/Math.pow(1.0+getShieldingParameter()*componentArray[i].getLennardJonesMolecularDiameter()*1e-10,2.0);
            ans2 += componentArray[i].getNumberOfMolesInPhase()*Math.pow(componentArray[i].getIonicCharge(), 2.0)/(1.0+getShieldingParameter()*componentArray[i].getLennardJonesMolecularDiameter()*1e-10);
    ...
    public double dFSR2dVdV(){
        return (FSR2VV() + 2.0*FSR2epsV()*getEpsdV() + FSR2epseps()*Math.pow(getEpsdV(),2.0) + FSR2eps()*getEpsdVdV())*1e-10;
    }
    
    public double dFSR2dVdVdV(){
        return (FSR2VVV() + 3*FSR2epsepsV() * Math.pow(getEpsdV(),2.0) + 3*FSR2VVeps() * getEpsdV() + FSR2epsepseps()*Math.pow(getEpsdV(),3.0))*1e-15;
    }
    ...
    public double FBorn(){
        return (avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature))*(1.0/getSolventDiElectricConstant()-1.0)*bornX;
    }
    ...
    public double FBornT(){
        return -(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature*temperature))*(1.0/getSolventDiElectricConstant()-1.0)*bornX;
    }
    
    public double FBornX(){
        return (avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature))*(1.0/getSolventDiElectricConstant()-1.0);
    }
    
    public double FBornD(){
        return  -(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature))*1.0/Math.pow(getSolventDiElectricConstant(),2.0)*bornX;
    }
    
    // second order derivatives
    
    public double FBornTT(){
        return 2.0*(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature*temperature*temperature))*(1.0/getSolventDiElectricConstant()-1.0)*bornX;
    }
    
    public double FBornTD(){
        return (avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature*temperature))*1.0/Math.pow(getSolventDiElectricConstant(),2.0)*bornX;
    }
    
    public double FBornTX(){
        return -(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature*temperature))*(1.0/getSolventDiElectricConstant()-1.0);
    }
    
    public double FBornDD(){
        return 2.0*(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature))*1.0/Math.pow(getSolventDiElectricConstant(),3.0)*bornX;
    }
    
    public double FBornDX(){
        return -(avagadroNumber*electronCharge*electronCharge/(4.0*pi*vacumPermittivity*R*temperature))*1.0/Math.pow(getSolventDiElectricConstant(),2.0);
    }
