 ...
 * @version
 */
public class PhaseModifiedFurstElectrolyteEosMod2004 extends PhaseSrkEos implements neqsim.thermo.ThermodynamicConstantsInterface{
    ...
    public void addcomponent(String componentName, double moles,double molesInPhase,  int compNumber){
        ...
        componentArray[compNumber] = new neqsim.thermo.component.ComponentModifiedFurstElectrolyteEosMod2004(componentName, moles, molesInPhase, compNumber);
    }
