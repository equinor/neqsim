...
public class PhasePCSAFT extends PhaseSrkEos {
    ...
    private double F1dispVolTerm = 1.0, F1dispSumTerm = 1.0, F1dispI1 = 1.0, F2dispI2 = 1.0, F2dispZHC = 1.0,
            F2dispZHCdN = 1.0, F2dispZHCdm = 1.0, F2dispZHCdV = 1.0, F2dispI2dVdV = 0.0, F2dispZHCdVdV = 0.0,
            F1dispI1dNdN = 1.0;
    private double F1dispVolTermdV = 1.0, F1dispVolTermdVdV = 1.0, F1dispI1dN = 1.0, F1dispI1dm = 1.0, F1dispI1dV = 1.0,
            ...
            F2dispI2dNdN = 1.0, F1dispI1dVdV = 0.0;
...
//        System.out.println("N SAFT " + getNSAFT());
    ...
    public double calcF2dispZHCdN() {
        ...
        return temp0 * (getmSAFT()
                * ((8.0 - 4.0 * getNSAFT()) * Math.pow(1.0 - getNSAFT(), 4.0) - 4.0 * Math.pow(1.0 - getNSAFT(), 3.0)
                        * (-1.0) * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2.0)))
                / Math.pow(1.0 - getNSAFT(), 8.0)
                + (1.0 - getmSAFT()) * ((20.0 - (2.0 * 27.0) * getNSAFT() + (12.0 * 3.0) * Math.pow(getNSAFT(), 2.0)
...
// ikke rett implementert
        ...
        double dZdndn = getmSAFT()
                * ((-4.0 * Math.pow(1.0 - getNSAFT(), 4.0)
                ...
                + (1.0 - getmSAFT()) * (((-54.0 + 72.0 * getNSAFT() - 24.0 * Math.pow(getNSAFT(), 2.0)) * temp1
                        ...
                        - ((-40.0 * Math.pow(getNSAFT(), 4.0) + 240.0 * Math.pow(getNSAFT(), 3.0)
                                ...
                                - temp11der * (-8.0 * Math.pow(getNSAFT(), 5.0) + 60.0 * Math.pow(getNSAFT(), 4.0)
                                        - 180.0 * Math.pow(getNSAFT(), 3.0) + 242.0 * Math.pow(getNSAFT(), 2.0)
                                        - 120.0 * getNSAFT()))
                                / Math.pow(temp11, 2.0));
        ...
        for (int i = 0; i < numberOfComponents; i++) {
            for (int j = 0; j < numberOfComponents; j++) {
                temp1 += getComponent(i).getNumberOfMolesInPhase() * getComponent(j).getNumberOfMolesInPhase()
                        ...
                        * Math.sqrt(getComponent(i).getEpsikSAFT() / temperature * getComponent(j).getEpsikSAFT()
                                / temperature)
    ...
    public double calcF2dispSumTerm() {
        ...
        for (int i = 0; i < numberOfComponents; i++) {
            for (int j = 0; j < numberOfComponents; j++) {
                temp1 += getComponent(i).getNumberOfMolesInPhase() * getComponent(j).getNumberOfMolesInPhase()
                        * getComponent(i).getmSAFTi() * getComponent(j).getmSAFTi() * getComponent(i).getEpsikSAFT()
    ...
    /**
     * <p>Getter for the field <code>nSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>nSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>dSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>dSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>ghsSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>ghsSAFT</code>.</p>
     *
    ...
    /**
     * <p>dF_DISP1_SAFTdVdV.</p>
     *
     * @return a double
     */
    public double dF_DISP1_SAFTdVdV() {
        return getNumberOfMolesInPhase() * ((-2.0 * ThermodynamicConstantsInterface.pi * F1dispVolTermdVdV
    ...
    public double F_DISP2_SAFT() {
        return getNumberOfMolesInPhase() * (-ThermodynamicConstantsInterface.pi * getmSAFT() * getF1dispVolTerm()
                * getF2dispSumTerm() * getF2dispI2() * getF2dispZHC());/// (ThermodynamicConstantsInterface.R*temperature);
    }
...
//        System.out.println("F-DISP2 " + useDISP2*F_DISP2_SAFT());
    ...
    /**
     * <p>Getter for the field <code>mdSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>mdSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>mSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>mSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>aHSSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>aHSSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>mmin1SAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>mmin1SAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>volumeSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>volumeSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>dgHSSAFTdN</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>dgHSSAFTdN</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>dnSAFTdV</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>dnSAFTdV</code>.</p>
     *
    ...
    public double molarVolume22(double pressure, double temperature, double A, double B, int phase)
        ...
        double volume = phase == 0 ? getB() / (2.0 / (2.0 + temperature / getPseudoCriticalTemperature()))
...
//        System.out.println("error BonV " + Math.abs((BonV-BonVold)/BonV));
    ...
    /**
     * <p>Getter for the field <code>dmeanSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>dmeanSAFT</code>.</p>
     *
    ...
    /**
     * <p>Getter for the field <code>nmSAFT</code>.</p>
     *
     * @return a double
     */
    ...
    /**
     * <p>Setter for the field <code>nmSAFT</code>.</p>
     *
