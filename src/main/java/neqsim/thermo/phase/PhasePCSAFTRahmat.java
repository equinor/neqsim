...
//        System.out.println("N SAFT " + getNSAFT());
        dnSAFTdVdVdV = -6.0 * ThermodynamicConstantsInterface.pi / 6.0 * ThermodynamicConstantsInterface.avagadroNumber * getNumberOfMolesInPhase() / Math.pow(volumeSAFT, 4.0) * getDSAFT();
//

        //added by rahmat

        dNSAFTdT = 1.0 * ThermodynamicConstantsInterface.pi / 6.0 * ThermodynamicConstantsInterface.avagadroNumber * getNumberOfMolesInPhase() / volumeSAFT * getdDSAFTdT();
        ...
        daHSSAFTdNdNdN = -36 / Math.pow((1 - getNSAFT()), 3) + (18.0 * (4.0 - 6.0 * getNSAFT())) / Math.pow((1 - getNSAFT()), 4.0) + (24.0 * (4.0 * getNSAFT() - 3.0 * Math.pow(getNSAFT(), 2.0))) / Math.pow((1 - getNSAFT()), 5.0);
        ...
        dgHSSAFTdNdNdN = -6.0 / Math.pow(1.0 - getNSAFT(), 5.0) - (12.0 * (3.0 - 1.5 * getNSAFT())) / Math.pow(1.0 - getNSAFT(), 6.0) + (8 * (-1.5 * Math.pow(1.0 - getNSAFT(), 4) + 4.0 * Math.pow(1.0 - getNSAFT(), 3) * (3.0 - 1.5 * getNSAFT()))) / Math.pow(1.0 - getNSAFT(), 9);
        ...
        F1dispVolTermdVdVdV = -6.0 * ThermodynamicConstantsInterface.avagadroNumber * getNumberOfMolesInPhase() / Math.pow(getVolumeSAFT(), 4.0);
        ...
        //added by Rahmat
        F1dispI1dVdVdV = F1dispI1dNdNdN * getDnSAFTdV() * getDnSAFTdV() * getDnSAFTdV() + F1dispI1dN * 2.0 * getDnSAFTdV() * dnSAFTdVdV + F1dispI1dNdN * dnSAFTdVdV + F1dispI1dN * dnSAFTdVdVdV; //F1dispI1dNdN*dnSAFTdVdV;
        ...
        //added by Rahmat
        F2dispI2dVdVdV = F2dispI2dNdNdN * getDnSAFTdV() * getDnSAFTdV() * getDnSAFTdV() + F2dispI2dN * 2.0 * getDnSAFTdV() * dnSAFTdVdV + F2dispI2dNdN * dnSAFTdVdV + F2dispI2dN * dnSAFTdVdVdV;
        ...
        F2dispZHCdVdVdV = F2dispZHCdNdNdN * getDnSAFTdV() * getDnSAFTdV() * getDnSAFTdV() + F2dispZHCdNdN * 2.0 * getDnSAFTdV() * dnSAFTdVdV + F2dispZHCdNdN * dnSAFTdVdV + F2dispZHCdN * dnSAFTdVdVdV;
    }
...
// ikke rett implementert
    ...
    public double calcF2dispZHCdNdNdN() {
        double temp = -6 * Math.pow((getmSAFT() * (8.0 - 4.0 * getNSAFT()) / Math.pow((1.0 - getNSAFT()), 4) + 4 * getmSAFT()
                * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2) / Math.pow((1.0 - getNSAFT()), 5) + (1.0 - getmSAFT()) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2))
                + (2 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 2)) + (2 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 3)))), 3) / Math.pow((1.0 + getmSAFT() * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2)) / Math.pow((1.0 - getNSAFT()), 4) + (1.0 - getmSAFT()) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4))
                / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2))), 4)
                + (6 * (getmSAFT() * (8.0 - 4.0 * getNSAFT()) / Math.pow((1.0 - getNSAFT()), 4) + 4 * getmSAFT() * (8.0 * getNSAFT() - Math.pow(2.0 * getNSAFT(), 2)) / Math.pow((1.0 - getNSAFT()), 5) + (1.0 - getmSAFT()) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2))
                + (2 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 2)) + (2 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 3)))) * (-4.0 * getmSAFT() / Math.pow((1.0 - getNSAFT()), 4) + 8 * getmSAFT() * (8.0 - 4.0 * getNSAFT()) / Math.pow((1.0 - getNSAFT()), 5)
                + 20 * getmSAFT() * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2)) / Math.pow((1.0 - getNSAFT()), 6) + (1.0 - getmSAFT()) * (-54 + 72 * getNSAFT() - 24 * Math.pow(getNSAFT(), 2)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2)) + (4 * (1.0 - getmSAFT())) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 2)) + (4 * (1.0 - getmSAFT())) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3))
                / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 3)) + (6 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 4) * Math.pow((2.0 - getNSAFT()), 2)) + (8 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 3)) + (6 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 4))) / Math.pow(1.0 + getmSAFT() * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2)) / Math.pow((1.0 - getNSAFT()), 4) + ((1.0 - getmSAFT()) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2))), 3)
                - (-48.0 * getmSAFT() / Math.pow((1.0 - getNSAFT()), 5) + 60 * getmSAFT() * (8.0 - 4.0 * getNSAFT()) / Math.pow((1.0 - getNSAFT()), 6) + 120 * getmSAFT() * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2))
                / Math.pow((1.0 - getNSAFT()), 7) + (1.0 - getmSAFT()) * (72 - 48 * getNSAFT()) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2)) + (6 * (1.0 - getmSAFT())) * (-54 + 72 * getNSAFT() - 24 * Math.pow(getNSAFT(), 2)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 2)) + (6 * (1.0 - getmSAFT())) * (-54 + 72 * getNSAFT() - 24 * Math.pow(getNSAFT(), 2)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 3)) + (18 * (1.0 - getmSAFT())) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3))
                / (Math.pow((1.0 - getNSAFT()), 4) * Math.pow((2.0 - getNSAFT()), 2)) + (24 * (1.0 - getmSAFT())) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 3)) + (18 * (1.0 - getmSAFT())) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) - 8 * Math.pow(getNSAFT(), 3)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 4)) + (24 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 5) * Math.pow((2.0 - getNSAFT()), 2)) + (36 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 4) * Math.pow((2.0 - getNSAFT()), 3)) + (36 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 3) * Math.pow((2.0 - getNSAFT()), 4)) + (24 * (1.0 - getmSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0
                - getNSAFT()), 5))) / Math.pow((1.0 + getmSAFT() * (8.0 * getNSAFT() - 2.0 * Math.pow(getNSAFT(), 2)) / Math.pow((1.0 - getNSAFT()), 4) + (1.0 - getmSAFT()) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4)) / (Math.pow((1.0 - getNSAFT()), 2) * Math.pow((2.0 - getNSAFT()), 2))), 2);
    ...
    public double calcdF2dispZHCdT() {
        double temp0 = -Math.pow(F2dispZHC, 2.0);
        double temp1 = getmSAFT() * ((8 - 4 * getNSAFT()) * dNSAFTdT * Math.pow(1 - getNSAFT(), 4) + 4 * Math.pow(1 - getNSAFT(), 3) * dNSAFTdT * (8 * getNSAFT() - 2 * Math.pow(getNSAFT(), 2))) / Math.pow(1 - getNSAFT(), 8);
        double temp2a = (1 - getmSAFT()) * (20 - 54 * getNSAFT() + 36 * Math.pow(getNSAFT(), 2) + 8 * Math.pow(getNSAFT(), 3)) * dNSAFTdT * Math.pow((1 - getNSAFT()) * (2 - getNSAFT()), 2);
        double temp2b = (1 - getmSAFT()) * 2 * ((1 - getNSAFT()) * (2 - getNSAFT())) * (-1 * dNSAFTdT * (2 - getNSAFT()) + (-1) * dNSAFTdT * (1 - getNSAFT())) * (20 * getNSAFT() - 27 * Math.pow(getNSAFT(), 2) + 12 * Math.pow(getNSAFT(), 3) - 2 * Math.pow(getNSAFT(), 4));
        ...
        for (int i = 0; i < numberOfComponents; i++) {
            for (int j = 0; j < numberOfComponents; j++) {
                temp1 += getComponent(i).getNumberOfMolesInPhase() * getComponent(j).getNumberOfMolesInPhase()
                        * getComponent(i).getmSAFTi() * getComponent(j).getmSAFTi()
                        * Math.sqrt(getComponent(i).getEpsikSAFT() / temperature * getComponent(j).getEpsikSAFT() / temperature) * (1.0 - mixRule.getBinaryInteractionParameter(i, j))
                        * Math.pow(0.5 * (getComponent(i).getSigmaSAFTi() + getComponent(j).getSigmaSAFTi()), 3.0) * (-1 / temperature);
            }
        }
        return temp1 / Math.pow(getNumberOfMolesInPhase(), 2.0);
    }
    ...
    public double calcdF2dispSumTermdT() {
        ...
        for (int i = 0; i < numberOfComponents; i++) {
            for (int j = 0; j < numberOfComponents; j++) {
                temp1 += getComponent(i).getNumberOfMolesInPhase() * getComponent(j).getNumberOfMolesInPhase()
                        * getComponent(i).getmSAFTi() * getComponent(j).getmSAFTi()
                        * (getComponent(i).getEpsikSAFT() / temperature * getComponent(j).getEpsikSAFT() / temperature) * Math.pow(1.0 - mixRule.getBinaryInteractionParameter(i, j), 2)
                        * Math.pow(0.5 * (getComponent(i).getSigmaSAFTi() + getComponent(j).getSigmaSAFTi()), 3.0) * (-2 / temperature);
            }
        }
        return temp1 / Math.pow(getNumberOfMolesInPhase(), 2.0);
    }
    ...
    public double calcdSAFT() {
        double temp1 = 0.0;
        for (int i = 0; i < numberOfComponents; i++) {
            temp1 += getComponent(i).getNumberOfMolesInPhase() * getComponent(i).getmSAFTi() * Math.pow(((ComponentPCSAFT) getComponent(i)).getdSAFTi(), 3.0);
    ...
    public double dF_DISP1_SAFTdVdVdV() {
        return getNumberOfMolesInPhase() * ((-2.0 * ThermodynamicConstantsInterface.pi * F1dispVolTermdVdVdV * getF1dispSumTerm() * getF1dispI1())
    ...
    public double dF_DISP1_SAFTdT() {
        return getNumberOfMolesInPhase() * (-2.0 * ThermodynamicConstantsInterface.pi * (dF1dispVolTermdT * getF1dispSumTerm() * getF1dispI1() + dF1dispSumTermdT * getF1dispVolTerm() * getF1dispI1() + dF1dispI1dT * getF1dispVolTerm() * getF1dispSumTerm()));
    }

    public double dF_DISP2_SAFTdT() {
        return getNumberOfMolesInPhase() * (-1 * ThermodynamicConstantsInterface.pi * getmSAFT()) * getF1dispVolTerm() * (dF2dispSumTermdT * getF2dispI2() * getF2dispZHC() + dF2dispI2dT * getF2dispSumTerm() * getF2dispZHC() + dF2dispZHCdT * getF2dispSumTerm() * getF2dispI2());
    }
...
//        System.out.println("F-DISP2 " + useDISP2*F_DISP2_SAFT());
    ...
    public double getdDSAFTdT() {
        double temp = 0.0;
        for (int i = 0; i < numberOfComponents; i++) {
            temp += getComponent(i).getNumberOfMolesInPhase() * getComponent(i).getmSAFTi() / getNumberOfMolesInPhase() * 3 * Math.pow(((ComponentPCSAFT) getComponent(i)).getdSAFTi(), 2.0) * (-1.08 / Math.pow(temperature, 2))
                    * Math.pow(getComponent(i).getSigmaSAFTi(), 3) * Math.pow(1 - 0.12 * Math.exp(-3 * getComponent(i).getEpsikSAFT() / temperature), 2) * getComponent(i).getEpsikSAFT()
    ...
    public double molarVolume(double pressure, double temperature, double A, double B, int phase) throws neqsim.util.exception.IsNaNException, neqsim.util.exception.TooManyIterationsException {
        ...
        double BonVold = BonV;
        double Btemp = 0, Dtemp = 0, h = 0, hOld = 0, dh = 0, dhOld = 0, gvvv = 0, fvvv = 0, dhh = 1;
        double d1 = 0, d2 = 0;
        Btemp = getB();
        Dtemp = getA();
        if (Btemp <= 0) {
        ...
        do {
            ...
            BonVold = BonV;
            //BonV = BonVold;
            h = BonVold - Btemp/numberOfMolesInPhase*dFdV()-pressure*Btemp/(numberOfMolesInPhase*R*temperature);
            dh = 1.0 + Btemp/Math.pow(BonVold,2.0)*(Btemp/numberOfMolesInPhase*dFdVdV());
