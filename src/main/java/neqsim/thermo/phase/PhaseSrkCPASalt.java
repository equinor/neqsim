 ...
 * @version $Id: $Id
 */
public class PhaseSrkCPASalt extends PhaseSrkCPA {
   ...
   * </p>
   */
  public PhaseSrkCPASalt() {
    super();
  }

  /** {@inheritDoc} */
  @Override
  public PhaseSrkCPASalt clone() {
    PhaseSrkCPASalt clonedPhase = null;
    try {
      clonedPhase = (PhaseSrkCPASalt) super.clone();
    } catch (Exception ex) {
