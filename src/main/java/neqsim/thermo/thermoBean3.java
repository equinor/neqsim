 ...
 * thermoBean.java
 *
 * Created on 20. januar 2001, 20:01
 */
 ...
 * @version
 */
public class thermoBean3 extends Object implements java.io.Serializable {

    private static final long serialVersionUID = 1000;
    private static final String PROP_SAMPLE_PROPERTY = "SampleProperty";
    static Logger logger = Logger.getLogger(thermoBean3.class);
...
//    static{
//        System.setProperty("NeqSim.home", "java.home");
...
//    }
    ...
    public synchronized void setModel(String name) {
        ...
        } else if (name.equals("GERG-water")) {
            thermoSystem = new SystemGERGwaterEos(temperature, pressure);
    ...
    public synchronized double getywat() {
        return thermoSystem.getProperty("molefraction", "water", 0);
    }

    public synchronized double property(String prop, String compName, int phase) {
        return thermoSystem.getProperty(prop, compName, phase);
    }

    public synchronized double property(String prop, int phase) {
        return thermoSystem.getProperty(prop, phase);
    }

    public synchronized double property(String prop) {
    ...
    public static void main(String[] args) {
        thermoBean3 tempVar = new thermoBean3();
        tempVar.addComponent("methane", 1.0);
        tempVar.addComponent("water", 1.0);
