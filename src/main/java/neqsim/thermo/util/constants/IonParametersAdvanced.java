 ...
 *
 * <p>
 * This class provides ion-specific interaction parameters fitted to experimental mean ionic activity coefficient and
 * osmotic coefficient data. Unlike the original e-CPA model which uses universal linear correlations for all ions, this
 * model has individual parameters per ion-solvent pair, enabling higher accuracy especially for multivalent ions and
 * sulfate systems.
 * </p>
 *
...
public final class IonParametersAdvanced implements Serializable {
  ...
  private static final Map<String, AdvancedIonData> ION_DATA = new HashMap<String, AdvancedIonData>();
  ...
  static {
    ...
    ION_DATA.put("NH4+", new AdvancedIonData(2.96, -5.00e-06, -4.80e-08, 0.0, 2.20, 3.3e-04, 1, -307.0));
    ...
    ION_DATA.put("NO3-", new AdvancedIonData(3.40, -1.40e-05, 3.00e-08, 0.0, 2.40, 2.7e-04, -1, -306.0));

    // HCO3- : Moderate. dGhyd = -373 kJ/mol
    ION_DATA.put("HCO3-", new AdvancedIonData(3.50, -1.90e-05, 4.00e-08, 0.0, 2.35, 2.9e-04, -1, -373.0));

    // HS- : Bisulfide. dGhyd = -330 kJ/mol
    ION_DATA.put("HS-", new AdvancedIonData(3.40, -1.80e-05, 3.50e-08, 0.0, 2.40, 2.6e-04, -1, -330.0));
    ...
    ION_DATA.put("Zn++", new AdvancedIonData(2.20, -8.80e-05, -2.90e-07, 0.0, 1.40, 6.2e-04, 2, -2046.0));
    ...
    ION_DATA.put("S--", new AdvancedIonData(3.50, -6.50e-05, 9.50e-08, 0.0, 2.40, 3.7e-04, -2, -1380.0));

    // --- Trivalent ions ---
    ION_DATA.put("Fe+++", new AdvancedIonData(2.00, -1.20e-04, -3.50e-07, 0.0, 1.25, 7.0e-04, 3, -4430.0));
    ION_DATA.put("Al+++", new AdvancedIonData(1.80, -1.40e-04, -3.80e-07, 0.0, 1.18, 7.5e-04, 3, -4665.0));
  ...
  /**
   * Set the W0 (base ion-water interaction energy) for a given ion. Used during parameter fitting to update W0 without
