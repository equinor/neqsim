...
public class BubbleFlashCPA {
 ...
 testSystem.addComponent("TEG", 100.0);
        /*testSystem.addComponent("methane", 69.243);
         ...
         testSystem.addComponent("CO2", 4.113);
         testSystem.addComponent("ethane", 8.732);
         testSystem.addComponent("propane", 4.27);
...
//
        ...
        testSystem.display();
        testSystem.clone();
        System.out.println("activity " + testSystem.getPhase(1).getActivityCoefficient(0));
