...
public class DewPointCurve {
    ...
    public static void main(String args[]) {
       ...
       // SystemInterface testSystem = new SystemSrkEos(195.9488, 47.0);
         ...
         * testSystem.addComponent("benzene", 61.03);
         * testSystem.addComponent("toluene", 24.63);
         * testSystem.addComponent("c-hexane", 45.23);
         * testSystem.addComponent("n-heptane", 93.83);
         * testSystem.addComponent("n-octane", 12.17);
         * testSystem.addComponent("n-nonane", 0.03);
...
/*
         * System.out.println("temp " + (testSystem.getTemperature() - 273.15));
         * for (int i = 0; i < testSystem.getPhase(0).getNumberOfComponents();
         * i++) { System.out.println("unsymetric activity coeff " +
         * testSystem.getPhase(1).getComponent(i).getName() + " " +
         * testSystem.getPhase(1).getActivityCoefficientUnSymetric(i)); } for
