...
//        testSystem2.addComponent("methane", testSystem.getPhase(0).getComponent("methane").getx());
//        testSystem2.addComponent("ethane", testSystem.getPhase(0).getComponent("ethane").getx());
//        testSystem2.addComponent("propane", testSystem.getPhase(0).getComponent("propane").getx());
//        testSystem2.addComponent("nitrogen", testSystem.getPhase(0).getComponent("nitrogen").getx());
//        testSystem2.addComponent("i-butane", testSystem.getPhase(0).getComponent("i-butane").getx());
//        testSystem2.addComponent("n-butane", testSystem.getPhase(0).getComponent("n-butane").getx());
//        testSystem2.addComponent("iC5", testSystem.getPhase(0).getComponent("iC5").getx());
//        testSystem2.addComponent("n-pentane", testSystem.getPhase(0).getComponent("n-pentane").getx());
////
...
//        testSystem2.addTBPfraction("C13",testSystem.getPhase(0).getComponent("C13_DefaultName").getx(),184.0/1000.0,0.883);
        ...
        //       testSystem2.addComponent("water", testSystem.getPhase(0).getComponent("water").getx());
        //  testSystem2.addComponent("MEG", testSystem.getPhase(0).getComponent("MEG").getx());
//
...
//        testSystem2.setHydrateCheck(true);
         ...
         * testOps2.hydrateFormationTemperature(2);
         * //testOps2.dewPointTemperatureFlash();
         * //testOps.freezingPointTemperatureFlash();
         * //testOps.bubblePointPressureFlash(false);
         * //testOps.hydrateFormationPressure();
         * //testOps2.hydrateFormationTemperature(2); // testOps.TPflash(); //
         * testSystem.display(); } catch(Exception e){ e.printStackTrace();
         * System.out.println(e.toString()); } /* //testSystem2.display(); int
         * phase = 0; double x1 =
         * testSystem2.getPhase(0).getMolarVolume()*testSystem2.getBeta(0);
         * double x2 =
         * testSystem2.getPhase(1).getMolarVolume()*testSystem2.getBeta(1);
         *
         * double x3 = x1/(x1+x2); double x4 = x2/(x1+x2);
         * System.out.println("vol gas % " + x3*100); System.out.println("vol
         * liq % " + x4*100); int n = testSystem.getNumberOfPhases()-1; double
         * megwtfracInit =
         ...
         * testSystem2.getPhase(n).getComponent("MEG").getMolarMass()*testSystem2.getPhase(n).getComponent("MEG").getx()/testSystem2.getPhase(n).getMolarMass();
