...
public class HydrateFlash2 {
        ...
        public static void main(String args[]) {
                ...
                // testSystem2.addComponent("iC5",
                // testSystem.getPhase(0).getComponent("iC5").getx());
                 ...
                 * System.out.println(e.toString()); } /* //testSystem2.display(); int phase = 0;
                 * double x1 = testSystem2.getPhase(0).getMolarVolume()*testSystem2.getBeta(0);
                 ...
                 * x3*100); System.out.println("vol liq % " + x4*100); int n =
                 * testSystem.getNumberOfPhases()-1; double megwtfracInit =
