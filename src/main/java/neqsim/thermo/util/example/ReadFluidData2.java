...
public class ReadFluidData2 {
    ...
    public static void main(String args[]) {
        ...
        /*
         * testSystem.init(0); testSystem.setPressure(100.0); testSystem.setTemperature(273.15 +
         * 15.0); // // ""); // testSystem.addComponent("water", 1.0); testSystem.setMixingRule(2);
         ...
         * testOps.PSflash(-1.266377583884310e+02); } catch (Exception e) {
