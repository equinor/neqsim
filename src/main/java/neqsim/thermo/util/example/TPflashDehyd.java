    ...
    public static void main(String[] args) {
     ...
     //   testSystem2.addComponent("MEG", 30.0e-16, "kg/sec");
       ...
       // testSystem.addComponent("methane", 1.0e-10, "kg/sec");
        ...
        // testModel.runTest();
        // testSystem.display();
        // System.out.println("water activity " + testSystem.getPhase(1).getActivityCoefficient(2));
        // testSystem.init(0);
        ...
        /*
         ...
         System.out.println("gas density " + (1.0 / (testSystem.getPhase(0).getDensity() / testSystem.getPhase(0).getMolarMass())));

         System.out.println("liq density " + (testSystem.getPhase(1).getDensity()));
         System.out.println("liq density " + (1.0 / (testSystem.getPhase(1).getDensity() / testSystem.getPhase(1).getMolarMass())));
         ...
         testSystem.setMolarComposition(new double[]{1.0, 1e-20, 1e-20});
         testSystem.init(0, 0);
         testSystem.init(1);
         testSystem.display();

         System.out.println("end.....");
         testSystem.setMolarComposition(new double[]{0.000001, 0.00001, 1e-20});
         //   testSystem.init(1);
         testSystem.init(0, 0);
         testSystem.init(1);
         //    testSystem.display();
         ...
         /*
         testSystem.initPhysicalProperties();
         double rho1 = testSystem.getPhase(0).getPhysicalProperties().getDensity();
         ...
         testSystem.setPressure(testSystem.getPressure() + 0.001);
         testSystem.init(1);
         //        testSystem.display();
         //   testSystem.initPhysicalProperties();
         double rho2 = testSystem.getPhase(0).getPhysicalProperties().getDensity();

         //System.out.println("drhodPnum " + (rho2 - rho1) / 0.01);
         System.out.println("drhodTnum " + (rho2 - rho1) / 0.001);

         testSystem.saveFluid(2327);
         testSystem.saveFluid(2301);
         //      testSystem.setNumberOfPhases(1);
         // testSystem.setTemperature(299.0);
         //  testSystem.init(1);
         // testSystem.getPhase(0).getEntropy();
         // System.out.println("enthalpy " + testSystem.getPhase(0).getEntropy());
         //testSystem.setTemperature(299.0);
         testSystem.init(1);
         System.out.println("water activity " + testSystem.getPhase(1).getActivityCoefficient(1));
         //  testSystem.getPhase(0).getEntropydP();
         System.out.println("Cp " + testSystem.getPhase(0).getCp());
         System.out.println("enthalpy " + testSystem.getPhase(0).getEnthalpy());
         System.out.println("entropy " + testSystem.getPhase(0).getEntropy());
         ...
         /*
         double h1 = testSystem.getPhase(0).getEntropy();
         System.out.println("H " + testSystem.getPhase(0).getEntropy());
         System.out.println("H dP " + testSystem.getPhase(0).getEntropydT());
         testSystem.setTemperature(testSystem.getTemperature() + 1);
         testSystem.init(3);
         double h2 = testSystem.getPhase(0).getEntropy();
         System.out.println("H " + testSystem.getPhase(0).getEntropy());
         System.out.println("H dP " + testSystem.getPhase(0).getEntropydT());
         */
        //       System.out.println("dhdp " + (h2 - h1));
        /*
         double seletivity = testSystem.getPhase(1).getComponent("CO2").getx() / testSystem.getPhase(0).getComponent("CO2").getx()
         / (testSystem.getPhase(1).getComponent("methane").getx() / testSystem.getPhase(0).getComponent("methane").getx());
         System.out.println("selectivity CO2/methane " + seletivity);

         double seletivity2 = testSystem.getPhase(1).getComponent("CO2").getx() / testSystem.getPhase(0).getComponent("CO2").getx()
         / (testSystem.getPhase(1).getComponent("ethane").getx() / testSystem.getPhase(0).getComponent("ethane").getx());
         System.out.println("selectivity CO2/ethane " + seletivity2);
         * */
        //  testSystem.saveObject(2201);
        // System.out.println("activity coef MDEA " + testSystem.getPhase(1).getActivityCoefficient(1));
        /*
         testSystem.saveObject(928);
         testSystem.display();
         System.out.println("wt " + testSystem.getPhase(2).getWtFraction(testSystem) + testSystem.getPhase(1).getWtFraction(testSystem) + testSystem.getPhase(0).getWtFraction(testSystem));
         ...
         double solubility = testSystem.getPhase(1).getComponent("CO2").getx() * 8.314 * 298.15 / 101325.0 / (testSystem.getPhase(1).getMolarMass()) * 1000;
        
         System.out.println("selectivity " + seletivity);
         System.out.println("CO2 solubility " + solubility);
         System.out.println("Z " + testSystem.getPhase(0).getZ());
         // testSystem.getPhase(0).getComponentWithIndex(1);
         //     testSystem.saveObject(300);
         //  System.out.println("ethanol activity " + testSystem.getPhase(0).getActivityCoefficient(0));

         //testSystem.
         // System.out.println("water activity " + testSystem.getPhase(1).getActivityCoefficient(1));
         // System.out.println("TEG activity " + testSystem.getPhase(1).getActivityCoefficient(0));
         //  testSystem.display();
         //System.out.println("fugacitycoefficient " + testSystem.getPhase(1).getComponent("water").getLogFugasityCoeffisient());
         /*
         ...
         * + testSystem.getPhase(0).getSresTP() /
         * thermo.ThermodynamicConstantsInterface.R); System.out.println("Cpres
         * " + testSystem.getPhase(0).getCpres() /
         * thermo.ThermodynamicConstantsInterface.R); System.out.println("Gibbs
         * gas " + testSystem.getPhase(0).getGibbsEnergy());
         * System.out.println("Gibbs liquid " +
