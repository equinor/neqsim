...
public class TPflashGR {
    ...
    public void testrun() {
        ...
        String[] components = new String[] { "water", "nitrogen", "CO2", "methane", "ethane", "propane", "i-butane",
                "n-butane", "i-pentane", "n-pentane", "C6", "C7", "C8", "C9", "C10" };// ,"CHCmp_6","CHCmp_7","CHCmp_8"};//,"CHCmp_9","CHCmp_10","CHCmp_11","CHCmp_12","CHCmp_13"};
        ...
        double[] molarmass = new double[] { 18.0153, 28.0135, 44.0098, 16.0429, 30.0698, 44.0968, 58.1239, 58.1239,
                72.1510, 72.1510, 86.1776 / 1000.0, 90.1140 / 1000.0, 102.0386 / 1000.0, 117.4548 / 1000.0,
                205.5306 / 1000.0 };
        double[] density = new double[] { 1.0, -1.0000e+19, -1.0000e+19, -1.0000e+19, -1.0000e+19, -1.0000e+19,
                -1.0000e+19, -1.0000e+19, -1.0000e+19, -1.0000e+19, 667.4991 / 1000.0, 746.5672 / 1000.0,
                787.1960 / 1000.0, 776.5150 / 1000.0, 849.9863 / 1000.0, };
         ...
         * thermoOps.PHflash(enthalpy[i]); errH[i] = fluid1.getTemperature() - T_C[i] -
         * 273.15; System.out.println("err " + errH[i]); //assertTrue(Math.abs(errH[i])
         * < 1e-2); }
         */
    }
