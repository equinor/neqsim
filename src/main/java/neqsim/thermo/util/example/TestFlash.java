...
public class TestFlash {
        ...
        public static void main(String[] args) {
                ...
                double[] spec2 = {288.15, 290.1, 295.1, 301.2, 299.3, 310.2, 315.3, 310.0, 305.2,
                                312.7}; // Temperatures
                // double[]
                ...
                double[] fractions = {0.01, 0.02, 0.03, 0.01, 0.80, 0.04, 0.03, 0.02, 0.01, 0.01,
                ...
                logger.info("Time taken for 10 flash calcs [ms] = "
                                + (System.currentTimeMillis() - time));

                int t = 0;
                int k = 0;
                logger.info("Mix Number of Phases                            "
                                + fluidProperties[t][k++]);
                ...
                double interfacialtensiongasoil = Double.NaN,
                                interfacialtensiongasaqueous = Double.NaN,
                ...
                if (fluid.hasPhaseType("gas") && fluid.hasPhaseType("aqueous")) {
                        interfacialtensiongasaqueous =
                                        fluid.getInterfacialTension("gas", "aqueous");
                }

                if (fluid.hasPhaseType("oil") && fluid.hasPhaseType("aqueous")) {
                        interfacialtensionoilaqueous =
                                        fluid.getInterfacialTension("oil", "aqueous");
                }

                logger.info("Interfacial Tension Gas-Oil      [N/m]      "
                                + interfacialtensiongasoil);
                logger.info("Interfacial Tension Gas-Aqueous      [N/m]      "
                                + interfacialtensiongasaqueous);
                logger.info("Interfacial Tension Oil-Aqueous      [N/m]      "
                                + interfacialtensionoilaqueous);
