        ...
        public static void main(String args[]) {
                ...
                for (int i = 0; i < 2000; i++) {
                        try {
                                ...
                                testOps.bubblePointPressureFlash(false);
                                testSystem2.addComponent("TEG",
                                                testSystem.getPhase(0).getComponent(0).getx()
                                                                / 2.0e3);
                                testSystem2.addComponent("MDEA",
                                                testSystem.getPhase(0).getComponent(1).getx()
                                                                / 2.0e3);
                                testSystem2.addComponent("Piperazine",
                                                testSystem.getPhase(0).getComponent(2).getx()
                                                                / 2.0e3);
                                testSystem2.addComponent("water",
                                                testSystem.getPhase(0).getComponent(3).getx()
                                                                / 2.0e3);
                                testSystem.addComponent("TEG",
                                                -testSystem.getPhase(0).getComponent(0).getx()
                                                                / 2.0e3);
                                testSystem.addComponent("MDEA",
                                                -testSystem.getPhase(0).getComponent(1).getx()
                                                                / 2.0e3);
                                ...
                                logger.info("MDEA act "
                                                + testSystem.getPhase(1).getActivityCoefficient(1));
                                logger.info("Piperazine act "
                                                + testSystem.getPhase(1).getActivityCoefficient(2));
                                logger.info("water act "
                                                + testSystem.getPhase(1).getActivityCoefficient(3));
                                double percentBack = (testSystem2.getPhase(0).getComponent(1)
                                                .getNumberOfmoles()) / 0.1 * 100.0;
                                double percentBackPip = (testSystem2.getPhase(0).getComponent(2)
                                                .getNumberOfmoles()) / 0.015 * 100.0;
                                double percentBackWater = (testSystem2.getPhase(0).getComponent(3)
                                                .getNumberOfmoles()) / 0.765 * 100.0;
