...
public class TestVHflash {
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        logger.info("Volume Nitrogen " + testSystem.getPhase(0).getMolarMass()
                                        * testSystem.getNumberOfMoles() / testSystem.getPhase(0)
                                                        .getPhysicalProperties().getDensity());
                        logger.info("Volume Liquid Methane "
                                        + testSystem2.getPhase(0).getMolarMass()
                                                        * testSystem2.getNumberOfMoles()
                                                        / testSystem2.getPhase(0)
                                                                        .getPhysicalProperties()
                                                                        .getDensity());
                        logger.info("Volume Nitrogen from vacum breaker system "
                                        + testSystem4.getPhase(0).getMolarMass()
                                                        * testSystem4.getNumberOfMoles()
                                                        / testSystem4.getPhase(0)
                                                                        .getPhysicalProperties()
                                                                        .getDensity());
                        ...
                        // testSystem3.getTotalNumberOfMoles() );
                } catch (Exception e) {
