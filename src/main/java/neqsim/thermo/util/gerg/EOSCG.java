 ...
 *
 * <p>
 * This class no longer delegates to the GERG-2008 implementation; every public entry point is routed to a dedicated
 * EOS-CG correlation backend that must be populated with the specific functional form and parameters from the EOS-CG
 * publication.
 * </p>
 */
public class EOSCG {
