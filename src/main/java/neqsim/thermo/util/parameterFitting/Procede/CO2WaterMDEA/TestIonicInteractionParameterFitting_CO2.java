...
public class TestIonicInteractionParameterFitting_CO2 extends java.lang.Object{
    ...
    public static void main(String[] args){
        ...
        //double guess[] = {0.0004463876, -0.0001475081, 0.0021294606, 0.0002761438, -0.0003450177}; //Detailed reactions, no data for 75 wt% MDEA or temp > 400K, more iterations
        double guess[] = {-0.0001660156, -0.0006035675, -0.0000068587, -0.0002164970};//,0.0005}; //Detailed reactions, no data for 75 wt% MDEA or temp > 400K or loading < 0.1 and bias = -4% and AAD = 18% for loading >0.1
        //double guess[] = {0.0004164151, 0.0002034767, 0.0018993447, 0.0022461592, -0.0008412103}; //Detailed reactions, no data for 75 wt% MDEA or temp > 400K or loading > 0.1   bias of -7% and AAD= 27% for loading<0.1
        //double guess[] = {1e-10}; //Assuming values for all other species, except OH-. Regression done only for data loading<0.1. {0.0004463876, -0.0001475081, 0.0021294606, 0.0002761438, -0.0003450177}
        //double guess[] = {0.0004480870, -0.0001871372, 0.0021482035, 0.0002770425, -0.0003886375}; //Detailed reactions, no data for 75 wt% MDEA or temp > 400K, more iterations diff. Water - MDEA HV parameter
       ...
       dataSet =  database.getResultSet(  "SELECT * FROM CO2WaterMDEA WHERE ID>230");
        ...
        try{
            ...
            while(dataSet.next()){
                ...
                IonicInteractionParameterFittingFunction_CO2 function = new IonicInteractionParameterFittingFunction_CO2(1,1);
                function.setInitialGuess(guess);
