...
public class EosInteractionParameterFittingFunction extends LevenbergMarquardtFunction {
    ...
    public double calcValue(double[] dependentValues){
        ...
        system.getPhases()[1].getComponents()[0].setK(Math.exp(Math.log(system.getPhases()[1].getComponents()[0].getFugasityCoeffisient()) - Math.log(system.getPhases()[0].getComponents()[0].getFugasityCoeffisient())));
