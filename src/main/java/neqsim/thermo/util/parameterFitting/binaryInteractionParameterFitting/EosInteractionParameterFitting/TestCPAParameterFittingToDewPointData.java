...
public class TestCPAParameterFittingToDewPointData extends java.lang.Object {
    ...
    public static void main(String[] args){
        ...
        ResultSet dataSet =  database.getResultSet("NeqSimDataBase",  "SELECT * FROM waterdewpointpaper WHERE gascomponent='nitrogen' AND reference='Gil'");
        ...
        try{
            ...
            while(dataSet.next() && p<500){
                ...
                //SystemInterface testSystem = new SystemSrkCPAstatoil(Double.parseDouble(dataSet.getString("temperature")), Double.parseDouble(dataSet.getString("Pressure"))*10.0);
                SystemInterface testSystem = new SystemGERGwaterEos(Double.parseDouble(dataSet.getString("temperature")), Double.parseDouble(dataSet.getString("Pressure"))*10.0);
