...
public class TestCPAParameterFittingToSolubilityGlycolHC extends java.lang.Object {
    ...
    public static void main(String[] args){
        ...
        ResultSet dataSet =  database.getResultSet("NeqSimDataBase",  "SELECT * FROM HCGlycolLLdata WHERE comp1='n-heptane' AND comp2='MEG' AND reference='Lindboe2002' ORDER BY Temperature,Pressure");// AND Reference='Houghton1957' AND Reference<>'Nighswander1989' AND Temperature>278.15 AND Temperature<383.15 AND Pressure<60.01325");
        ...
        try{
            ...
            while(!dataSet.next() && p<50){
                ...
                //SystemInterface testSystem = new SystemSrkCPAs(Double.parseDouble(dataSet.getString("temperature"))+273.15, Double.parseDouble(dataSet.getString("pressure")));
                SystemInterface testSystem = new SystemSrkEos(Double.parseDouble(dataSet.getString("temperature"))+273.15, Double.parseDouble(dataSet.getString("pressure")));
        ...
        dataSet =  database.getResultSet("NeqSimDataBase",  "SELECT * FROM HCGlycolLLdata WHERE comp1='n-heptane' AND comp2='MEG' AND reference='Lindboe2002' ORDER BY Temperature,Pressure");
