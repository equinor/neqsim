...
//        double parameterGuess[] ={2012.8210952954, -1074.4698351045, 5.5675858688, -1.0503110172, -0.0082939895};//, 1.3505557460};//, 0.1169806819}; /SRK-EOS
 //       double parameterGuess[] ={1506.3, -863.3, 4.11, -0.603, -0.0145};//, 1.3505557460};//, 0.1169806819}; /PR-EOS
   double parameterGuess[] ={ -359.2, 351.7, -1.31, 2.44, 0.25}; // PVTsim SRK
 //       double parameterGuess[] ={ -446.3717107738, 523.8799876586, -1.2101168104, 1.1754366244, 0.1726026869}; // fitted MeOH
