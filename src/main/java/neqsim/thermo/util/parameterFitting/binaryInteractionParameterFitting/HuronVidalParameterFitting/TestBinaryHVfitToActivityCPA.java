        ...
        public static void main(String[] args) {
                ...
                for (int i = 0; i < 1; i++) {
                        ...
                        for (int j = 0; j < 10; j++) {
                                ...
                                SystemInterface testSystem =
                                                new SystemSrkEos(268.15 + 10.0 * i, 1.0);
                                ...
                                SystemInterface testSystem2 =
                                                new SystemSrkCPAs(268.15 + 10.0 * i, 1.0);
                                ...
                                logger.info("activity " + activ + " molfraction MEG " + testSystem2
                                                .getPhase(1).getComponent("methanol").getx());

                                function.setInitialGuess(parameterGuess);
                                double sample1[] = {
                                                testSystem2.getPhase(1).getComponent("methanol")
                                                                .getx(),
                                                testSystem.getTemperature()};
                                double standardDeviation1[] = {1.0};
                                SampleValue sample = new SampleValue(activ, activ / 100.0, sample1,
                                                standardDeviation1);
                ...
                for (int i = 0; i < 0; i++) {
                        ...
                        for (int j = 0; j < 10; j++) {
                                ...
                                SystemInterface testSystem2 =
                                                new SystemSrkCPAs(300.0 + 20.0 * i, 1.0);
                                testSystem2.addComponent("water", 100.0 - j * j);
                                // testSystem2.addComponent("MEG",1.0+j*j);
                                testSystem.addComponent("methanolPVTsim", 1.0 + j * j);
                                ...
                                double activ = testSystem2.getPhase(1).getActivityCoefficient(0);
                                logger.info("activity " + activ + " molfraction MEG " + testSystem2
                                                .getPhase(1).getComponent("MEG").getx());
                ...
                for (int i = 0; i < 0; i++) {
                        ...
                        for (int j = 0; j < 0; j++) {
                                ...
                                SystemInterface testSystem2 =
                                                new SystemSrkCPAs(253.0 + 20.0 * i, 1.0);
