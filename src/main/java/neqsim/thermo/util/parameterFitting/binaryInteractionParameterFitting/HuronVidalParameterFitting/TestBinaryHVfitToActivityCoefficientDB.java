        ...
        public static void main(String[] args) {
                ...
                try {
                        while (dataSet.next()) {
                                ...
                                SampleValue sample = new SampleValue(val, val / 100.0, sample1,
                                                standardDeviation1);
                                ...
                                double guess[] = {-1460.6790723030, 1200.6447170870, 5.8929954883,
                                                -7.2400706727, 0.2131035181};
                ...
                try {
                        while (!dataSet.next()) {
                                ...
                                SystemInterface testSystem =
                                                new SystemSrkSchwartzentruberEos(280, 1.101);
                                ...
                                double val = Double.parseDouble(
                                                dataSet.getString("FreezingTemperature"));
                                testSystem.setTemperature(val);
                                SampleValue sample = new SampleValue(val, val / 700, sample1,
                                                standardDeviation1);
                                sample.setFunction(function);
