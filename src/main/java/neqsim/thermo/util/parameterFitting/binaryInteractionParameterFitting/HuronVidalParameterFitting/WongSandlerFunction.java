...
abstract class WongSandlerFunction extends LevenbergMarquardtFunction {
    ...
    public void setDatabaseParameters(){
        ...
        params[4] = ((HVmixingRuleInterface) ((PhaseEosInterface)system.getPhases()[0]).getMixingRule()).getKijWongSandler(1,0);
    }
    ...
    public void setFittingParams(int i, double value){
        ...
        if(i==5){
            ((HVmixingRuleInterface) ((PhaseEosInterface)system.getPhases()[0]).getMixingRule()).setKijWongSandler(1,0, value);
            ((HVmixingRuleInterface) ((PhaseEosInterface)system.getPhases()[1]).getMixingRule()).setKijWongSandler(1,0, value);
        }
