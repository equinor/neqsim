        ...
        public void setFittingParams(int i, double value) {
                ...
                if (i == 4) {
                        ((PhaseEosInterface) system.getPhases()[0]).getMixingRule()
                                        .setBinaryInteractionParameter(CO2Numb, MDEANumb,
                                                        value * 1e3);
                ...
                if (i == 20) {
                        system.getPhase(0).getComponent(MDEAplusNumb)
                                        .setStokesCationicDiameter(value);
                        ((PhaseModifiedFurstElectrolyteEos) system.getPhases()[0])
                                        .reInitFurstParam();
                        system.getPhase(1).getComponent(MDEAplusNumb)
                                        .setStokesCationicDiameter(value);
                        ((PhaseModifiedFurstElectrolyteEos) system.getPhases()[1])
                                        .reInitFurstParam();
                }
                if (i == 40) {
                        system.getChemicalReactionOperations().getReactionList().getReaction(0)
                                        .setK(0, value);
                }
                if (i == 50) {
                        system.getChemicalReactionOperations().getReactionList().getReaction(0)
                ...
                if (i == 10) {
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[0])
                                        .getMixingRule()).setHVDijParameter(CO2Numb, MDEANumb,
                                                        value);
                ...
                if (i == 40) {
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[0])
                                        .getMixingRule()).setHVDijParameter(MDEANumb, CO2Numb,
                                                        value * 1e8);
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[1])
                                        .getMixingRule()).setHVDijParameter(MDEANumb, CO2Numb,
                                                        value * 1e8);
                ...
                if (i == 10) {
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[0])
                                        .getMixingRule()).setHVDijTParameter(CO2Numb, MDEANumb,
                                                        value);
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[1])
                                        .getMixingRule()).setHVDijTParameter(CO2Numb, MDEANumb,
                                                        value);
                ...
                if (i == 50) {
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[0])
                                        .getMixingRule()).setHVDijTParameter(MDEANumb, CO2Numb,
                                                        value * 1e8);
                        ((HVmixingRuleInterface) ((PhaseEosInterface) system.getPhases()[1])
                                        .getMixingRule()).setHVDijTParameter(MDEANumb, CO2Numb,
                                                        value * 1e8);
