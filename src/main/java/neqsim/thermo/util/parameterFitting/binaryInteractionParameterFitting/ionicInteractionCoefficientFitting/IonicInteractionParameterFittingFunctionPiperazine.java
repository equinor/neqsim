...
public class IonicInteractionParameterFittingFunctionPiperazine extends LevenbergMarquardtFunction {
    ...
    static Logger logger = Logger.getLogger(IonicInteractionParameterFittingFunctionPiperazine.class);
    ...
    public void setFittingParams(int i, double value){
        ...
        if(i==0){
            ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule().setWijParameter(PiperazineplusNumb,CO2Numb, value);
            ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule().setWijParameter(PiperazineplusNumb,CO2Numb, value);
        }
        if(i==1){
            ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule().setWijParameter(PiperazineplusNumb,PiperazineNumb, value);
            ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule().setWijParameter(PiperazineplusNumb,PiperazineNumb, value);
        }
//        if(i==1){
