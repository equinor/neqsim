...
public class IonicInteractionParameterFittingFunction_Sleipnernoacid extends LevenbergMarquardtFunction implements ThermodynamicConstantsInterface{
    ...
    public void setFittingParams(int i, double value){
       ...
       /* System.out.println("Ac- " + system.getPhase(1).getComponent(AcidnegNumb).getx());
        ...
        /*if(i==0){
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb,WaterNumb, value);
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb,WaterNumb, value);
        }
        if(i==1){
       ...
       if(i==2){
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb, MDEANumb, value);
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb, MDEANumb, value);
         }
        if(i==3){
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb,HCO3Numb, value);
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb,HCO3Numb, value);
         }*/
       /* if(i==0){
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[0]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb, AcidnegNumb, value);
            ((ElectrolyteMixingRulesInterface) ((PhaseModifiedFurstElectrolyteEos)system.getPhases()[1]).getElectrolyteMixingRule()).setWijParameter(MDEAplusNumb, AcidnegNumb, value);
         }*/
