        ...
        public static void main(String[] args) {
                ...
                try {
                        ...
                        while (dataSet.next() && i < 100) {
                                ...
                                SystemInterface testSystem = new SystemFurstElectrolyteEos(
                                                (273.15 + 25.0), 100.0);
                                ...
                                double sample1[] = {testSystem.getPhases()[0].getComponents()[0]
                                                ...
                                                / testSystem.getPhases()[0].getComponents()[2]
                                                                .getNumberOfMolesInPhase()}; // temperature
                                double standardDeviation1[] = {0.01}; // std.dev temperature //
                                                                      // presure std.dev
                                                                      // pressure

                                SampleValue sample = new SampleValue(pressure, pressure / 100.0,
                ...
                try {
                        ...
                        while (!dataSet.next() && i < 100) {
                                ...
                                SampleValue sample = new SampleValue(pressure * y1,
                                                y1 * pressure / 100.0, sample1, standardDeviation1);
                                function.setInitialGuess(guess);
                                sample.setFunction(function);
                                sample.setReference("addicks");
                                sample.setDescription(Double.toString(pressure));
