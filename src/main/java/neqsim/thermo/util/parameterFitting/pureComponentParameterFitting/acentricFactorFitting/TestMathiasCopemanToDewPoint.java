            ...
            try{
                ...
                while(dataSet.next()){
                    ...
                    if(i%numerOfPoint==0){
                        ...
                        SystemInterface testSystem = new SystemSrkMathiasCopeman(Double.parseDouble(dataSet.getString("Temperature")), Double.parseDouble(dataSet.getString("VapourPressure")));
        ...
        try{
            ...
            while(dataSet.next() && i < 100){
                ...
                if(i%numerOfPoint==0){
                    ...
                    SystemInterface testSystem = new SystemSrkMathiasCopeman(Double.parseDouble(dataSet.getString("Temperature")), Double.parseDouble(dataSet.getString("Pressure")));
                    ...
                    //                            testSystem.addComponent(dataSet.getString("comp9"), Double.parseDouble(dataSet.getString("x9")));
                    //                            testSystem.addComponent(dataSet.getString("comp10"), Double.parseDouble(dataSet.getString("x10")));
                    //testSystem.createDatabase(true);
                    double sample1[] = {testSystem.getPressure()};  // temperature
                    double standardDeviation1[] = {0.1,0.1,0.1}; // std.dev temperature    // presure std.dev pressure
                    double val =testSystem.getTemperature();
