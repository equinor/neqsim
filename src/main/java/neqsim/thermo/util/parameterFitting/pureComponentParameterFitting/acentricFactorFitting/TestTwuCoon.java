...
public class TestTwuCoon extends java.lang.Object {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // double guess[] ={0.1228415979307727,0.9144707890284266,2.7419786111346327} ;  // Methane  chi sqr 0.1425
            //double guess[] ={0.2996073181440976,0.8766268388933209,1.6792384004871077} ;  // ethane  chi sqr 0.6
            //double guess[] ={0.4358258831879946,0.8661321788747547,1.3954328182729108} ;  // PROPANE  chi sqr 0.57
            // double guess[] ={0.33180058324421624,0.8546927333111055,1.8658288576964368} ;  // n-butane chi sqr 0.66
            // double guess[] ={0.2179712800665,0.8488910728515817,2.284036968290834};  // i-butane chi sqr 0.64
            // double guess[] ={0.3426699116420882,0.8518937813463485,1.9218752789862321} ;  // i-pentane chi sqr 1.71
            // double guess[] ={0.2728761064186051,0.8503101221977485,2.340728864856859} ;  // n-pentane chi sqr 0.827
            //  double guess[] ={0.11262960694190573,0.9021997146737551,2.8749606780260866} ;  // nitrogen chi sqr 0.063
            //double guess[] ={0.08838047169500897,0.9400222937525736,3.4011901770700264} ;  // neon chi sqr 0.044
