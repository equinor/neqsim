    ...
    public static void main(String[] args){
        ...
        try{
            while(dataSet.next()){
                ...
                double guess[] = {13.21, 39.123563589168, 1.1692, 0.0188, 14337.0};//, 0.3255175584, 10725.7300849509};
                // abs 3.2%  10,8185533003 33,0294376487 1,0676048144 0,0221795587 12220,2224075760
        ...
        try{
            while(dataSet.next()){
                ...
                double guess[] = {13.21, 39.123563589168, 1.1692, 0.0188, 14337.0};//, 0.4354649799, 0.3255175584, 10725.7300849509};
