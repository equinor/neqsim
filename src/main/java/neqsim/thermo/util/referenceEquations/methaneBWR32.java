...
public class methaneBWR32 {
    ...
    double[] N = new double[] {-1.84E-02, 1.051016206, 1.61E+01, 8.48E+02, -4.27E+04, 7.66E-04,
            ...
            3.836506384, 2.50E-05, 5.80E-06, -7.16E-03, 1.26E-04, 2.22E+04, -1.48E+06, 5.05E+01,
    ...
    public double calcPressure(double molDens, double temp) {
        ...
        pres = molDens * R * temp
                + molDens * molDens
                        * (N[0] * temp + N[1] * Math.sqrt(temp) + N[2] + N[3] / temp
                                + N[4] / temp / temp)
                ...
                + Math.pow(molDens, 13.0)
                        * (N[29] / temp / temp + N[30] / Math.pow(temp, 3.0)
                                + N[31] / Math.pow(temp, 4.0))
                        * Math.exp(-gamma * Math.pow(molDens, 2.0));
