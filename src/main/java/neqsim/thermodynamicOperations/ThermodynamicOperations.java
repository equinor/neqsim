...
public class ThermodynamicOperations extends Object implements java.io.Serializable, Cloneable {
     ...
     * @param enthalpyUnit The unit as a string. units supported are J, J/mol,
     * J/kg and kJ/kg
     */
    ...
    public void bubblePointTemperatureFlash() throws Exception {
        ...
        if (Double.isNaN(system.getTemperature()) || operation.isSuperCritical()) {
            throw new neqsim.util.exception.IsNaNException("error in bubblePointTemperatureFlash() - could not find solution - possible no bubble point exists");
        }
    ...
    public void freezingPointTemperatureFlash() throws Exception {
        ...
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in freezingPointTemperatureFlash() - could not find solution - possible no freezing point exists");
        }
    }
    ...
    public void waterDewPointTemperatureFlash() throws Exception {
        ...
        getOperation().run();
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in freezingPointTemperatureFlash() - could not find solution - possible no dew point exists");
        }
    }
...
//        TPflash();
    ...
    public void calcSaltSaturation(String saltName) throws Exception {
        ...
        getOperation().run();
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in calcSaltSaturation() - could not find solution - possible no dew point exists");
        }
    }
    ...
    public void checkScalePotential(int phaseNumber) throws Exception {
        ...
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in checkScalePotential() - could not find solution - possible no dew point exists");
        }
    }
    ...
    public void hydrateFormationPressure() throws Exception {
        ...
        getOperation().run();
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in hydrateFormationPressure() - could not find solution - possible no dew point exists");
        }
    }
    ...
    public void calcWAT() throws Exception {
        ...
        getOperation().run();
        if (Double.isNaN(system.getTemperature())) {
            throw new neqsim.util.exception.IsNaNException("error in WAT() - could not find solution - possible no dew point exists");
        }
    }
    ...
    public void hydrateFormationTemperature() throws Exception {
        ...
        if (system.getPhase(0).hasComponent("methanol")) {
            factor -= 2 * system.getPhase(0).getComponent("methanol").getz() / system.getPhase(0).getComponent("water").getz();
        }
    ...
    public void bubblePointPressureFlash() throws Exception {
        ...
        if (Double.isNaN(system.getPressure()) || operation.isSuperCritical()) {
            throw new neqsim.util.exception.IsNaNException("error in bubblePointPressureFlash() - could not find solution - possible no dew point exists");
        }
    ...
    public void dewPointMach(String componentName, String specification, double spec) throws Exception {
        ...
        if (system.getPhase(0).hasComponent(componentName)) {
            ...
            throw new neqsim.util.exception.IsNaNException("error in dewPointMach(String componentName) - specified component is not precent in mixture: " + componentName);
        }
        ...
        if (specification.equals("dewPointTemperature")) {
            ...
            } while (Math.abs(dn / system.getPhase(0).getComponent(componentName).getNumberOfmoles()) > 1e-9 || iterations < 5 || iterations > 105);
    ...
    public void dewPointTemperatureFlash() throws Exception {
        constantDutyFlashInterface operation = new neqsim.thermodynamicOperations.flashOps.saturationOps.dewPointTemperatureFlash(system);
        operation.run();
        if (Double.isNaN(system.getTemperature()) || operation.isSuperCritical()) {
            throw new neqsim.util.exception.IsNaNException("error in dewPointTemperatureFlash() - could not find solution - possible no dew point exists");
        }
    ...
    public void dewPointPressureFlashHC() throws Exception {
        ...
        operation.run();
        if (Double.isNaN(system.getPressure()) || operation.isSuperCritical()) {
            throw new neqsim.util.exception.IsNaNException("error in dewPointPressureFlash() - could not find solution - possible no dew point exists");
        }
        //  }
    }
