...
public class TPmultiflash_1 extends TPflash implements java.io.Serializable {
    ...
    public void stabilityAnalysis(){
        ...
        double[][] Wi = new double[system.getPhases()[1].getNumberOfComponents()][system.getPhases()[0].getNumberOfComponents()];
        ...
        double[][] x = new double[system.getPhases()[1].getNumberOfComponents()][system.getPhases()[0].getNumberOfComponents()];
