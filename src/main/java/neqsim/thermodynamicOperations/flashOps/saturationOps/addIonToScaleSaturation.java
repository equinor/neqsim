            ...
            while (dataSet.next()) {
                ...
                ksp = Math.exp(Double.parseDouble(dataSet.getString("Ksp-water")) / temperatureC
                        ...
                        + Math.log(temperatureC)
                                * Double.parseDouble(dataSet.getString("Ksp-water3"))
                        + temperatureC * Double.parseDouble(dataSet.getString("Ksp-water4"))
                        + Double.parseDouble(dataSet.getString("Ksp-water5"))
                ...
                if (system.getPhase(phaseNumber).hasComponent(name1)
                    ...
                    do {
                        ...
                        int compNumb1 = system.getPhase(phaseNumber).getComponent(name1)
                                .getComponentNumber();
                        int compNumb2 = system.getPhase(phaseNumber).getComponent(name2)
                                .getComponentNumber();
                        int waterompNumb = system.getPhase(phaseNumber).getComponent("water")
                                .getComponentNumber();
                        ...
                        error = (scalePotentialFactor - oldScalePotentialFactor)
                                / scalePotentialFactor * 100;
                        ...
                        if (saltName.equals(scaleSaltName)) {
                            ...
                            system.addComponent(nameOfIonToBeAdded,
                                    (1.0 - scalePotentialFactor) / 100000.0, phaseNumber);
                            ops.TPflash();
                            logger.info("x1 "
                                    + system.getPhase(phaseNumber).getComponent(name1).getx());
                            logger.info("x2 "
                ...
                try {
                        while (dataSet.next()) {
                                ...
                                stoc2 = Double.parseDouble(dataSet.getString("stoc2"));
                                double temperatureC = system.getPhase(phaseNumber).getTemperature();
                                ksp = Math.exp(Double.parseDouble(dataSet.getString("Ksp-water"))
                                                / temperatureC
                                                + Double.parseDouble(
                                                                dataSet.getString("Ksp-water2"))
                                                + Math.log(temperatureC) * Double.parseDouble(
                                                                dataSet.getString("Ksp-water3"))
                                                + temperatureC * Double.parseDouble(
                                                                dataSet.getString("Ksp-water4"))
                                                + Double.parseDouble(
                                                                dataSet.getString("Ksp-water5"))
                                                                / (temperatureC * temperatureC));
                                if (saltName.equals("NaCl")) {
                                ...
                                if (system.getPhase(phaseNumber).hasComponent(name1) && system
                                        ...
                                        do {
                                                ...
                                                double x1 = system.getPhase(phaseNumber)
                                                                ...
                                                                / (system.getPhase(phaseNumber)
                                                                                ...
                                                                                * system.getPhase(
                                                                                                ...
                                                                                                .getComponent(waterompNumb)
                                                                                                .getMolarMass());
                                                double x2 = system.getPhase(phaseNumber)
                                                                ...
                                                                / (system.getPhase(phaseNumber)
                                                                                ...
                                                                                * system.getPhase(
                                                                                                ...
                                                                                                .getComponent(waterompNumb)
                                                                                                .getMolarMass());
                                                double kspReac = Math.pow(system
                                                                ...
                                                                * Math.pow(x2 * system.getPhase(
                                                                                ...
                                                                                .getActivityCoefficient(
                                                                                                ...
                                                                                                waterompNumb),
                                                                                stoc2);
                                                double stocKsp = Math.pow(x1, stoc1)
                                                                * Math.pow(x2, stoc2);
                                                logger.info("calc Ksp " + kspReac);
                                                logger.info("stoc Ksp " + stocKsp);
                                                logger.info("activity " + kspReac / stocKsp);
                                                ...
                                                error = (scalePotentialFactor
                                                                - oldScalePotentialFactor)
                                                                / scalePotentialFactor * 100;
                                                oldScalePotentialFactor = scalePotentialFactor;
                                                logger.info("Scale potential factor "
                                                                + scalePotentialFactor);
                                                resultTable[numb][0] = name1 + " " + name2;
                                                resultTable[numb][1] = Double
                                                                .toString(scalePotentialFactor);
                                                resultTable[numb][2] = "";

                                                if (saltName.equals(scaleSaltName)) {
                                                        logger.info("error " + error);
                                                        logger.info("pH : " + system
                                                                        .getPhase(phaseNumber)
                                                                        .getpH());
                                                        system.addComponent(nameOfIonToBeAdded,
                                                                        (1.0 - scalePotentialFactor)
                                                                                        / 100000.0,
                                                                        phaseNumber);
                                                        ops.TPflash();
                                                        logger.info("x1 " + system
                                                                        .getPhase(phaseNumber)
                                                                        .getComponent(name1)
                                                                        .getx());
                                                        logger.info("x2 " + system
                                                                        .getPhase(phaseNumber)
                                                                        .getComponent(name2)
                                                                        .getx());
                                                }
                                        } while (saltName.equals(scaleSaltName)
                                                        && Math.abs(error) > 1e-6
                                                        && iterations < 200);
                                }
                        }
