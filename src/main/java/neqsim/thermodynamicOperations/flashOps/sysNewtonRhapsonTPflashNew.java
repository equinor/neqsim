...
public class sysNewtonRhapsonTPflashNew extends Object implements java.io.Serializable {
 ...
 /** Creates new nonlin */
    ...
    public void setfvec(){
        ...
        {
            fvec.set(i,0, u.get(i,0)+Math.log(
            system.getPhases()[1].getComponents()[i].getFugasityCoeffisient()/system.getPhases()[0].getComponents()[i].getFugasityCoeffisient()));
        ...
        for (int i=0;i<numberOfComponents;i++)
        {
            fsum=fsum+system.getPhases()[1].getComponents()[i].getx()-system.getPhases()[0].getComponents()[i].getx();
        }
    ...
    public void setJac(){
        ...
        for (int i=0;i<numberOfComponents;i++)
        {
            dxidlnk[i]=-system.getBeta()*system.getPhases()[0].getComponents()[i].getx()*system.getPhases()[1].getComponents()[i].getx()/system.getPhases()[0].getComponents()[i].getz();
            dyidlnk[i]=system.getPhases()[1].getComponents()[i].getx()+system.getPhases()[0].getComponents()[i].getK()*dxidlnk[i];
            
            dyidbeta[i]=(system.getPhases()[0].getComponents()[i].getK()*system.getPhases()[0].getComponents()[i].getz()*(1-system.getPhases()[0].getComponents()[i].getK()))/Math.pow(1-system.getBeta()+system.getBeta()*system.getPhases()[0].getComponents()[i].getK(),2);
            dxidbeta[i]=(system.getPhases()[0].getComponents()[i].getz()*(1-system.getPhases()[0].getComponents()[i].getK()))/Math.pow(1-system.getBeta()+system.getBeta()*system.getPhases()[0].getComponents()[i].getK(),2);
        ...
        for (int i=0;i<numberOfComponents;i++)
        {
            for (int j=0;j<numberOfComponents;j++)
            {
                ...
                tempJ=dij+system.getPhases()[1].getComponents()[i].getdfugdx(j)*dyidlnk[j]-system.getPhases()[0].getComponents()[i].getdfugdx(j)*dxidlnk[j];
                Jac.set(i,j,tempJ);
            }
            Jac.set(i,nofc, system.getPhases()[1].getComponents()[i].getdfugdx(i)*dyidbeta[i]-system.getPhases()[0].getComponents()[i].getdfugdx(i)*dxidbeta[i]);
