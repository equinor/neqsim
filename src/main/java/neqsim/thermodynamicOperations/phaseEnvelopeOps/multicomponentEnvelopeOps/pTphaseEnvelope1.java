...
public class pTphaseEnvelope1 extends BaseOperation implements OperationInterface, java.io.Serializable {
    ...
    static Logger logger = Logger.getLogger(pTphaseEnvelope1.class);
    ...
    public pTphaseEnvelope1(SystemInterface system, String name, double phaseFraction, double lowPres, boolean bubfirst) {
    ...
    public void run() {
        ...
        try {
            ...
            for (np = 1; np < 9500; np++) {
                ...
                if (Double.isNaN(system.getTemperature()) || Double.isNaN(system.getTemperature()) || system.getPressure() < startPres) {
