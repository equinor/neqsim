...
public class OLGApropertyTableGeneratorWater extends neqsim.thermodynamicOperations.BaseOperation {
    ...
    public void run() {
        ...
        for (int j = 0; j < temperatures.length; j++) {
            ...
            for (int i = 0; i < pressures.length; i++) {
                ...
                if (thermoSystem.hasPhaseType("aqueous") && acceptedFlash) {
                    ...
                    props[k][i][j] = thermoSystem.getPhase(0).getComponent("water").getx() * thermoSystem.getPhase(0).getComponent("water").getMolarMass() / thermoSystem.getPhase(0).getMolarMass();
        ...
        BicubicInterpolatingFunction funcGasDens = interpolationFunc.interpolate(pressures, temperatures, props[0]);
