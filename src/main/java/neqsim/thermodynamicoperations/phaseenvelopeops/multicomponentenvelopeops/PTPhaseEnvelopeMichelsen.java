...
public class PTPhaseEnvelopeMichelsen extends BaseOperation {
  ...
  private void clearResults() {
    ...
    cricondenThermX = new double[system.getNumberOfComponents()];
    cricondenThermY = new double[system.getNumberOfComponents()];
    cricondenBarX = new double[system.getNumberOfComponents()];
    cricondenBarY = new double[system.getNumberOfComponents()];
    buildOutputArrays();
  }
