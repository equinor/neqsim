...
class BenchmarkValidationTest {
  ...
  void testTrustReportCompleteness() {
    ...
    String[] expectedTools = {"runFlash", "runFlashFromE300", "runProcess", "runPVT",
        "runFlowAssurance", "calculateStandard", "runPipeline", "runWaterHammer",
        "runRootCauseAnalysis", "runReservoir", "runFieldEconomics", "runDynamic", "runBioprocess",
        "crossValidateModels", "runParametricStudy", "getPhaseEnvelope", "getPropertyTable",
        "sizeEquipment"};
  ...
  void testToolTrustPageStructure() {
    String[] calculationTools = {"runFlash", "runFlashFromE300", "runProcess", "runPVT"};
