...
class OperationalStudyRunnerTest {
  ...
  void getSchemaReturnsOperationalActions() {
    JsonObject result = JsonParser.parseString(OperationalStudyRunner.run("{\"action\":\"getSchema\"}"))
        .getAsJsonObject();
  ...
  void applyFieldDataWritesAutomationBinding() {
    String json = "{" + "\"action\":\"applyFieldData\"," + processJsonField() + "," + "\"tagBindings\":[{"
        + "\"logicalTag\":\"outlet_valve_position\"," + "\"automationAddress\":\"Outlet Valve.percentValveOpening\","
        + "\"unit\":\"%\",\"role\":\"INPUT\"}]," + "\"fieldData\":{\"outlet_valve_position\":35.0}}";
    ...
    assertEquals(35.0, result.getAsJsonObject("applied").get("outlet_valve_position").getAsDouble(), 1.0e-10);
    assertEquals(35.0, result.getAsJsonObject("modelValues").get("outlet_valve_position").getAsDouble(), 1.0e-10);
  }
  ...
  void runScenarioExecutesValveAndAutomationActions() {
    String json = "{" + "\"action\":\"runScenario\"," + "\"scenarioName\":\"partly close outlet\"," + processJsonField()
        + "," + "\"actions\":[" + "{\"type\":\"SET_VALVE_OPENING\",\"target\":\"Outlet Valve\",\"value\":15.0},"
    ...
    assertEquals(15.0,
        scenarioResult.getAsJsonObject("afterValues").get("Outlet Valve.percentValveOpening").getAsDouble(), 1.0e-10);
  }
  ...
  void evaluateControllerResponseReturnsRecommendation() {
    String json = "{" + "\"action\":\"evaluateControllerResponse\"," + "\"controllerName\":\"LC-001\",\"setPoint\":1.0,"
        + "\"timeSeconds\":[0.0,10.0,20.0,30.0,40.0,50.0]," + "\"processValue\":[0.0,0.55,0.82,0.95,0.99,1.0],"
  ...
  void runEvidencePackageReturnsBottleneckReport() {
    String json = "{" + "\"action\":\"runEvidencePackage\"," + processJsonField() + ","
        + "\"studyName\":\"operations screen\"," + "\"benchmarkToleranceFraction\":0.05," + "\"tagBindings\":["
        + "{\"logicalTag\":\"outlet_valve_position\"," + "\"automationAddress\":\"Outlet Valve.percentValveOpening\","
        + "\"unit\":\"%\",\"role\":\"INPUT\"}," + "{\"logicalTag\":\"outlet_pressure\","
        + "\"automationAddress\":\"Outlet Valve.outletPressure\"," + "\"unit\":\"bara\",\"role\":\"BENCHMARK\"}],"
    ...
    assertTrue(evidencePackage.getAsJsonObject("benchmarkComparison").get("allWithinTolerance").getAsBoolean(),
        result.toString());
    assertTrue(evidencePackage.getAsJsonObject("baseCapacity").getAsJsonObject("bottleneck").get("hasBottleneck")
  ...
  void analyzePipeSectionsReturnsVelocityAndUtilization() {
    String json = "{\"action\":\"analyzePipeSections\","
        ...
        + "\"temperature_C\":25.0,\"pressure_bara\":70.0," + "\"flowRate\":{\"value\":50000,\"unit\":\"kg/hr\"},"
        + "\"pipeSections\":[" + "{\"name\":\"Line-A001\",\"innerDiameter_m\":0.254,\"length_m\":100,"
        + "\"roughness_m\":0.00005,\"maxDesignVelocity_m_s\":20.0," + "\"sourceReference\":\"PID-001\"},"
    ...
    assertTrue(section2.get("maxVelocity_m_s").getAsDouble() > section1.get("maxVelocity_m_s").getAsDouble());
  }
  ...
  void analyzePipeSectionsSupportsFieldDataOverrides() {
    String json = "{\"action\":\"analyzePipeSections\","
        ...
        + "\"temperature_C\":30.0,\"pressure_bara\":60.0," + "\"flowRate\":{\"value\":20000,\"unit\":\"kg/hr\"},"
        + "\"pipeSections\":[" + "{\"name\":\"Line-B001\",\"innerDiameter_m\":0.2,\"length_m\":80}" + "],"
        + "\"sectionTagBindings\":[" + "{\"pipeSectionName\":\"Line-B001\",\"logicalTag\":\"FT-B001\","
  ...
  void runEvidencePackageIncludesPipeSectionAnalysis() {
    String json = "{\"action\":\"runEvidencePackage\"," + processJsonField() + ","
        + "\"studyName\":\"with pipe sections\"," + "\"components\":{\"methane\":0.90,\"ethane\":0.10},"
        + "\"temperature_C\":25.0,\"pressure_bara\":70.0," + "\"flowRate\":{\"value\":10000,\"unit\":\"kg/hr\"},"
        + "\"pipeSections\":[" + "{\"name\":\"Bypass-001\",\"innerDiameter_m\":0.15,\"length_m\":30}" + "]}";
  ...
  /**
   * Verifies that designCapacities from JSON are applied to equipment and reported with data source tracking.
   */
  @Test
  ...
  /**
   * Verifies that dataSource is reported as "not_set" or "equipment" when no designCapacities are provided.
   */
  @Test
  ...
  void evaluateOperatingEnvelopeReturnsMarginsAndPredictions() {
    String json = "{" + "\"action\":\"evaluateOperatingEnvelope\"," + processJsonField() + "," + "\"tagBindings\":[{"
        + "\"logicalTag\":\"outlet_valve_position\"," + "\"automationAddress\":\"Outlet Valve.percentValveOpening\","
        + "\"unit\":\"%\",\"role\":\"INPUT\"}]," + "\"fieldData\":{\"outlet_valve_position\":72.0},"
        + "\"predictionHorizonSeconds\":1800.0," + "\"marginHistory\":["
        ...
        + "{\"key\":\"Outlet Valve.valveOpening\",\"timestampSeconds\":120.0," + "\"marginPercent\":15.0}]}";
  ...
  private String processJsonField() {
    return "\"processJson\":{" + "\"fluid\":{" + "\"model\":\"SRK\"," + "\"temperature\":298.15," + "\"pressure\":70.0,"
        + "\"mixingRule\":\"classic\"," + "\"components\":{\"methane\":0.90," + "\"ethane\":0.10}}," + "\"process\":["
