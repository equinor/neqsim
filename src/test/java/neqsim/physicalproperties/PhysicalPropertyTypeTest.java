...
public class PhysicalPropertyTypeTest {
  ...
  void testByName() {
    ...
    assertEquals(PhysicalPropertyType.byName("dynamic_VISCOSITY"), PhysicalPropertyType.DYNAMIC_VISCOSITY);

    assertEquals(PhysicalPropertyType.byName("CONDUCTIVITY"), PhysicalPropertyType.THERMAL_CONDUCTIVITY);
    assertEquals(PhysicalPropertyType.byName("thermal_CONDUCTIVITY"), PhysicalPropertyType.THERMAL_CONDUCTIVITY);
    assertEquals(PhysicalPropertyType.byName("conductivity"), PhysicalPropertyType.THERMAL_CONDUCTIVITY);
    assertEquals(PhysicalPropertyType.byName("viscosity"), PhysicalPropertyType.DYNAMIC_VISCOSITY);
  ...
  void testValueOf() {
    ...
    assertEquals(PhysicalPropertyType.MASS_DENSITY, PhysicalPropertyType.valueOf("mass_density".toUpperCase()));
