...
/**
 * Tests for the CO2 thermal conductivity model coupled with the Span–Wagner EOS over a wide range of conditions.
 */
public class CO2ConductivityMethodTest {
  ...
  void testConductivityAcrossConditions() {
    ...
    double[][] states = { { 300.0, 1.0, 0.016773682981674743 }, { 300.0, 10.0, 0.017334537751875614 },
        { 400.0, 50.0, 0.027437895523946265 }, { 220.0, 20.0, 0.17401034581268648 }, // NIST:
                                                                                     // 0.17407
        // W/m.K (liquid)
        { 250.0, 50.0, 0.14025257694726223 }, { 260.0, 100.0, 0.13423766706020518 }, }; // NIST:
                                                                                        // 0.14026
    // W/m.K (liquid)
    for (double[] st : states) {
      ...
      assertTrue(system.getPhase(0).getPhysicalProperties().getConductivityModel() instanceof CO2ConductivityMethod);
