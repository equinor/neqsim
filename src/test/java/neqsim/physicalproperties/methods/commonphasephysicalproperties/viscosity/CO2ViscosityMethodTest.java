...
/**
 * Tests for the CO2 viscosity model coupled with the Span–Wagner EOS over a wide range of conditions.
 */
public class CO2ViscosityMethodTest {
  ...
  void testViscosityAcrossConditions() {
    ...
    double[][] states = { { 300.0, 1.0, 1.5003069868799645E-5 }, { 300.0, 10.0, 1.51080385834066E-5 },
        { 400.0, 50.0, 2.059452549395974E-5 }, { 220.0, 20.0, 2.47741850798784E-4 }, // NIST:
                                                                                     // 242.18
        // uPa.s (liquid)
    ...
    for (double[] st : states) {
      ...
      assertTrue(system.getPhase(0).getPhysicalProperties().getViscosityModel() instanceof CO2ViscosityMethod);
