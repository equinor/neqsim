...
public class CompressorChartTest {
  ...
  public void test_Run() {
     ...
     * comp1.getAntiSurge().isSurge()); System.out
     * .println("fraction in anti surge line " +
     * comp1.getAntiSurge().getCurrentSurgeFraction());
     * logger.info("Polytropic head from curve:" +
     ...
     * stream_1.getThermoSystem().getFlowRate("m3/hr") + 10.0,
     * comp1.getPolytropicHead()));
     * logger.info("pressure out " + comp1.getOutletPressure());
     * logger.info("temperature out " +
    ...
    /*
     * logger.info("polytopic head " + polytropicHead);
     * logger.info("polytopic efficiency " +
     * comp1.getPolytropicEfficiency()); logger.info("temperature out " +
     * (comp1.getOutTemperature()
