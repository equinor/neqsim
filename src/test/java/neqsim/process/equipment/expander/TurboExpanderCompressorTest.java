...
public class TurboExpanderCompressorTest {
  ...
  void testRun() {
    ...
    Assertions.assertEquals(19.8347635, turboExpander.getCompressorPolytropicHead(), 1e-2);
    Assertions.assertEquals(0.88071122465, turboExpander.getUCratioexpander(), 1e-2);
    Assertions.assertEquals(0.880844374, turboExpander.getUCratiocompressor(), 1e-2);
    Assertions.assertEquals(0.869499636, turboExpander.getQNratioexpander(), 1e-2);
  ...
  void testRun2() {
    ...
    Assertions.assertEquals(47.97237761,
        turboExpander.getCompressorOutletStream().getPressure("bara"), 1e-2);

    Assertions.assertEquals(6066.9233322, turboExpander.getSpeed(), 1e-2);
    Assertions.assertEquals(2746243.2491, turboExpander.getPowerExpander(), 1e-2);
    Assertions.assertEquals(2746235.404, turboExpander.getPowerCompressor(), 1e-2);
    Assertions.assertEquals(0.6907436019, turboExpander.getCompressorPolytropicEfficiency(), 1e-2);
    Assertions.assertEquals(0.765879841, turboExpander.getExpanderIsentropicEfficiency(), 1e-2);
    Assertions.assertEquals(16.170943128, turboExpander.getCompressorPolytropicHead(), 1e-2);
    Assertions.assertEquals(0.8078085350, turboExpander.getUCratioexpander(), 1e-2);
    Assertions.assertEquals(0.809140031202, turboExpander.getUCratiocompressor(), 1e-2);
    Assertions.assertEquals(0.98968751, turboExpander.getQNratioexpander(), 1e-2);
    Assertions.assertEquals(0.98805891628, turboExpander.getQNratiocompressor(), 1e-2);
    Assertions.assertEquals(-40.32454910,
        turboExpander.getExpanderOutletStream().getTemperature("C"), 1e-2);
  }
}
