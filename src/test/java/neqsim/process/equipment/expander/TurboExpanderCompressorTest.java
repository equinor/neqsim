...
public class TurboExpanderCompressorTest {
  ...
  void testRun() {
    ...
    Assertions.assertEquals(3001861.63337, turboExpander.getPowerExpander(), 1.0);
    Assertions.assertEquals(3.00186163337, turboExpander.getPowerExpander("MW"), 1e-3);
    Assertions.assertEquals(3001852.309290, turboExpander.getPowerCompressor(), 1.0);
    Assertions.assertEquals(3.00185230929, turboExpander.getPowerCompressor("MW"), 1e-3);
