...
public class MultiStreamHeatExchanger2Test {
  ...
  /* 2.  Register the eight inlet streams
   *     Pass   • "hot" / "cold"
   *            • outlet-temperature set-point  (null = unknown / to be solved)
   *            • order matters: heatEx.getOutStream(i) returns in same order
   */
  // ----- HOT SIDE -----
  ...
  operations.add(H1);   operations.add(H2);   operations.add(H3);   operations.add(H4);
  operations.add(C1);   operations.add(C2);   operations.add(C3);   operations.add(C4);
  operations.add(heatEx); 
