...
public class PumpChartTest {
  ...
  void testPumpChart() {
	...
	pump1.getPumpChart().getHead(pump1.getInletStream().getFlowRate("m3/hr"), active_speed), 1.0);
    Assertions.assertEquals(80.76,
	pump1.getPumpChart().getEfficiency(pump1.getInletStream().getFlowRate("m3/hr"), active_speed), 0.1);
