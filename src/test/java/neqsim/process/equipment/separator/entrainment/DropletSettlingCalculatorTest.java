...
class DropletSettlingCalculatorTest {
  ...
  void testStokesSettling() {
    ...
    double vt = DropletSettlingCalculator.calcTerminalVelocity(dropletDiameter, gasDensity, waterDensity, gasViscosity);
    ...
    double vStokes = dropletDiameter * dropletDiameter * (waterDensity - gasDensity) * 9.81 / (18.0 * gasViscosity);
  ...
  void testBubbleRising() {
    ...
    double vt = DropletSettlingCalculator.calcTerminalVelocity(bubbleDiameter, oilDensity, gasDensity, oilViscosity);
