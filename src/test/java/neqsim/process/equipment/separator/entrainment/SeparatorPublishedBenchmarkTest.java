 ...
 *
 * <p>
 * These tests validate model behavior against published performance windows and design thresholds, not against
 * proprietary vendor test-rig datasets.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Bothamley, M. (2013). Gas/Liquid Separators: Quantifying Separation Performance, <i>Oil and Gas
 * Facilities</i>.</li>
 * <li>Brunazzi, E., Paglianti, A. (1998). Wire mesh mist eliminator performance, <i>Chem. Eng. Sci.</i>, 53(19),
 * 3373-3380.</li>
...
class SeparatorPublishedBenchmarkTest {
  ...
  void testWireMeshDemisterEfficiencyWindowFromPublishedCurve() {
    ...
    assertEquals(0.499, etaAtD50, 0.02, "Efficiency at d50 should be about 0.5 for the sigmoid grade curve");
  }
