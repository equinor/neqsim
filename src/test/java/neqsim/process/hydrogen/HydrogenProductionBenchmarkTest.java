 ...
 *
 * <p>
 * The acceptance bands are intentionally engineering envelopes instead of exact reference points. They guard that the
 * screening models remain in public SMR/ATR/POX/PSA/blue-H2 ranges while allowing future thermodynamic and solver
 * improvements to move individual values within those ranges.
 * </p>
 */
public class HydrogenProductionBenchmarkTest extends neqsim.NeqSimTest {
  ...
  public void testFullBlueHydrogenChainBenchmarkEnvelope() {
    ...
    assertTrue(builder.getCarbonIntensityKgCO2PerKgH2() <= builder.getGrossCarbonIntensityKgCO2PerKgH2());
