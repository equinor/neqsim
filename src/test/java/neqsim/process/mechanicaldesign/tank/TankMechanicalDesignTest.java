...
public class TankMechanicalDesignTest {
  private static final Logger logger = LogManager.getLogger(TankMechanicalDesignTest.class);
  private Tank tank;
  ...
  public void testTankDimensions() {
    ...
    logger.info("Tank diameter: " + diameter + " m");
    logger.info("Tank height: " + height + " m");
  }
  ...
  public void testNominalCapacity() {
    ...
    logger.info("Nominal capacity: " + capacity + " m³");
  }
  ...
  public void testFoundationLoad() {
    ...
    logger.info("Foundation load: " + load + " kN");
  }
  ...
  public void testTankType() {
    ...
    logger.info("Tank type: " + tankType);
  }
  ...
  public void testRoofType() {
    ...
    logger.info("Roof type: " + roofType);
  }
  ...
  public void testBottomThickness() {
    ...
    logger.info("Bottom thickness: " + bottomThickness + " mm");
  }
  ...
  public void testRoofThickness() {
    ...
    logger.info("Roof thickness: " + roofThickness + " mm");
  }
