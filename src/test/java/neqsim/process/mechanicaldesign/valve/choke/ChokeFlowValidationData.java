...
public final class ChokeFlowValidationData {
  ...
  public static final double[][] SACHDEVA_CRITICAL_RATIO = {{0.01, 0.690}, // Near-liquid
      {0.05, 0.653}, {0.10, 0.637}, {0.20, 0.621}, {0.30, 0.612}, {0.40, 0.605}, {0.50, 0.600}, {0.60, 0.596},
      {0.70, 0.593}, {0.80, 0.590}, {0.90, 0.587}, {0.95, 0.585}, {0.99, 0.582}, // Near-gas
  };
  ...
  public static final double[][] ASHFORD_DISCHARGE_COEFFICIENTS = {{5000, 0.1, 0.78}, {5000, 0.3, 0.82},
      ...
      {100000, 0.1, 0.84}, {100000, 0.3, 0.86}, {100000, 0.5, 0.88}, {100000, 0.7, 0.89}, {100000, 0.9, 0.91},};
