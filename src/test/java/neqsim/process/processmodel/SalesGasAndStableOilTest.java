...
public class SalesGasAndStableOilTest extends neqsim.NeqSimTest {
  ...
  public void testProcess2() {
    ...
    Assertions.assertEquals(0.9964135182937641,
        dewPointControlCooler.getOutletStream().getFluid().getBeta(), 1e-6);
    ...
    Assertions.assertEquals(0.9673153306118873,
        dewPointControlCooler2.getOutletStream().getFluid().getBeta(), 1e-4);
