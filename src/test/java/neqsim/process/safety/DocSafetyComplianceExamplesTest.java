...
/**
 * Verifies every code example shown in the new {@code docs/safety} reference pages compiles and
...
public class DocSafetyComplianceExamplesTest {
  ...
  public void testApi14cSafeChartExample() {
    ...
    Api14cSafeChartBuilder chart = new Api14cSafeChartBuilder()
        .declarePresent("HP separator", EnumSet.of(Api14cDeviceType.PSH, Api14cDeviceType.PSV))
        .build(process);
  ...
  public void testNorsokP002Example() {
    NorsokP002ComplianceChecker c =
        new NorsokP002ComplianceChecker().checkFlareLineMach("Header", 0.5)
            .checkBlowdownRhoV2("BDV-1", 150000.0).checkVentGasVelocity("Vent", 45.0)
            .checkLiquidCarryOver("V-100", 1.0e-4).checkErosionalVelocity("Line-200", 80000.0)
  ...
  public void testMultiVesselBlowdownExample() {
    MultiVesselBlowdownStudy study = new MultiVesselBlowdownStudy().setGridStep(1.0)
        ...
        .setHeader(0.80, 1.5, 288.15, 0.020, 1.30);
  ...
  public void testApi537FlareFlameExample() {
    Api537FlareFlameModel model = new Api537FlareFlameModel(50.0, 50.0e6, 0.20, 200.0)
        .setStackHeightM(40.0).setWindSpeedMPerS(10.0);
  ...
  public void testPfpDemandExample() {
    PfpDemandResult res =
        new PfpDemandCalculator(100.0e3, 0.012).setFireType(FireType.POOL).evaluate(3600.0);
