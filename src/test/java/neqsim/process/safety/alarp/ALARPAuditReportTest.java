...
class ALARPAuditReportTest {
  ...
  void cheapEffectiveMeasureAccepted() {
    ALARPAuditReport r = new ALARPAuditReport("Test").setValueOfStatisticalLife(30.0e6).setDisproportionFactor(3.0)
  ...
  void expensiveLowImpactMeasureRejected() {
    ALARPAuditReport r = new ALARPAuditReport("Test").addMeasure("Replace whole HC system", 1.0e-7, 100.0e6);
