...
public class BottleneckTest {
    ...
    public void testBottleneck() {
        ...
        // Check utilization
        System.out.println("Compressor utilization: " + compressor.getCapacityDuty() / compressor.getCapacityMax());
        System.out.println("Separator utilization: " + separator.getCapacityDuty() / separator.getCapacityMax());
