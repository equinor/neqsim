 ...
 * loaded from text/JSON-like format at runtime.
 *
 * <p>
 * This demonstrates:
 * </p>
...
public class ConfigurableLogicExample {
  ...
  private static ProcessSystem createSimpleProcess() {
    ...
    System.out.println("Process system created with " + system.getUnitOperations().size() + " units");
    return system;
  }
  ...
  private static void demonstrateUserDefinedLogic(LogicFactory factory) {
    ...
    ESDLogic userDefinedLogic = factory.createESDFromConfig(logicName, userActions.toArray(new String[0]));
