 ...
 * <li>Adjusters on HP and LP streams adjust heat transfer coefficients to match measured temperatures (50°C)</li>
 * </ul>
 *
 * <pre>
 *                        +--------+
...
public class FourWellManifoldWithHeatTransferAdjustmentExample {
  private static final Logger logger = LogManager.getLogger(FourWellManifoldWithHeatTransferAdjustmentExample.class);
  ...
  public static void main(String[] args) {
    ...
    logger.printf(org.apache.logging.log4j.Level.INFO, "HP Adjuster: Target temperature = %.1f °C%n", measuredHPTemp);
    logger.printf(org.apache.logging.log4j.Level.INFO, "LP Adjuster: Target temperature = %.1f °C%n", measuredLPTemp);
