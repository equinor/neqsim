...
public class MEGinjection {
  ...
  public static void main(String[] args) {
    ...
    neqsim.process.processmodel.ProcessSystem MEGwelloperations = new neqsim.process.processmodel.ProcessSystem();
    ...
    Stream feedStream = new Stream("feed to onhore", (Stream) MEGwelloperations.getUnit("feed gas and MEG"));
    ...
    neqsim.process.processmodel.ProcessSystem onshoreOperations = new neqsim.process.processmodel.ProcessSystem();
