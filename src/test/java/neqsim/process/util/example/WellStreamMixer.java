...
public class WellStreamMixer {
  ...
  public static void main(String[] args) {
    ...
    testSystem
        .setMolarComposition(new double[] {1.0, 1.42, 70.1, 8, 3.54, 0.54, 0.2, 0.21, 0.19, 0.28, 5.0, 1.0, 1.0, 0, 0});
    ...
    testSystem2
        .setMolarComposition(new double[] {1.0, 1.42, 70.1, 8, 3.54, 0.54, 0.2, 0.21, 0.19, 0.28, 5.0, 0.0, 0.0, 1, 1});
