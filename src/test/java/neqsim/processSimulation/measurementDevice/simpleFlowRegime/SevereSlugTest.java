...
public class SevereSlugTest {
  ...
  void testCheckFlowRegime1() {
      ...
      SevereSlugAnalyser mySevereSlug = new SevereSlugAnalyser(testSystem, myPipe, 100000.0, 20.0, 200.0, 200000); 
      ...
      SevereSlugAnalyser mySevereSlug5= new SevereSlugAnalyser (inputStream2, 0.05, 167, 7.7, 2,100000.0,20.0, 200.0,20000);
