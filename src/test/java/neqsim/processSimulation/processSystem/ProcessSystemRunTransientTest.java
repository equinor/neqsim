...
public class ProcessSystemRunTransientTest extends neqsim.NeqSimTest {
  ...
  public void testDynamicCalculation() {
    ...
    flowController.setControllerParameters(0.1, 100.0, 0.0);
  ...
  public void testDynamicCalculation2() {
    ...
    separatorLevelController.setControllerParameters(0.001, 100.0, 0.0);
    ...
    separatorPressureController.setControllerParameters(1.0, 20.0, 0.0);
    ...
    for (int i = 0; i < 10; i++) {
      System.out.println("pressure " + separator_1.getGasOutStream().getPressure() + " flow "
          ...
          + separator_1.getLiquidLevel());
      p.runTransient();
    }

    valve_1.setPercentValveOpening(90);
    for (int i = 0; i < 100; i++) {
      System.out.println("2pressure " + separator_1.getGasOutStream().getPressure() + " flow "
          + separator_1.getGasOutStream().getFlowRate("kg/hr") + " sepr height "
    ...
    valve_1.setPercentValveOpening(50);
    for (int i = 0; i < 100; i++) {
      System.out.println("3pressure " + separator_1.getGasOutStream().getPressure() + " flow "
          + separator_1.getGasOutStream().getFlowRate("kg/hr") + " sepr height "
          + separatorLevelTransmitter.getMeasuredValue() + " flow oil "
          + valve_2.getOutletStream().getFlowRate("kg/hr"));
      p.runTransient();
    }
  }
}