...
public class OffshoreProcess {
  ...
  public static void main(String args[]) {
    ...
    StreamInterface stream_2 = new Stream("gas out stream", separator.getGasOutStream());
    StreamInterface stream_3 = new Stream("liquid out stream", separator.getLiquidOutStream());

    Compressor compressor1 = new Compressor("compressor1", stream_2);
    compressor1.setOutletPressure(131.3);

    StreamInterface stream_4 =
        new Stream("gas compressor out stream", compressor1.getOutletStream());

    Compressor compressor2 = new Compressor("compressor2", stream_3);
    compressor2.setOutletPressure(131.3);

    StreamInterface stream_5 =
        new Stream("liquid compressor out stream", compressor2.getOutletStream());
