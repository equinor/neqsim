    ...
    public static void main(String args[]) {
        try {
            ...
            double nitrogen_s = 2.525, CO2_s = 5.262, methane_s = 81.006, ethane_s = 5.027,
                    propane_s = 2.534, ibutane_s = 0.4, nbutane_s = 0.83, benzene_s = 0.078,
                    toluene_s = 0.09, mXylene_s = 0.061, water_s = 4.0;
            double C6_s = 0.352, C7_s = 0.469, C8_s = 0.407, C9_s = 0.203, C10_s = 0.086,
                    C11_s = 0.063, C12_s = 0.062, C13_s = 0.049, C14_s = 0.033, C15_s = 0.025,
                    C16_s = 0.015, C17_s = 0.015, C18_s = 0.010, C19_s = 0.007, C20plus_s = 0.031;
            double C6_M_s = 85.0, C7_M_s = 90.7, C8_M_s = 104.1, C9_M_s = 119.8, C10_M_s = 133.0,
                    C11_M_s = 147.0, C12_M_s = 159.0, C13_M_s = 173.0, C14_M_s = 188.0,
                    C15_M_s = 202.0, C16_M_s = 213.0, C17_M_s = 230.0, C18_M_s = 247.0,
                    C19_M_s = 258.0, C20plus_M_s = 315.0;
            double C6_d_s = 0.668, C7_d_s = 0.745, C8_d_s = 0.767, C9_d_s = 0.776, C10_d_s = 0.783,
                    C11_d_s = 0.787, C12_d_s = 0.799, C13_d_s = 0.811, C14_d_s = 0.821,
                    C15_d_s = 0.828, C16_d_s = 0.836, C17_d_s = 0.834, C18_d_s = 0.835,
            ...
            double nitrogen_a = 0.1, CO2_a = 7.0, methane_a = 80.43, ethane_a = 4.99,
                    propane_a = 2.51, ibutane_a = 0.39, nbutane_a = 0.82, benzene_a = 0.077,
                    toluene_a = 0.089, mXylene_a = 0.06, water_a = 2.0;
            ...
            neqsim.thermo.system.SystemInterface testSystem2 =
                    new neqsim.thermo.system.SystemSrkEos(reservoirTemperatureAlbatross,
            ...
            testSystem.addTBPfraction("C6",
                    C6_s * reservoirGasFlowSnohvit / 360000.0 / reservoirGasMolarMassSnohvit,
                    C6_M_s / 1000.0, C6_d_s);
            testSystem.addTBPfraction("C7",
                    C7_s * reservoirGasFlowSnohvit / 360000.0 / reservoirGasMolarMassSnohvit,
                    C7_M_s / 1000.0, C7_d_s);
            testSystem.addTBPfraction("C8",
                    C8_s * reservoirGasFlowSnohvit / 360000.0 / reservoirGasMolarMassSnohvit,
                    C8_M_s / 1000.0, C8_d_s);
            testSystem.addTBPfraction("C9",
                    C9_s * reservoirGasFlowSnohvit / 360000.0 / reservoirGasMolarMassSnohvit,
            ...
            testSystem2.addComponent("nitrogen", nitrogen_a * reservoirGasFlowAlbatross / 360000.0
            ...
            testSystem2.addComponent("methane", methane_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("ethane", ethane_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("propane", propane_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("i-butane", ibutane_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("n-butane", nbutane_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("benzene", benzene_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("toluene", toluene_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            testSystem2.addComponent("m-Xylene", mXylene_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);

            testSystem2.addComponent("water", water_a * reservoirGasFlowAlbatross / 360000.0
                    / reservoirGasMolarMassAlbatross);
            ...
            double wateraqphase =
                    slugCatcher.getWaterOutStream().getThermoSystem().getTotalNumberOfMoles()
                            * slugCatcher.getWaterOutStream().getThermoSystem().getPhase(0)
            ...
            System.out.println("kg water in gas phase from slug catcher "
                    + slugCatcher.getGasOutStream().getThermoSystem().getTotalNumberOfMoles()
                            * slugCatcher.getGasOutStream().getThermoSystem().getPhase(0)
                                    .getComponent("water").getMolarMass()
                            * slugCatcher.getGasOutStream().getThermoSystem().getPhase(0)
                                    .getComponent("water").getx()
                            * 3600.0
            ...
            System.out.println("kg water in condesate phase from slug catcher "
                    ...
                    + " kg/hr");
            System.out.println(
                    "kg water in aqueous phase from slug catcher " + wateraqphase + " kg/hr");
            ...
            System.out.println("kg MEG in condesate phase from slug catcher "
                    ...
                    + " kg/hr");
            System.out
                    .println("kg MEG in aqueous phase from slug catcher " + MEGaqphase + " kg/hr");
