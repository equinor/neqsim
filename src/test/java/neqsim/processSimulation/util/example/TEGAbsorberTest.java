...
public class TEGAbsorberTest {
  ...
  public static void main(String args[]) {
    ...
    StreamInterface MPstreamGas = new Stream("MPGasStream", MPseparator.getGasOutStream());

    StreamInterface MPstreamLiq = new Stream("MPLiqStream", MPseparator.getLiquidOutStream());
