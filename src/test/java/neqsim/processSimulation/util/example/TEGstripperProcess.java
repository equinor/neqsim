...
public class TEGstripperProcess {
  ...
  public static void main(String[] args) {
    ...
    double wtInletTEG = TEGFeed.getFluid().getPhase(PhaseType.AQUEOUS).getWtFrac("TEG");
    double wtInletTEG2 =
        stripper.getLiquidOutStream().getFluid().getPhase(PhaseType.AQUEOUS).getWtFrac("TEG");
    double a = 1;
