...
//        testSystem.addComponent("ethane", 2.0);
        ...
        neqsim.processSimulation.processEquipment.heatExchanger.Heater heater = new neqsim.processSimulation.processEquipment.heatExchanger.Heater(
                stream_2);
...
//        ThermodynamicOperations ops = new ThermodynamicOperations(stream_2.getThermoSystem());
         ...
         * ops.dewPointTemperatureFlash(); } catch (Exception ex) {
         * ex.printStackTrace(); } double wtMEG =
         * stream_2.getThermoSystem().getPhase(1).getComponent("MEG").getx()*stream_2.
         * getThermoSystem().getPhase(1).getComponent("MEG").getMolarMass(); double
         * wtwater =
        ...
        public static void main(String args[]) {
                ...
                // stream_2.getThermoSystem().setHydrateCheck(true);
                // stream_2.getThermoSystem().init(0);
                // ThermodynamicOperations ops = new
                // ThermodynamicOperations(stream_2.getThermoSystem());
                /*
                 * try { // ops.TPflash();
                 * 
                 * ops.waterPrecipitationTemperature(); stream_2.getThermoSystem().display();
