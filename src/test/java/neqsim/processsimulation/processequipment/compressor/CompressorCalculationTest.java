...
public class CompressorCalculationTest extends neqsim.NeqSimTest {
  ...
  public void testRun() {
    ...
    // logger.info("Polytropic eff from curve:" + comp1.getPolytropicEfficiency() *
    // 100.0);
    ...
    // logger.info("temperature out " + (comp1.getOutTemperature() - 273.15) + "
    // C");
    /*
     * double temperatureOut = 273.15 + 84; comp1.setOutletPressure(96.0);
     * comp1.setOutTemperature(temperatureOut); operations.run(); double
     * polytropicHead =
     * comp1.getPolytropicHead(); double flowRate =
     * stream_1.getThermoSystem().getFlowRate("m3/hr");
     * double calcSpeed = comp1.getCompressorChart().getSpeed(flowRate,
     * polytropicHead);
