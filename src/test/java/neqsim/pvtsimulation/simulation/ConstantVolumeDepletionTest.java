...
public class ConstantVolumeDepletionTest {
  ...
  void testRunEclipseInput() {
    ...
    CVDsim.runCalc();
    CVDsim.getThermoSystem().initPhysicalProperties(PhysicalPropertyType.DENSITY);
    ...
    gasFluid.initPhysicalProperties(PhysicalPropertyType.DENSITY);
    ...
    ops.TPflash();
    oilFluid.initPhysicalProperties(PhysicalPropertyType.DENSITY);
