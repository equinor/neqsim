...
public class GammaFunctionVerificationTest {
  ...
  void testGammaAtIntegerValues() {
    ...
    logger.info("Gamma(1) = " + gamma1 + " (expected: 1.0)");
  ...
  void testGammaAtHalfIntegerValues() {
    ...
    logger.info("Gamma(0.5) = " + gamma05 + " (expected: " + SQRT_PI + ")");
    ...
    logger.info("Gamma(1.5) = " + gamma15 + " (expected: " + expected15 + ")");
    ...
    logger.info("Gamma(2.5) = " + gamma25 + " (expected: " + expected25 + ")");
