...
class RefineryHydrotreatingHydrogenEmissionsBalanceTest {
  ...
  void qualifiesPublicBigHillEmissionsReceipt() {
    ...
    RefineryHydrotreatingHydrogenEmissionsBalance emissions = RefineryHydrotreatingHydrogenEmissionsBalance
    ...
    assertEquals(5.49093756, emissions.getHydrogenSupplyEmissionsKgCo2EquivalentPerHour(), 1.0e-8);
    assertEquals(5.49093756, emissions.getHydrogenSupplyEmissionsKgCo2EquivalentPerTonneFeed(), 1.0e-8);
  ...
  void scalesRatesAndPreservesNormalizedIntensities() {
    RefineryHydrotreatingHydrogenEmissionsBalance base = RefineryHydrotreatingHydrogenEmissionsBalance
        .calculate(publicUtility(1000.0), EMISSION_FACTOR_KG_CO2E_PER_KG_H2, CARBON_PRICE_PER_TONNE_CO2E);
    RefineryHydrotreatingHydrogenEmissionsBalance doubled = RefineryHydrotreatingHydrogenEmissionsBalance
  ...
  void zeroScenarioInputsProduceZeroReceipt() {
    RefineryHydrotreatingHydrogenEmissionsBalance zero = RefineryHydrotreatingHydrogenEmissionsBalance
  ...
  void rejectsInvalidInputs() {
    ...
    assertThrows(NullPointerException.class, () -> RefineryHydrotreatingHydrogenEmissionsBalance.calculate(null,
        EMISSION_FACTOR_KG_CO2E_PER_KG_H2, CARBON_PRICE_PER_TONNE_CO2E));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenEmissionsBalance.calculate(utility, -1.0, CARBON_PRICE_PER_TONNE_CO2E));
    assertThrows(IllegalArgumentException.class, () -> RefineryHydrotreatingHydrogenEmissionsBalance.calculate(utility,
  ...
  private static RefineryHydrotreatingHydrogenUtilityBalance publicUtility(double feedMassFlowKgPerHour) {
    ...
    return RefineryHydrotreatingHydrogenUtilityBalance.calculate(throughput, LHV_MJ_PER_KG, HYDROGEN_COST_PER_KG);
  }
}
