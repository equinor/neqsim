...
public class RefineryHydrotreatingHydrogenRecycleBalanceTest {
  ...
  public void recycleReceiptsScaleWithFeedMass() {
    RefineryHydrotreatingHydrogenRecycleBalance one = RefineryHydrotreatingHydrogenRecycleBalance
        .calculate(publicSupply(1000.0), 0.90, 0.10, 0.50, 0.05);
    RefineryHydrotreatingHydrogenRecycleBalance two = RefineryHydrotreatingHydrogenRecycleBalance
        .calculate(publicSupply(2000.0), 0.90, 0.10, 0.50, 0.05);
  ...
  public void positiveSourceWithoutPurgeOrRejectionFailsClosed() {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, 0.90, 1.0, 0.50, 0.0));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, 0.90, 0.10, 1.0, 0.0));
  }
  ...
  public void invalidInputsFailClosed() {
    ...
    assertThrows(NullPointerException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(null, 0.90, 0.10, 0.50, 0.05));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, -0.01, 0.10, 0.50, 0.05));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, 0.90, 1.01, 0.50, 0.05));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, 0.90, 0.10, Double.NaN, 0.05));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingHydrogenRecycleBalance.calculate(supply, 0.90, 0.10, 0.50, 1.01));
  }
  ...
  private static RefineryHydrotreatingHydrogenSupplyBalance publicSupply(double feedMassKg) {
    RefineryHydrotreatingSulfurBalance sulfur = RefineryHydrotreatingSulfurBalance.calculate(feedMassKg, 0.0040867518,
        15.0e-6, 2.0);
    return RefineryHydrotreatingHydrogenSupplyBalance.calculate(sulfur, 1.5, 0.90, NITROGEN_MOLAR_MASS_KG_PER_MOL);
  }
}
