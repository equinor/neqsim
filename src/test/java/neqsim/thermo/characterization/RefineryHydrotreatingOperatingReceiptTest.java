...
class RefineryHydrotreatingOperatingReceiptTest {
  ...
  void qualifiesPublicBigHillOperatingReceipt() {
    ...
    RefineryHydrotreatingOperatingReceipt receipt = RefineryHydrotreatingOperatingReceipt.calculate(emissions);
    ...
    assertEquals(5.49093756, receipt.getHydrogenSupplyEmissionsKgCo2EquivalentPerHour(), 1.0e-8);
    assertEquals(5.49093756, receipt.getHydrogenSupplyEmissionsKgCo2EquivalentPerTonneFeed(), 1.0e-8);
  ...
  void scalesRatesAndPreservesNormalizedResults() {
    RefineryHydrotreatingOperatingReceipt base = RefineryHydrotreatingOperatingReceipt
        .calculate(publicEmissions(1000.0));
    RefineryHydrotreatingOperatingReceipt doubled = RefineryHydrotreatingOperatingReceipt
  ...
  void zeroScenarioInputsKeepPhysicalEnergyButZeroCostAndEmissions() {
    RefineryHydrotreatingOperatingReceipt receipt = RefineryHydrotreatingOperatingReceipt
  ...
  void rejectsNullInput() {
    assertThrows(NullPointerException.class, () -> RefineryHydrotreatingOperatingReceipt.calculate(null));
  }

  private static RefineryHydrotreatingHydrogenEmissionsBalance publicEmissions(double feedMassFlowKgPerHour) {
  ...
  private static RefineryHydrotreatingHydrogenEmissionsBalance publicEmissions(double feedMassFlowKgPerHour,
    ...
    return RefineryHydrotreatingHydrogenEmissionsBalance.calculate(utility, emissionFactorKgCo2ePerKgH2,
