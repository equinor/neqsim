...
public class RefineryHydrotreatingSulfurBalanceTest {
  ...
  public void publicDoeBigHillScreenClosesMassSulfurAndTarget() {
    RefineryHydrotreatingSulfurBalance receipt = RefineryHydrotreatingSulfurBalance.calculate(1000.0,
        BIG_HILL_SULFUR_MASS_FRACTION, TARGET_SULFUR_MASS_FRACTION, 2.0);
  ...
  public void assayFactoryUsesBulkSulfurWithoutMutation() {
    ...
    RefineryHydrotreatingSulfurBalance receipt = RefineryHydrotreatingSulfurBalance.calculateForAssay(1000.0, assay,
        TARGET_SULFUR_MASS_FRACTION, 2.0);
  ...
  public void targetEqualToFeedProducesZeroRemovalReceipt() {
    RefineryHydrotreatingSulfurBalance receipt = RefineryHydrotreatingSulfurBalance.calculate(1000.0, 0.004, 0.004,
        1.0);
  ...
  public void invalidInputsFailClosed() {
    ...
    assertThrows(NullPointerException.class,
        () -> RefineryHydrotreatingSulfurBalance.calculateForAssay(1000.0, null, 15.0e-6, 2.0));
  }
}
