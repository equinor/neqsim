...
public class RefineryHydrotreatingSulfurNitrogenBalanceTest {
  ...
  public void publicBigHillScreenClosesCoupledTargetsAndMass() {
    RefineryHydrotreatingSulfurNitrogenBalance receipt = RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0,
        BIG_HILL_SULFUR_MASS_FRACTION, BIG_HILL_NITROGEN_MASS_FRACTION, TARGET_SULFUR_MASS_FRACTION,
        TARGET_NITROGEN_MASS_FRACTION, 2.0, 4.0);
    ...
    assertEquals(TARGET_SULFUR_MASS_FRACTION, receipt.getAchievedProductSulfurMassFraction(), 1.0e-15);
  ...
  public void assayFactoryReadsBothAttributesWithoutMutation() {
    ...
    RefineryHydrotreatingSulfurNitrogenBalance receipt = RefineryHydrotreatingSulfurNitrogenBalance
        .calculateForAssay(1000.0, assay, TARGET_SULFUR_MASS_FRACTION, TARGET_NITROGEN_MASS_FRACTION, 2.0, 4.0);
  ...
  public void scalingPreservesCoupledMassFractions() {
    RefineryHydrotreatingSulfurNitrogenBalance basis = RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0,
        0.004, 0.001, TARGET_SULFUR_MASS_FRACTION, TARGET_NITROGEN_MASS_FRACTION, 2.0, 4.0);
    RefineryHydrotreatingSulfurNitrogenBalance doubled = RefineryHydrotreatingSulfurNitrogenBalance.calculate(2000.0,
        0.004, 0.001, TARGET_SULFUR_MASS_FRACTION, TARGET_NITROGEN_MASS_FRACTION, 2.0, 4.0);

    assertEquals(2.0 * basis.getProductMassKg(), doubled.getProductMassKg(), 1.0e-10);
    assertEquals(2.0 * basis.getTotalHydrogenConsumedMassKg(), doubled.getTotalHydrogenConsumedMassKg(), 1.0e-12);
    assertEquals(basis.getAchievedProductSulfurMassFraction(), doubled.getAchievedProductSulfurMassFraction(), 1.0e-15);
    assertEquals(basis.getAchievedProductNitrogenMassFraction(), doubled.getAchievedProductNitrogenMassFraction(),
        1.0e-15);
  }
  ...
  public void invalidInputsFailClosed() {
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculate(0.0, 0.004, 0.001, 15.0e-6, 10.0e-6, 2.0, 4.0));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0, 0.004, 0.001, 0.005, 10.0e-6, 2.0, 4.0));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0, 0.004, 0.001, 15.0e-6, 0.002, 2.0, 4.0));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0, 0.004, 0.001, 15.0e-6, 10.0e-6, 0.999, 4.0));
    assertThrows(IllegalArgumentException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculate(1000.0, 0.004, 0.001, 15.0e-6, 10.0e-6, 2.0, 1.499));
    assertThrows(NullPointerException.class,
        () -> RefineryHydrotreatingSulfurNitrogenBalance.calculateForAssay(1000.0, null, 15.0e-6, 10.0e-6, 2.0, 4.0));
  }
}
