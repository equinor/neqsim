...
/**
 * Test that BWRS gives the same results regardless of the order components are added, and that components without
 * MBWR-32 parameters produce valid (non-NaN) results.
 *
 * @author copilot
 * @version 1.0
 */
public class BWRSComponentOrderTest {
  ...
  /**
   * Test that methane-propane order does not matter, and propane (no MBWR-32 params) gives valid non-NaN fugacities.
   */
  @Test
  ...
  /**
   * Test a three-component mixture (methane + ethane + nitrogen). Nitrogen has no MBWR-32 params. Verify results are
   * order-independent and valid.
   */
  @Test
