 ...
 *
 * <p>
 * Documents the current CPA BIP performance for CO2-water at various temperatures. Reference data from Wiebe &amp;
 * Gaddy (1940), King et al. (1992), and Duan &amp; Sun (2003).
 * </p>
 *
 * <p>
 * Current CPA parameters (INTER.csv): cpakij_SRK = -0.27686, cpakijT_SRK = 0.001121, cpaBetaCross = 0.075, cpaEpsCross
 * = 0.
 * </p>
 *
 * @author Copilot
...
class CPACO2WaterBenchmarkTest extends neqsim.NeqSimTest {
   ...
   *
   * <p>
   * Reference: Wiebe &amp; Gaddy (1940) — CO2 mole fraction in liquid at 25C. At 100 bar: x_CO2 ~ 0.023; at 50 bar:
   * x_CO2 ~ 0.019.
   * </p>
   */
  @Test
  void testCO2SolubilityInWater25C() {
    ...
    assertTrue(co2InLiquid > 0.005, "CO2 solubility should be > 0.005 at 25C, 100 bar but was " + co2InLiquid);
    assertTrue(co2InLiquid < 0.05, "CO2 solubility should be < 0.05 at 25C, 100 bar but was " + co2InLiquid);
  }
   ...
   *
   * <p>
   * Reference: x_CO2 ~ 0.017 at 60C, 100 bar. This is the condition where current BIPs are known to under-predict.
   * </p>
   */
  @Test
  void testCO2SolubilityInWater60C() {
    ...
    assertTrue(co2InLiquid > 0.003, "CO2 solubility should be > 0.003 at 60C, 100 bar but was " + co2InLiquid);
    assertTrue(co2InLiquid < 0.04, "CO2 solubility should be < 0.04 at 60C, 100 bar but was " + co2InLiquid);
  }
  ...
  void testWaterInCO2Phase25C() {
    ...
    assertTrue(waterInCO2 > 0.0001, "Water in CO2 should be > 0.0001 at 25C, 100 bar but was " + waterInCO2);
    assertTrue(waterInCO2 < 0.02, "Water in CO2 should be < 0.02 at 25C, 100 bar but was " + waterInCO2);
  }
}
