 ...
 * <li>Flash calculations converge and produce physically valid results (VF in [0,1], positive density, positive
 * pressure).</li>
 * <li>For light components (ω ≤ 0.49) PR-LK and PR78 give identical VF (same m-factor).</li>
 * <li>For mixtures containing heavy pseudo-components (ω > 0.49) PR-LK and PR78 differ measurably, because PR-LK
 * applies the PR76 m-factor to all components while PR78 uses a modified polynomial for ω > 0.49.</li>
