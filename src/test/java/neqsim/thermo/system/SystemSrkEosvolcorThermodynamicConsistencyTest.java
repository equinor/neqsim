...
public class SystemSrkEosvolcorThermodynamicConsistencyTest extends neqsim.NeqSimTest {
  ...
  public void testPureComponentThermodynamicConsistency() {
    SystemInterface system = new SystemSrkEosvolcor(230.0, 30.0);
  ...
  public void testMixtureThermodynamicConsistency() {
    SystemInterface system = new SystemSrkEosvolcor(298.15, 30.0);
  ...
  public void testCachedPropertyThermodynamicConsistency() {
    SystemInterface system = new SystemSrkEosvolcor(320.0, 60.0);
