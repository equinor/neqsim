...
public class TPflashGR {
    ...
    public static void main(String[] args) {
        ...
        double[] molarmass = new double[] {18.0153, 28.0135, 44.0098, 16.0429, 30.0698, 44.0968,
                58.1239, 58.1239, 72.1510, 72.1510, 86.1776 / 1000.0, 90.1140 / 1000.0,
                102.0386 / 1000.0, 117.4548 / 1000.0, 205.5306 / 1000.0};
        ...
        double[] T_C =
                new double[] {330.54 - 273.15, 0, 15, 30, 100, 0, 15, 30, 100, 0, 15, 30, 100};
