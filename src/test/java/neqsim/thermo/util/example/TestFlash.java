...
public class TestFlash {
    ...
    public static void main(String[] args) {
        ...
        if (fluidNumber == 1) {
            ...
            fluid.addTBPfraction("CHCmp_1", 0.11058749198913600, 0.0861780014038086,
                    0.662663996219635);
            fluid.addTBPfraction("CHCmp_2", 0.17813117980957000, 0.0909560012817383,
                    0.740698456764221);
            fluid.addTBPfraction("CHCmp_3", 0.14764604568481400, 0.1034290008544920,
                    0.769004046916962);
            fluid.addTBPfraction("CHCmp_4", 0.10463774681091300, 0.1171869964599610,
                    0.789065659046173);
            fluid.addTBPfraction("CHCmp_5", 0.08433451652526860, 0.1458090057373050,
                    0.80481481552124);
            fluid.addTBPfraction("CHCmp_6", 0.03788370132446290, 0.1813300018310550,
                    0.825066685676575);
            fluid.addTBPfraction("CHCmp_7", 0.02444351673126220, 0.2122779998779300,
                    0.837704122066498);
            fluid.addTBPfraction("CHCmp_8", 0.01481210947036740, 0.2481419982910160,
                    0.849904119968414);
            fluid.addTBPfraction("CHCmp_9", 0.01158336877822880, 0.2892170104980470,
                    0.863837122917175);
            ...
            fluid.addTBPfraction("CHCmp_1", 0.0352155113220215, 0.0854749984741211,
                    0.664700031280518);
            fluid.addTBPfraction("CHCmp_2", 0.0705802822113037, 0.0890039978027344,
                    0.757499992847443);
            fluid.addTBPfraction("CHCmp_3", 0.0850765609741211, 0.1021979980468750,
                    0.778400003910065);
            fluid.addTBPfraction("CHCmp_4", 0.0605201292037964, 0.1156969985961910,
                    0.792500019073486);
            fluid.addTBPfraction("CHCmp_5", 0.1793018150329590, 0.1513029937744140,
                    0.82480001449585);
            fluid.addTBPfraction("CHCmp_6", 0.1033354282379150, 0.2105240020751950,
                    0.869700014591217);
            fluid.addTBPfraction("CHCmp_7", 0.0706664896011353, 0.2728500061035160,
                    0.881599962711334);
            fluid.addTBPfraction("CHCmp_8", 0.0626348257064819, 0.3172810058593750,
                    0.89300000667572);
            fluid.addTBPfraction("CHCmp_9", 0.0488108015060425, 0.3585450134277340,
                    0.90200001001358);
            fluid.addTBPfraction("CHCmp_10", 0.0484040451049805, 0.4076000061035160,
                    0.911700010299683);
            fluid.addTBPfraction("CHCmp_11", 0.0417061710357666, 0.4698110046386720,
                    0.923400044441223);
            fluid.addTBPfraction("CHCmp_12", 0.0425787830352783, 0.5629600219726560,
                    0.939900040626526);
            fluid.addTBPfraction("CHCmp_13", 0.0365876793861389, 0.7858560180664060,
                    0.979299962520599);
            fluid.createDatabase(true);
            fluid.setMixingRule(2);
            fluid.useVolumeCorrection(true);
            ...
            for (int j = 0; j < 3; j++) {
                if (fluid.hasPhaseType(phaseName[j])) {
                    ...
                    fluidProperties[t][k++] = fluid.getWtFraction(phaseNumber) * 100; // Phase
                                                                                      ...
                                                                                      // Percent
                    fluidProperties[t][k++] =
                            1.0 / fluid.getPhase(phaseNumber).getDensity("mol/m3"); // Phase Molar
                                                                                    // Volume
                                                                                    // [m3/mol]
                    fluidProperties[t][k++] = fluid.getCorrectedVolumeFraction(phaseNumber) * 100;// Phase
                                                                                                  // Volume
                                                                                                  // Percent
                    fluidProperties[t][k++] = fluid.getPhase(phaseNumber).getDensity("kg/m3"); // Phase
                                                                                               // Density
                                                                                               // [kg/m3]
                    fluidProperties[t][k++] = fluid.getPhase(phaseNumber).getZ(); // Phase
                                                                                  // Z
                                                                                  // Factor
                    ...
                    // (Cp/Cv)
                    fluidProperties[t][k++] = fluid.getPhase(phaseNumber).getKappa(); // Phase
                                                                                      // Kappa
                                                                                      // (Cp/Cv)
                    fluidProperties[t][k++] =
                    ...
                    // Phase
                    // Viscosity [Pa s]
                    fluidProperties[t][k++] = fluid.getPhase(phaseNumber).getViscosity("kg/msec");// Phase
                                                                                                  // Viscosity
                                                                                                  // [Pa
                                                                                                  // s]
                                                                                                  // or
                    ...
                    fluidProperties[t][k++] =
                            fluid.getPhase(phaseNumber).getThermalConductivity("W/mK"); // Phase
                                                                                                   // Thermal
                                                                                                   // Conductivity
                                                                                                   // [W/mK]
        ...
        logger.info(
                "Interfacial Tension Gas-Aqueous      [N/m]      " + interfacialtensiongasaqueous);
        logger.info(
                "Interfacial Tension Oil-Aqueous      [N/m]      " + interfacialtensionoilaqueous);
