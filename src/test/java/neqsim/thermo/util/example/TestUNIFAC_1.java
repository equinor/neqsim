        ...
        for (int i = 0; i < 2000; i++) {
            try {
                ...
                testSystem2.addComponent("TEG",
                        testSystem.getPhase(0).getComponent(0).getx() / 2.0e3);
                testSystem2.addComponent("MDEA",
                        testSystem.getPhase(0).getComponent(1).getx() / 2.0e3);
                testSystem2.addComponent("Piperazine",
                        testSystem.getPhase(0).getComponent(2).getx() / 2.0e3);
                testSystem2.addComponent("water",
                        testSystem.getPhase(0).getComponent(3).getx() / 2.0e3);
                ...
                double percentBackPip = (testSystem2.getPhase(0).getComponent(2).getNumberOfmoles())
                        / 0.015 * 100.0;
                double percentBackWater =
                        (testSystem2.getPhase(0).getComponent(3).getNumberOfmoles()) / 0.765
                                * 100.0;
