...
public class GERG2008NH3DiagnosticTest {
  ...
  public void printDeviationTable() {
    ...
    double[][] nistData = {
        ...
        // 400 K
        {400, 500, 0.15299, 40.083, 493.91}, {400, 1000, 0.31160, 41.617, 488.91}, {400, 2000, 0.64791, 45.119, 478.46},
        {400, 3000, 1.0143, 49.362, 467.32}, {400, 5000, 1.8705, 61.423, 442.30},
        // 430 K
        {430, 1000, 0.28739, 41.776, 507.74}, {430, 3000, 0.91503, 46.901, 491.57}, {430, 5000, 1.6327, 53.639, 474.14},
        // 500 K
    ...
    System.out.println("Full Gao et al. (2020) reference EOS: 20-term (8 power + 10 Gaussian + 2 GaoB)");
    System.out.println("Coefficients from CoolProp (Gao-JPCRD-2020), Tc=405.56K, rhoc=13.696 mol/L");
    logger.info("========================================================\n");
  }
}
