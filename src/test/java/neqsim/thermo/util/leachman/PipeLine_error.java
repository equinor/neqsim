...
public class PipeLine_error {
  ...
  void Leachman_compr_pipe_test() {
    ...
    SystemInterface Leachmanfluid = new neqsim.thermo.system.SystemSrkEos(293.15, 90);

    double length = 20000.0;
    double elevation = 0.0;
    double diameter = 0.98;
    System.out.println("-----------SRK EOS-----------");


    //Leachmanfluid.addComponent("hydrogen", 0.5);
    Leachmanfluid.addComponent("methane", 1.0);
    ...
    neqsim.process.equipment.stream.Stream gasstream_leachman =
      ...
      gasstream_leachman.setFlowRate(60.0, "MSm3/day");//Went over max itterations for 130 MSm3/day
