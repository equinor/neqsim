...
/**
 * Decomposes TPflash+stability cost into isolated sub-phases to find speedup opportunities. Each scenario is run as a
 * fresh clone so allocation costs are included.
 */
