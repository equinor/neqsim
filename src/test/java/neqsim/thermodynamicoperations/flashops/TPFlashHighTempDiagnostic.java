 ...
 * ~0.00683 or ~0.00349 is the correct answer at 268 C, 88 bara for the heavy oil system.
 */
public class TPFlashHighTempDiagnostic {
  ...
  public static void main(String[] args) {
    ...
    logger.info("--- Test 5: Single-phase vs 2-phase Gibbs energy ---");
    {
      ...
      System.out.println("  2-phase: nPhases=" + nph2 + " gasFrac=" + gasFrac2 + " Gibbs=" + gibbs2);
      logger.info("  1-phase (forced): Gibbs=" + gibbs1single);
      logger.info("  Gibbs difference (2ph - 1ph): " + (gibbs2 - gibbs1single));
      logger.info("  2-phase is " + (gibbs2 < gibbs1single ? "LOWER (correct)" : "HIGHER (wrong or mixed up)"));
    ...
    {
      neqsim.thermo.system.SystemInterface sysPR = new neqsim.thermo.system.SystemPrEos(243.15, 300.0);
