...
public class VigdisOilTest {
  ...
  @BeforeEach
  void setUp() {
    inletFluid = new SystemPrEos(273.15 + 65.0, 33.0);
  }
  ...
  void testFluidBuilding() {
    ...
    inletFluid.setPressure(33.0);
    inletFluid.setTemperature(273.15 + 65.0);

    ThermodynamicOperations operations = new ThermodynamicOperations(inletFluid);
    assertDoesNotThrow(() -> operations.TPflash());
